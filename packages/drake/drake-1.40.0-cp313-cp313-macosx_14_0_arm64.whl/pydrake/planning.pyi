...
class IrisZoOptions:
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def CreateWithRationalKinematicParameterization(kin: pydrake.multibody.rational.RationalForwardKinematics, q_star_val: numpy.ndarray[numpy.float64[m, 1]]) -> IrisZoOptions: ...
    def SetParameterizationFromExpression(self, expression_parameterization: numpy.ndarray[object[m, 1]], variables: numpy.ndarray[object[m, 1]]) -> None: ...
    ...
    def set_parameterization(self, parameterization: Callable[[numpy.ndarray[numpy.float64[m, 1]]], numpy.ndarray[numpy.float64[m, 1]]], parameterization_dimension: int) -> None: ...
