...
from src.pyccup.core import _logger, convert, html, xml
...
class HTMLTest(CommonTest):
    ...
    def test_comprehension_conversion(self):
        ...
        awaited = ('<!DOCTYPE html><html dir="ltr" lang="en" xml:lang="en">'
    ...
    def test_html5_doc_type(self):
        """Test HTML 5 DOCTYPE"""
        data = []
        awaited = '<!DOCTYPE html><html dir="ltr" lang="en" xml:lang="en"></html>'
    ...
    def test_html4_doc_type(self):
        ...
        awaited = ('<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" '
                   '"http://www.w3.org/TR/html4/strict.dtd"><html dir="ltr" lang="en"'
                   ' xml:lang="en"></html>')
