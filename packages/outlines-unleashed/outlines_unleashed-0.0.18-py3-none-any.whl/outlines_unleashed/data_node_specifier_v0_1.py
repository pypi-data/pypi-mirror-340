...
from outlines_unleashed.unleashed_outline_exceptions import InvalidDataNodeSpecifier


class DataNodeSpecifier_v0_1(BaseDataNodeSpecifier):
    """
    ...
    def _extract_field_names(self, primary_key_only: Optional[bool] = None):
        ...
        fields = [
            ...
            if self._key_field_check(primary_key_only, descriptor[field_name]['primary_key'])
        ]
        return fields
    ...
    def _match_field_node(self, field_node_list_entry):
        ...
        for field_name in descriptor:
            ...
            if self._match_field(field_node_list_entry, criteria):
                field_value = self._extract_field(field_node_list_entry.node(), field_specification)
                yield field_name, field_value

    @staticmethod
    def _match_field(node_ancestry_record, field_ancestry_criteria):
        """
