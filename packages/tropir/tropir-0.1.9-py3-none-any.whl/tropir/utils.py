...
def load_session_logs(session_id: str) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        # Use LOG_FILE_PATTERN for glob pattern
        log_files = sorted(log_dir.glob(LOG_FILE_PATTERN.format("*")))
...
def write_log_entry(log_entry):
    ...
    try:
        ...
        with open(log_file, "a") as f:
            json_str = json.dumps(log_entry, cls=GrammarEncoder)
            f.write(json_str + "\n")
    except Exception as e:
