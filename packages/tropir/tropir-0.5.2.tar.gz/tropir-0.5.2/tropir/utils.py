...
def get_user_id():
    ...
    Raises:
        ValueError: If TROPIR_API_KEY is invalid
    """
    import os
    import requests
    ...
    try:
        ...
        if not response.text:
            ...
            raise ValueError("Invalid API key: empty response received")
        ...
        try:
            ...
            raise ValueError(f"Invalid API key response format: {json_err}")
            
    except requests.exceptions.RequestException as req_err:
        logger.error(f"API key validation request failed: {req_err}")
        raise ValueError(f"API key validation request failed: {req_err}")
