...
def mock_ui_element_get_attr():
    ...
    with patch("t_page_object.base.ui_element.SeleniumManager"), patch(
        "t_page_object.base.ui_element.UIElement.__getattr__"
    ) as mock_getattr:
        yield mock_getattr
...
class TestRetryIfStaleElementError:
    ...
    def setup_method(self) -> None:
        ...
        self.button_element = ButtonElement(xpath="//button")
