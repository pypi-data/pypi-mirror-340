...
def _parallel_execute(path, report, app_set):
    print(app_set)
    devices = app_set.get('did', None)
    pkg = app_set.get('pkg', None)
    app_run_mode = app_set.get('run_mode', None)
    wda_project_path = app_set.get('wda_project_path', None)
    sib_path = app_set.get('sib_path', None)
    sonic_host = app_set.get('sonic_host', None)
    sonic_user = app_set.get('sonic_user', None)
    sonic_pwd = app_set.get('sonic_pwd', None)
