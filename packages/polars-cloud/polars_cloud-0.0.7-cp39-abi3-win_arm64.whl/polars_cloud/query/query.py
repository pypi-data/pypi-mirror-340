...
class BatchQuery(InProgressQueryRemote):
    ...
    def get_status(self) -> QueryStatus:
        schema = pcr.get_query(str(self._workspace_id), str(self._query_id))
    ...
    def _get_result(
        ...
        result_raw = pcr.get_query_result(str(self._query_id))
        result = QueryResult(
...
def spawn(
    ...
    **optimizations
    ...
    if context.interactive:
        ...
        q_id = pcr.submit_query(str(context._compute_id), plan, settings, labels)
