...
def login() -> None:
    ...
    See: `Polars Cloud Service Accounts <https://docs.pola.rs/polars-cloud/run/service-accounts/>`_
...
def list_workspaces(
    name: str | None = None, organization_id: str | None = None
...
def list_queries(workspace_id: str) -> list[QueryWithStateTimingSchema]: ...
def get_query(
    workspace_id: str, query_id: str
...
def get_organization(organization_id: str) -> OrganizationSchema: ...
