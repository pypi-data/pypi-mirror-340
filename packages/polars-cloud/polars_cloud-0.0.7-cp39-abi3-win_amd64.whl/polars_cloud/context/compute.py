...
class ComputeContext:
    ...
    workspace
        ...
        Example:
        >>> context = ComputeContext(workspace="my-workspace")  # doctest: +SKIP
    labels
    ...
    def stop(self, *, wait: bool = False) -> None:
        ...
        pcr.stop_compute(str(self.workspace.id), str(self._compute_id))
        if wait:
    ...
    def list(cls, workspace_id: UUID) -> list[Self]:
        ...
        compute_contexts = pcr.list_compute(str(workspace_id))
    ...
    def connect(cls, workspace_id: UUID, compute_id: UUID) -> Self:
        ...
        """
        details = pcr.get_compute_details(str(workspace_id), str(compute_id))
    ...
    def _get_server_info(self) -> None:
        ...
        server_info = pcr.get_compute_server_info(
            str(self.workspace.id), str(self._compute_id)
        )
