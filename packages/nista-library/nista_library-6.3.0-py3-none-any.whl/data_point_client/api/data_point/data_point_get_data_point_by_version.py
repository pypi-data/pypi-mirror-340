...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[DataPointResponseBase, ProblemDetails]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[DataPointResponseBase, ProblemDetails]]:
    return Response(
