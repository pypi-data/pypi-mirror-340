...
from ...models.append_manual_input_request import AppendManualInputRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: AppendManualInputRequest,

) -> Dict[str, Any]:
    url = "{}/DataPoint/workspace/{workspaceId}/datapoint/{dataPointId}/manualinputs/update".format(
