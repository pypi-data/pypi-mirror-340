...
from ...models.finish_execution_result_data_request import FinishExecutionResultDataRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: FinishExecutionResultDataRequest,

) -> Dict[str, Any]:
    url = "{}/DataPoint/workspace/{workspaceId}/dataPoint/{dataPointId}/resultparts/{executionId}/finish".format(
