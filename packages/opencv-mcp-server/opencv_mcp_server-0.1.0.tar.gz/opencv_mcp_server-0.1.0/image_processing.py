...
def detect_edges_tool(
    ...
    try:
        ...
        return {
            "image_base64": encode_image(edges),
...
def detect_contours_tool(
    ...
    try:
        ...
        return {
            ...
            "binary_image_base64": encode_image(binary),
...
def match_template_tool(
    ...
    Args:
        image_base64: Base64 encoded source image string
        template_base64: Base64 encoded template image string
    ...
    try:
        img = decode_image(image_base64)
        template = decode_image(template_base64)
        ...
        return {
            ...
            "result_visualization": encode_image(result_norm),
...
def register_tools(mcp):
    ...
    mcp.tool(apply_filter_tool)
    mcp.tool(detect_edges_tool)
    mcp.tool(apply_threshold_tool)
    mcp.tool(detect_contours_tool)
    mcp.tool(find_shapes_tool)
    mcp.tool(match_template_tool)