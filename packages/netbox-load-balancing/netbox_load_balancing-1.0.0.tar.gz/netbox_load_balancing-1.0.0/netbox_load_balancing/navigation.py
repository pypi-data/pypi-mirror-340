...
monitor_menu_items = (
    PluginMenuItem(
        ...
        link_text=_("LB Health Monitors"),
...
if plugin_settings.get("top_level_menu"):
    menu = PluginMenu(
        ...
        groups=(
            (_("LB Services"), service_menu_items),
            (_("LB Listeners"), listener_menu_items),
            (_("LB Pools"), pool_menu_items),
            (_("LB Health Monitors"), monitor_menu_items),
            (_("LB Members"), member_menu_items),
        ),
