...
- Development CLI: `./Code/dev_cli.py <example_file.py>` (run from project root)
  - Always specify a target file: `./Code/dev_cli.py [flags] <example_file.py>`
  - Use `-p` flag to show constraints: `./Code/dev_cli.py -p <example_file.py>`
  - Use `-z` flag to show Z3 output: `./Code/dev_cli.py -z <example_file.py>`
  - Combine flags: `./Code/dev_cli.py -p -z <example_file.py>`
