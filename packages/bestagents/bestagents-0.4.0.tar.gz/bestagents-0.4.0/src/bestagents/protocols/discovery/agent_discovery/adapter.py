"""
Agent-level agent discovery protocol for BestAgents.
...
from bestagents.models.messages import ProtocolMessage
from bestagents.models.tool import AgentAdapterTool
from bestagents.utils.message_util import get_protocol_message_thread_id
import copy

logger = logging.getLogger(__name__)

# Protocol constants
PROTOCOL_NAME = "bestagents.protocols.discovery.agent_discovery"
