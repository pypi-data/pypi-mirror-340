"""
Agent-level simple messaging protocol for BestAgents.
...
from bestagents.utils.message_util import (
...
class SimpleMessagingAgentClient(BaseProtocolAdapter):
    ...
    def initialize(self) -> bool:
        ...
        self.temp_dir = tempfile.TemporaryDirectory(prefix=f"bestagents_agent_{self.agent_id}_")
