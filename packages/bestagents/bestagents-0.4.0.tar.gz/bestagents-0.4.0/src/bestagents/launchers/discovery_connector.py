#!/usr/bin/env python3
"""
BestAgents Network Discovery Connector
...
from bestagents.models.network_profile import NetworkProfile
...
class NetworkDiscoveryConnector:
    ...
    def __init__(
        ...
        if not self.discovery_server_url:
            self.discovery_server_url = "https://discovery.bestagents.org"
