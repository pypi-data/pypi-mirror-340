#!/usr/bin/env python3
"""
BestAgents Terminal Console

A simple terminal console for interacting with an BestAgents network.
"""
...
from bestagents.models.messages import DirectMessage, BroadcastMessage
...
class ConsoleAgent:
    """Simple console agent for interacting with an BestAgents network."""
