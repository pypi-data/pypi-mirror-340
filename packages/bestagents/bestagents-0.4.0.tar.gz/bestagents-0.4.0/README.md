...
```python
from bestagents.core.network import AgentNetworkServer
...
```python
from bestagents.core.agent import Agent
...
Visit our project website at [https://bestagents.org](https://bestagents.org) for more information, documentation, and resources.

## Overview

BestAgents provides an engine for running a network with a set of protocols. The framework is designed to be modular, allowing developers to:
...
BestAgents includes several built-in protocols:
...
We welcome contributions to the BestAgents framework! Whether you want to fix bugs, add new features, or create new protocols, your help is appreciated.
...
pytest --cov=src/bestagents --cov-report=xml
```
...
[![Python Tests](https://github.com/bestagents/bestagents/actions/workflows/pytest.yml/badge.svg)](https://github.com/bestagents/bestagents/actions/workflows/pytest.yml)

### Test Coverage

[![codecov](https://codecov.io/gh/bestagents/bestagents/branch/main/graph/badge.svg)](https://codecov.io/gh/bestagents/bestagents)
...
git clone https://github.com/bestagents/bestagents.git
cd bestagents
...
BestAgents provides a command-line interface for basic operations:

```bash
# Launch a network with a configuration file
bestagents network launch config.json --runtime 3600

# Get help on available commands
bestagents --help

# Set logging level
bestagents --log-level DEBUG network launch config.json
```
