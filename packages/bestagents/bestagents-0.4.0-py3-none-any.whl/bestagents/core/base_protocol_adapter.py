...
from bestagents.models.messages import BaseMessage, DirectMessage, BroadcastMessage, ProtocolMessage
from bestagents.models.tool import AgentAdapterTool
from bestagents.core.connector import NetworkConnector
from bestagents.models.message_thread import MessageThread

class BaseProtocolAdapter(ABC):
    """Base class for agent adapter level protocols in BestAgents.
