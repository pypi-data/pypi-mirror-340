"""Network profile models for BestAgents.

This module defines the data models for network profiles, which describe
the characteristics and capabilities of BestAgents networks.
"""
...
class NetworkProfile(BaseModel):
    """Profile information for an BestAgents network.
    
    This model defines the public-facing information and capabilities
    of an BestAgents network, including its name, description, capacity,
    ...
    network_discovery_server: Optional[str] = Field(
        default="https://discovery.bestagents.org",
    ...
    required_bestagents_version: str = Field(
        ...,
        description="The minimum version of BestAgents required to connect to this network"
    )
    ...
    @validator('required_bestagents_version')
