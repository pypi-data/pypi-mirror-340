...
def load_protocol_adapters(protocol_names: List[str]) -> List[BaseProtocolAdapter]:
    ...
    Args:
        protocol_names: List of protocol names to load adapters for.
                       Format should be 'bestagents.protocols.{category}.{protocol_name}'
                       Example: 'bestagents.protocols.communication.simple_messaging'
    ...
    for protocol_name in protocol_names:
        try:
            ...
            # For example, from 'bestagents.protocols.communication.simple_messaging'
            # we get module_path = 'bestagents.protocols.communication.simple_messaging.adapter'
