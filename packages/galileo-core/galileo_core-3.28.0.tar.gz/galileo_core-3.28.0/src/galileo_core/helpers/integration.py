...
def create_or_update_openai_integration(
    ...
    data = {"token": token, "organization_id": organization_id}
...
def create_or_update_anthropic_integration(token: str, config: Optional[GalileoConfig] = None) -> IntegrationResponse:
    """
...
def create_or_update_mistral_integration(token: str, config: Optional[GalileoConfig] = None) -> IntegrationResponse:
    """
