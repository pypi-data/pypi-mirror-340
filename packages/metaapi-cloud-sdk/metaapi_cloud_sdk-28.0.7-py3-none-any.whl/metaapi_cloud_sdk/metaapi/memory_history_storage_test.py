...
class TestMemoryHistoryStorage:
    ...
    async def test_load_data_from_file_manager(self):
        ...
        test_order = {
            ...
            'magic': 0,
            'time': date(5000000),
            'doneTime': date(1000000),
            'currentPrice': 1,
            'volume': 0.01,
            'currentVolume': 0,
            'positionId': '61206630',
            'platform': 'mt5',
            'comment': 'AS_AUDNZD_5YyM6KS7Fv:',
        }
    ...
    async def test_clear_storage(self):
        ...
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1',
            {
                'id': '3',
    ...
    async def test_return_last_history_order_time(self):
        ...
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1', {'id': '1', 'state': 'ORDER_STATE_FILLED', 'type': 'ORDER_TYPE_SELL'}
        )
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1',
            {
    ...
    async def test_return_last_deal_time(self):
        ...
        await storage.on_deal_added(
            'vint-hill:1:ps-mpa-1', {'id': '1', 'entryType': 'DEAL_ENTRY_IN', 'time': date('2019-01-01T00:00:00.000Z')}
        )
        await storage.on_deal_added(
            'vint-hill:1:ps-mpa-1', {'id': '2', 'entryType': 'DEAL_ENTRY_IN', 'time': date('2020-01-01T00:00:00.000Z')}
        )
        await storage.on_deal_added(
            'vint-hill:1:ps-mpa-1', {'id': '3', 'entryType': 'DEAL_ENTRY_IN', 'time': date('2020-01-02T00:00:00.000Z')}
        )
    ...
    async def test_return_saved_deals(self):
        ...
        await storage.on_deal_added(
            ...
            {
                'id': '7',
                'time': date('2020-05-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_BUY',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        await storage.on_deal_added(
            ...
            {
                'id': '8',
                'time': date('2020-02-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_SELL',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        await storage.on_deal_added(
            ...
            {
                'id': '6',
                'time': date('2020-10-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_BUY',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        ...
        await storage.on_deal_added(
            ...
            {
                'id': '5',
                'time': date('2020-06-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_BUY',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        await storage.on_deal_added(
            ...
            {
                'id': '11',
                'time': date('2019-09-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_SELL',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        await storage.on_deal_added(
            ...
            {
                'id': '3',
                'time': date('2020-09-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_BUY',
                'entryType': 'DEAL_ENTRY_IN',
            },
        )
        ...
        await storage.on_deal_added(
            ...
            {
                'id': '2',
                'time': date('2020-08-01T00:00:00.000Z'),
                'positionId': '1',
                'type': 'DEAL_TYPE_SELL',
                'entryType': 'DEAL_ENTRY_IN',
            },
        ...
        assert storage.get_deals_by_ticket('1') == [
            {
                'id': '1',
                'time': date('2020-01-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_SELL',
        ...
        assert storage.get_deals_by_position('1') == [
            {
                'id': '1',
                'time': date('2020-01-01T00:00:00.000Z'),
                'type': 'DEAL_TYPE_SELL',
    ...
    async def test_return_saved_history_orders(self):
        ...
        await storage.on_history_order_added(
            ...
            {
                'id': '7',
                'doneTime': date('2020-05-01T00:00:00.000Z'),
                'type': 'ORDER_TYPE_BUY',
                'state': 'ORDER_STATE_FILLED',
            },
        )
        await storage.on_history_order_added(
            ...
            {
                'id': '8',
                'doneTime': date('2020-02-01T00:00:00.000Z'),
                'type': 'ORDER_TYPE_SELL',
                'state': 'ORDER_STATE_FILLED',
            },
        )
        await storage.on_history_order_added(
            ...
            {
                'id': '6',
                'doneTime': date('2020-10-01T00:00:00.000Z'),
                'type': 'ORDER_TYPE_BUY',
                'state': 'ORDER_STATE_FILLED',
            },
        )
        ...
        await storage.on_history_order_added(
            ...
            {
                'id': '5',
                'doneTime': date('2020-06-01T00:00:00.000Z'),
                'type': 'ORDER_TYPE_BUY',
                'state': 'ORDER_STATE_FILLED',
            },
        )
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1', {'id': '11', 'type': 'ORDER_TYPE_SELL', 'state': 'ORDER_STATE_FILLED'}
        )
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1',
            {
                'id': '3',
                'doneTime': date('2020-09-01T00:00:00.000Z'),
                'type': 'ORDER_TYPE_BUY',
                'state': 'ORDER_STATE_FILLED',
            },
        )
        ...
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1', {'id': '10', 'type': 'ORDER_TYPE_SELL', 'state': 'ORDER_STATE_FILLED'}
        )
        await storage.on_history_order_added(
            'vint-hill:1:ps-mpa-1', {'id': '12', 'type': 'ORDER_TYPE_BUY', 'state': 'ORDER_STATE_FILLED'}
        )
        ...
        assert storage.get_history_orders_by_ticket('1') == [
            {
                'id': '1',
                'state': 'ORDER_STATE_FILLED',
                'doneTime': date('2020-01-01T00:00:00.000Z'),
        ...
        assert storage.get_history_orders_by_position('1') == [
            {
                'id': '1',
                'state': 'ORDER_STATE_FILLED',
                'doneTime': date('2020-01-01T00:00:00.000Z'),
        ...
        assert storage.get_history_orders_by_time_range(
            date('2020-08-01T00:00:00.000Z'), date('2020-09-01T00:00:00.000Z')
        ) == [
            {
                'id': '2',
                'state': 'ORDER_STATE_FILLED',
    ...
    async def test_flush_db(self):
        ...
        with patch('lib.metaapi.memory_history_storage.asyncio.sleep', new=lambda x: sleep(x / 60)):
            await storage.on_deals_synchronized('vint-hill:1:ps-mpa-1', 'synchronizationId')
            db.flush = AsyncMock()
            await storage.on_history_order_added(
                'vint-hill:1:ps-mpa-1',
    ...
    async def test_throttle_db_flush(self):
        ...
        with patch('lib.metaapi.memory_history_storage.asyncio.sleep', new=lambda x: sleep(x / 50)):
            await storage.on_deals_synchronized('vint-hill:1:ps-mpa-1', 'synchronizationId')
            db.flush = AsyncMock()
            await storage.on_history_order_added(
                'vint-hill:1:ps-mpa-1',
