...
db: Union[FilesystemHistoryDatabase, None] = FilesystemHistoryDatabase()
storage = None
test_deal = None
test_deal2 = None
test_deal3 = None
...
async def run_around_tests():
    ...
    test_deal = {
        ...
        'magic': 0,
        'time': datetime.fromtimestamp(100).isoformat(),
        'commission': 0,
        'swap': 0,
        'profit': 10000,
        'platform': 'mt5',
    ...
    test_deal2 = {
        ...
        'type': 'DEAL_TYPE_SELL',
        'magic': 1,
        'time': datetime.fromtimestamp(200).isoformat(),
        'commission': 0,
        'swap': 0,
        'profit': 10000,
        'platform': 'mt5',
        'comment': 'Demo deposit 2',
    }
    global test_deal3
    test_deal3 = {
        'id': '37863645',
        'type': 'DEAL_TYPE_BUY',
        'magic': 2,
        'time': datetime.fromtimestamp(300).isoformat(),
        'commission': 0,
        'swap': 0,
        'profit': 10000,
        'platform': 'mt5',
        'comment': 'Demo deposit 3',
    }
    global test_order
    test_order = {
        'id': '61210463',
        ...
        'symbol': 'AUDNZD',
        'magic': 0,
        'time': datetime.fromtimestamp(50).isoformat(),
        'doneTime': datetime.fromtimestamp(100).isoformat(),
        'currentPrice': 1,
        'volume': 0.01,
        'currentVolume': 0,
        'positionId': '61206630',
    ...
    test_order2 = {
        ...
        'symbol': 'AUDNZD',
        'magic': 1,
        'time': datetime.fromtimestamp(75).isoformat(),
        'doneTime': datetime.fromtimestamp(200).isoformat(),
        'currentPrice': 1,
        'volume': 0.01,
        'currentVolume': 0,
        'positionId': '61206631',
    ...
    test_order3 = {
        ...
        'magic': 2,
        'time': datetime.fromtimestamp(100).isoformat(),
        'doneTime': datetime.fromtimestamp(300).isoformat(),
        'currentPrice': 1,
        'volume': 0.01,
        'currentVolume': 0,
        'positionId': '61206632',
