...
opts = {'url': '/some/rest/api', 'method': 'GET'}
host = {
...
class TestDomainClient:
    ...
    async def test_try_another_region_if_first_failed(self):
        ...
        us_west_call = respx.get(
            'https://risk-management-api-v1.us-west.agiliumtrade.agiliumtrade.ai/some/rest/api'
    ...
    async def test_return_error_if_all_regions_failed(self):
        ...
        request_call.mock(return_value=Response(500))
        respx.get('https://risk-management-api-v1.us-west.agiliumtrade.agiliumtrade.ai/some/rest/api').mock(
    ...
    @respx.mock
    @pytest.mark.asyncio
    async def test_roll_over_to_first_region_if_all_failed(self):
