...
async def run_around_tests():
    ...
    equity_tracking_client = EquityTrackingClient(domain_client, meta_api)
    global listener
    listener = Listener('accountId', 'trackerId')
...
class TestEquityTrackingClient:
        ...
        domain_client.request_api.assert_called_with(
            {
                ...
                'headers': {'auth-token': 'header.payload.sign', 'api-version': '1'},
                'method': 'POST',
                'body': tracker,
            }
        )
    ...
    async def test_update_tracker(self):
        ...
        domain_client.request_api.assert_called_with(
            {'url': '/users/current/accounts/accountId/trackers/trackerId', 'method': 'PUT', 'body': update}
        )
    ...
    async def test_delete_tracker(self):
        ...
        domain_client.request_api.assert_called_with(
            {'url': '/users/current/accounts/accountId/trackers/trackerId', 'method': 'DELETE'}
        )
    ...
    async def test_retrieve_tracking_statistics(self):
        ...
        actual = await equity_tracking_client.get_tracking_statistics(
            'accountId', 'trackerId', '2022-04-08 09:36:00.000', 100
        )
        assert actual == expected
        domain_client.request_api.assert_called_with(
            {
    ...
    async def test_retrieve_equity_chart(self):
        ...
        domain_client.request_api = AsyncMock(return_value=expected)
        actual = await equity_tracking_client.get_equity_chart(
            'accountId', '2022-04-08 09:36:00.000', '2022-04-08 10:36:00.000'
        )
        assert actual == expected
        domain_client.request_api.assert_called_with(
            {
    ...
    async def test_retrieve_equity_chart_and_fill_the_missing_records(self):
        ...
        actual = await equity_tracking_client.get_equity_chart(
            'accountId', '2022-04-08 09:36:00.000', '2022-04-08 10:36:00.000', False, True
        )
        assert actual == [
            {
                'averageBalance': 1050,
    ...
    async def test_add_tracker_event_listener(self, tracker_event_listener_fixture):
        ...
        call_stub = MagicMock()
        equity_tracking_client._tracker_event_listener_manager.add_tracker_event_listener = call_stub
    ...
    async def test_remove_tracker_event_listener(self, tracker_event_listener_fixture):
        ...
        call_stub = MagicMock()
        equity_tracking_client._tracker_event_listener_manager.remove_tracker_event_listener = call_stub
    ...
    async def test_add_period_statistics_event_listener(self, period_statistics_listener_fixture):
        ...
        call_stub = AsyncMock()
        equity_tracking_client._period_statistics_stream_manager.add_period_statistics_listener = call_stub
    ...
    async def test_remove_period_statistics_event_listener(self, period_statistics_listener_fixture):
        ...
        call_stub = MagicMock()
        equity_tracking_client._period_statistics_stream_manager.remove_period_statistics_listener = call_stub
    ...
    async def test_add_equity_chart_event_listener(self, equirt_chart_listener_fixture):
        ...
        call_stub = AsyncMock()
        equity_tracking_client._equity_chart_stream_manager.add_equity_chart_listener = call_stub
    ...
    async def test_remove_equity_chart_event_listener(self, equirt_chart_listener_fixture):
        ...
        call_stub = MagicMock()
        equity_tracking_client._equity_chart_stream_manager.remove_equity_chart_listener = call_stub
