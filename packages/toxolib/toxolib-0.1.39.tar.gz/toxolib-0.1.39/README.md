...
### v0.1.39
- Fixed 'cmd' variable reference error in job script that was causing job submission failures
- Added proper handling of raw_data_dir parameter in the job script generation
- Improved offline mode support for HPC environments without internet access
