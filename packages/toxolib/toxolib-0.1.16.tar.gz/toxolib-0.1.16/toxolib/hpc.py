...
from .session import store_credentials, get_credentials, initialize_session
...
class HPCConnection:
    ...
    def setup_connection(self, hostname=None, username=None, password=None, key_file=None, use_session=True):
        """Set up SSH connection to HPC"""
        # Initialize session for credential storage
        initialize_session()
