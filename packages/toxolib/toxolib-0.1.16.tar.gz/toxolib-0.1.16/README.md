...
#### 6. Session-Based Password Storage

Toxolib now includes session-based password storage, which allows you to enter your password just once per terminal session. The password is securely stored in memory and automatically reused for subsequent commands during your session.
