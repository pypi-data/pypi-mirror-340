...
def main():
    ...
    for input_file in input_files:
        ...
        cmd = f"kraken2 --db {kraken_db} --threads {threads} "
        cmd += f"--output {output_file} --report {report_file} {input_file}"
    ...
    try:
        ...
        try:
            ...
            run_command(f"python create_abundance_matrix.py kraken_output abundance_matrix.tsv {corn_db}")
...
export RAW_DATA_DIR="$OUTPUT_PARENT_DIR/Raw_Data"
