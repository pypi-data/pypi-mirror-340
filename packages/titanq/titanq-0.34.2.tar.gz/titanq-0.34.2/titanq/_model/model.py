...
class Model:
    ...
    def get_objective_matrices(self) -> Tuple[Optional[Union[np.ndarray, coo_array]], Optional[np.ndarray]]:
        """
    ...
    def get_constraints_weights_and_bounds(self) -> Tuple[Optional[Union[np.ndarray, coo_array]], Optional[np.ndarray]]:
        """
    ...
    def get_quad_constraints_weights_and_bounds(self) -> Tuple[Optional[Union[np.ndarray, coo_array]], Optional[np.ndarray]]:
        """
    ...
    def get_quad_constraints_linear_weights(self) -> Optional[Union[np.ndarray, coo_array]]:
        """
    ...
    def set_objective_matrices(
        self,
        weights: Optional[Union[np.ndarray, coo_array]],
        bias: Union[np.ndarray, coo_array],
    ...
    def add_set_partitioning_constraints_matrix(self, constraint_mask: Union[np.ndarray, coo_array]):
        """
    ...
    def add_set_partitioning_constraint(self, constraint_mask: Union[np.ndarray, coo_array]):
        """
    ...
    def add_cardinality_constraints_matrix(self, constraint_mask: Union[np.ndarray, coo_array], cardinalities: Union[np.ndarray, coo_array]):
        """
    ...
    def add_cardinality_constraint(self, constraint_mask: Union[np.ndarray, coo_array], cardinality: int):
        """
    ...
    def add_equality_constraints_matrix(self, constraint_mask: Union[np.ndarray, coo_array], limit: Union[np.ndarray, coo_array]) -> None:
        """
    ...
    def add_equality_constraint(self, constraint_mask: Union[np.ndarray, coo_array], limit: np.float32) -> None:
        """
    ...
    def add_inequality_constraints_matrix(self, constraint_mask: Union[np.ndarray, coo_array], constraint_bounds: Union[np.ndarray, coo_array]):
        """
    ...
    def add_inequality_constraint(self, constraint_mask: Union[np.ndarray, coo_array], constraint_bounds: Union[np.ndarray, coo_array]):
        """
    ...
    def _solve(
        ...
        if constraint_weights is not None and constraint_bounds is not None:
            for mask, bounds in zip(constraint_weights, constraint_bounds):
                bounds_numpy = self._array_like_factory.create_numpy(bounds)
                self._manifest.add_constraint_type(get_constraint_type(mask, bounds_numpy))
