...
from ..hardware.random_wrapper import RandomWrapper

from pymodaq_plugins_mockexamples import config


class DAQ_Move_MockRandom(DAQ_Move_base):
    """
    ...
    params = comon_parameters_fun(is_multiaxes)
    ...
    def ini_stage(self, controller=None):
        ...
        """
        self.ini_stage_init(controller, RandomWrapper())
        info = "Mock Random Wrapper"
        initialized = True
