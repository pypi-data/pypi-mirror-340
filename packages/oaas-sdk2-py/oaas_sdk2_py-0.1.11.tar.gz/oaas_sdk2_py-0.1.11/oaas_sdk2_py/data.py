...
class DataManager:
    ...
    async def set_all(self,
                      ...
                      object_id: int,
                      data: Dict[int, bytes], ):
        logger.debug("set_all: cls_id: %s, partition_id: %d, object_id: %d, setting %d keys, example keys: %s",
    ...
    async def delete(self,
                     ...
                     partition_id: int,
                     object_id: int):
        logger.debug("Deleting object: cls_id=%s, partition_id=%d, object_id=%d", cls_id, partition_id, object_id)
