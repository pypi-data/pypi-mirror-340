...
def aizymes_setup(self):
    ...
    if self.N_PARENT_JOBS < self.MAX_JOBS:
        logging.info(f"Attention! N_PARENT_JOBS should be > MAX_JOBS. N_PARENT_JOBS: {self.N_PARENT_JOBS}, MAX_JOBS: {self.MAX_JOBS}.")
        logging.info(f"NOTE FROM HAB: Needs to be adjusted to take the number of input structures into account!")
    ...
    logging.info(f"Add checks here to make sure all ligand files are present!")
