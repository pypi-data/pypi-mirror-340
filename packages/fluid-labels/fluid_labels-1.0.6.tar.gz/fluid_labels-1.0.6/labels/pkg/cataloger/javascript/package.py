...
def is_stable_npm_version(version_str: str) -> bool:
    ...
    return (
        not any(identifier in version_str for identifier in unstable_identifiers)
        or re.search(numeric_prerelease_pattern, version_str) is None
    )
