...
Thank you for your help improving **geestac**!

**geestac** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **geestac** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/geestac
   cd geestac
...
This will install the **geestac** library, together with two additional tools:
