...
class Customer(SensitiveFieldsTrackingMixin, BaseModel):
    ...
    mobile = EncryptedCharField(max_length=20, blank=True)
    
    # Define sensitive fields for tracking
    sensitive_fields = ['email', 'phone', 'mobile', 'first_name', 'last_name']
    ...
    KYC_STATUS_CHOICES = [
        ...
        ('approved', 'Approved'),
        ('rejected', 'Rejected'),
        ('recheck_pending', 'Recheck Pending')
    ]
    kyc_status = models.CharField(max_length=20, choices=KYC_STATUS_CHOICES, default='not_uploaded')
    level_one_kyc_status = models.CharField(max_length=20, choices=KYC_STATUS_CHOICES, default='not_uploaded')
    level_two_kyc_status = models.CharField(max_length=20, choices=KYC_STATUS_CHOICES, default='not_uploaded')
    level_three_kyc_status = models.CharField(max_length=20, choices=KYC_STATUS_CHOICES, default='not_uploaded')
    ...
    ib_status = models.CharField(max_length=20, choices=IB_STATUS_CHOICES, null=True, blank=True)
...
class CustomerDetail(SensitiveFieldsTrackingMixin, BaseModel):
    ...
    title = EncryptedCharField(max_length=10, blank=True)
    dob = models.DateField(null=True)
    nationality = models.CharField(max_length=2, blank=True)
    city = EncryptedCharField(max_length=100, blank=True)
    address = EncryptedCharField(max_length=500, blank=True)
    address2 = EncryptedCharField(max_length=500, blank=True)
    gender = models.CharField(max_length=1, blank=True)
    zip_code = EncryptedCharField(max_length=20, blank=True)
    language = models.CharField(max_length=2, default='EN')
    
    # Define sensitive fields for tracking
    sensitive_fields = ['title', 'dob', 'city', 'address', 'address2', 'zip_code', 'tax_identification_number']
