...
def get_screenshot_text_ocr(
    ...
    try:
        ...
        screenshot = take_screenshot(title_pattern, use_regex, threshold)
        ...
        print(f"Error getting UI elements: {str(e)}")
        import traceback
...
print(get_screenshot_text_ocr("chrome"))
