...
class ScNetFileAPI(ApiBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super().__init__(*args, module="file", **kwargs)
    ...
    def upload_file(
        self, token: str, file_path: str, remote_dir: str, cover: str = "uncover"
    ) -> Dict[str, Any]:
        """
    ...
    def download_file(
        ...
        endpoint = self._get_endpoint("download")
    ...
    def download_check(self, token: str, paths: List[str]) -> bool:
        """
        ...
        endpoint = self._get_endpoint("download-check")
        response = requests.get(endpoint, headers=headers, params=params)
