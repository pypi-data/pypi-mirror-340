...
DEBRIDGE_ACTIONS = {
    "CREATE_DEBRIDGE_TRANSACTION": Tool(
        ...
        description="Create a cross-chain bridge transaction using deBridge Liquidity Network API",
        inputSchema={
            "src_chain_id": {
                "type": "string",
                "description": "The internal chain ID of the source chain.",
            },
            "src_chain_token_in": {
                "type": "string",
                "description": "The address of the input token (token being sold).",
            },
            ...
            "dst_chain_id": {
                "type": "string",
                "description": "The internal chain ID of the destination chain.",
            },
            "dst_chain_token_out": {
                "type": "string",
                "description": "The address of the output token (token being bought).",
            },
            ...
            "src_chain_order_authority_address": {
                "type": "string",
                "description": "The address on the source chain for order authority.",
            },
            "dst_chain_order_authority_address": {
                "type": "string",
                "description": "The address on the destination chain for order authority.",
            },
            "affiliate_fee_percent": {
                "type": "string",
                "description": "The percentage of affiliate fee to cut off. Defaults to '0'.",
            },
            "affiliate_fee_recipient": {
                "type": "string",
                "description": "The recipient address of the affiliate fee. Optional.",
            },
            "prepend_operating_expenses": {
                "type": "boolean",
                "description": "Whether to prepend operating expenses. Defaults to True.",
            },
    ...
    "EXECUTE_DEBRIDGE_TRANSACTION": Tool(
        ...
        description="Execute a cross-chain bridge transaction using deBridge Liquidity Network API",
        inputSchema={
            "transaction_data": {
                "type": "object",
    ...
    "CHECK_TRANSACTION_STATUS": Tool(
        ...
        description="Check the status of a cross-chain bridge transaction using deBridge Liquidity Network API",
        inputSchema={
            "tx_hash": {
                "type": "string",
