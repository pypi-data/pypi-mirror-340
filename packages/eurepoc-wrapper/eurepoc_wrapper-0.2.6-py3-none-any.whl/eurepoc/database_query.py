...
class DatabaseQuery:
    ...
    def execute_query(self, url = None):
        ...
        try:
            ...
            if raw_data is not None:
                try:
                    clean_data = get_clean_data(raw_data, receiver_region=self.receiver_region)
                except:
                    print(f"Error processing incident: {raw_data["id"]}")
                    clean_data = None
                return clean_data
            return None
    ...
    def _query_database(self):
        ...
        return self.util.query_database(
            ...
            receiver_category=self.receiver_category, initiator_country=self.initiator_country, incident_id=self.incident_id,
