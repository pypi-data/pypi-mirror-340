...
def encrypt(plaintext: str, password: str, salt: str, iterations: int = 20, prime: int = 65537) -> bytes:
...
def decrypt(ciphertext: bytes, password: str, salt: str, iterations: int = 20, prime: int = 65537) -> str:
