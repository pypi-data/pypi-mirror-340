...
class GeneralizedSearchContext:
    ...
    @overload
    @staticmethod
    def create(generalized_problem: _pymimir.advanced.formalism.GeneralizedProblem, options: SearchContextOptions = ...) -> GeneralizedSearchContext: ...

    @overload
    @staticmethod
    def create(generalized_problem: _pymimir.advanced.formalism.GeneralizedProblem, search_contexts: Sequence[SearchContext]) -> GeneralizedSearchContext: ...
...
class ProblemGoalStrategy(GoalStrategy):
    def __init__(self, problem: _pymimir.advanced.formalism.Problem) -> None: ...
    ...
    @staticmethod
    def create(problem: _pymimir.advanced.formalism.Problem) -> ProblemGoalStrategy: ...
...
class SearchContext:
    ...
    @overload
    @staticmethod
    def create(problem: _pymimir.advanced.formalism.Problem, options: SearchContextOptions = ...) -> SearchContext: ...

    @overload
    @staticmethod
    def create(problem: _pymimir.advanced.formalism.Problem, applicable_action_generator: IApplicableActionGenerator, state_repository: StateRepository) -> SearchContext: ...
...
class StateRepository:
    ...
    def get_or_create_state(self, atoms: _pymimir.advanced.formalism.FluentGroundAtomList, numeric_variables: _pymimir.advanced.common.FlatDoubleList) -> tuple[State, float]: ...
...
def compute_state_metric_value(state: State, problem: _pymimir.advanced.formalism.Problem) -> float: ...

def find_solution_astar(search_context: SearchContext, heuristic: IHeuristic, start_state: State | None = None, astar_event_handler: IAStarEventHandler | None = None, goal_strategy: GoalStrategy | None = None, pruning_strategy: "mimir::search::IPruningStrategy" | None = None) -> SearchResult: ...

def find_solution_brfs(search_context: SearchContext, start_state: State | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: GoalStrategy | None = None, pruning_strategy: "mimir::search::IPruningStrategy" | None = None, exhaustive: bool = False) -> SearchResult: ...

def find_solution_iw(search_context: SearchContext, start_state: State | None = None, max_arity: int | None = None, iw_event_handler: IIWEventHandler | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: GoalStrategy | None = None) -> SearchResult: ...

def find_solution_siw(search_context: SearchContext, start_state: State | None = None, max_arity: int | None = None, siw_event_handler: ISIWEventHandler | None = None, iw_event_handler: IIWEventHandler | None = None, brfs_event_handler: IBrFSEventHandler | None = None, goal_strategy: GoalStrategy | None = None) -> SearchResult: ...
