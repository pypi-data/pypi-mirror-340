...
class StateSpace:
    ...
    @overload
    @staticmethod
    def create(context: _pymimir.advanced.search.SearchContext, options: StateSpaceOptions = ...) -> tuple[StateSpace, "mimir::datasets::CertificateMaps" | None] | None: ...

    @overload
    @staticmethod
    def create(contexts: _pymimir.advanced.search.GeneralizedSearchContext, options: StateSpaceOptions = ...) -> list[tuple[StateSpace, "mimir::datasets::CertificateMaps" | None]]: ...
