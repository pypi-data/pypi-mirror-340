...
def find_solution_astar(search_context: SearchContext, heuristic: IHeuristic, start_state: Optional[State] = None, astar_event_handler: Optional[IAStarEventHandler] = None, goal_strategy: Optional[GoalStrategy] = None, pruning_strategy: Optional["mimir::search::IPruningStrategy"] = None) -> SearchResult: ...

def find_solution_brfs(search_context: SearchContext, start_state: Optional[State] = None, brfs_event_handler: Optional[IBrFSEventHandler] = None, goal_strategy: Optional[GoalStrategy] = None, pruning_strategy: Optional["mimir::search::IPruningStrategy"] = None, exhaustive: bool = False) -> SearchResult: ...

def find_solution_iw(search_context: SearchContext, start_state: Optional[State] = None, max_arity: Optional[int] = None, iw_event_handler: Optional[IIWEventHandler] = None, brfs_event_handler: Optional[IBrFSEventHandler] = None, goal_strategy: Optional[GoalStrategy] = None) -> SearchResult: ...

def find_solution_siw(search_context: SearchContext, start_state: Optional[State] = None, max_arity: Optional[int] = None, siw_event_handler: Optional[ISIWEventHandler] = None, iw_event_handler: Optional[IIWEventHandler] = None, brfs_event_handler: Optional[IBrFSEventHandler] = None, goal_strategy: Optional[GoalStrategy] = None) -> SearchResult: ...
