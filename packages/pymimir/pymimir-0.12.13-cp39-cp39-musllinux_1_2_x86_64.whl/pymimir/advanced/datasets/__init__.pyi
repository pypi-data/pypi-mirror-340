...
class BidirectionalStaticTupleGraph:
    ...
    def get_forward_adjacent_edges(self, vertex_index: int) -> Iterator[_pymimir.advanced.graphs.EmptyEdge]: ...

    def get_backward_adjacent_edges(self, vertex_index: int) -> Iterator[_pymimir.advanced.graphs.EmptyEdge]: ...
    ...
    def get_edges(self) -> list[_pymimir.advanced.graphs.EmptyEdge]: ...
...
class ImmutableStaticTupleGraph:
    ...
    def get_edge(self, arg: int, /) -> _pymimir.advanced.graphs.EmptyEdge: ...
...
class StateSpace:
    ...
    @overload
    @staticmethod
    def create(context: _pymimir.advanced.search.SearchContext, options: StateSpaceOptions = ...) -> Optional[tuple[StateSpace, Optional["mimir::datasets::CertificateMaps"]]]: ...

    @overload
    @staticmethod
    def create(contexts: _pymimir.advanced.search.GeneralizedSearchContext, options: StateSpaceOptions = ...) -> list[tuple[StateSpace, Optional["mimir::datasets::CertificateMaps"]]]: ...
...
class StaticTupleGraph:
    ...
    @overload
    def add_directed_edge(self, arg0: int, arg1: int, arg2: _pymimir.advanced.graphs.EmptyEdge, /) -> int: ...
