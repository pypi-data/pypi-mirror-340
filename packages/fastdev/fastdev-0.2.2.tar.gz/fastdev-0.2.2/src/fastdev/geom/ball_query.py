...
from fastdev.geom.knn import _KNN
...
class _ball_query(Function):
    ...
    def forward(ctx, p1, p2, lengths1, lengths2, K, radius):
        ...
        """
        idx, dists = FDEV_EXT.load_module("fastdev_ball_query").ball_query(p1, p2, lengths1, lengths2, K, radius)
    ...
    def backward(ctx, grad_dists, grad_idx):
        ...
        grad_p1, grad_p2 = FDEV_EXT.load_module("fastdev_knn").knn_points_backward(
...
def ball_query(
    ...
    dists, idx = _ball_query.apply(p1, p2, lengths1, lengths2, K, radius)  # type: ignore
