...
class _knn_points(Function):
    ...
    def forward(
        ...
        idx, dists = FDEV_EXT.load_module("fastdev_knn").knn_points_idx(p1, p2, lengths1, lengths2, norm, K, version)
...
def knn_points(
    ...
    p1_dists, p1_idx = _knn_points.apply(p1, p2, lengths1, lengths2, K, version, norm, return_sorted)  # type: ignore
