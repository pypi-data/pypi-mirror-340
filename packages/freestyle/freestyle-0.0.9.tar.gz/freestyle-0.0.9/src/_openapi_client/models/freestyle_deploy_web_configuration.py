...
class FreestyleDeployWebConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entrypoint", "domains", "projectId", "nodeModules", "envVars", "serverStartCheck", "networkPermissions", "build"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "build": BuildOptions.from_dict(obj["build"]) if obj.get("build") is not None else None
        })
        return _obj
