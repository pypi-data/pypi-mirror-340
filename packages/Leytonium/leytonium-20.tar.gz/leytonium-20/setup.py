...
setup(
    ...
    py_modules = [],
    install_requires = ['aridity>=73', 'autopep8>=1.5.4', 'awscli>=1.19.53', 'docutils>=0.15.2', 'lagoon>=51', 'PyGObject>=3.42.2,<3.52.1', 'pytz>=2020.4', 'pyven>=90', 'PyYAML>=5.2', 'roman>=5', 'setuptools>=44.1.1', 'termcolor>=1.1.0', 'Unidecode>=1.3.2', 'venvpool>=19'],
