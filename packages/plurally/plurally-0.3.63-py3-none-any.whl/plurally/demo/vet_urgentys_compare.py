...
d1 = Path("/home/villqrd/veturgentys_cases/vet_urgentys_0")
d2 = Path("/home/villqrd/veturgentys_cases/vet_urgentys_1")
...
generate_html_page_with_side_by_side_diff(runs_data, out_dir, "v0.0", "v0.1")
