...
class TestFFRepValueReducer:
    ...
    def test_compute(self, idx, assert_equals_result):
        np.random.seed(1)
        data = REP_VALUE_TEST_DATA[idx]
        reducer = FFRepValueReducerFactory(infos=format_data(data, units="km/h"))
        assert_equals_result(
            build_expected_result(
                data,
                {language: reducer.compute() for language in reducer.iter_languages()},
...
class TestFFRafRepValueReducer:
        ...
        assert_equals_result(
            {
                language: {
                    ...
                    for x, around in [
                        ...
                        (1e-5, None),
                        (7.5, None),
                        (7.5, self.factory._("comprises entre")),
                    ]
                }
                for language in self.factory.iter_languages()
            }
    ...
    def test_compute(self, idx, assert_equals_result):
        np.random.seed(1)
        data = REP_VALUE_TEST_DATA[idx]
        reducer = FFRafRepValueReducerFactory(infos=format_data(data, units="km/h"))
        assert_equals_result(
            build_expected_result(
                data,
                {language: reducer.compute() for language in reducer.iter_languages()},
...
class TestAltitudeRepValueReducer:
    ...
    def test_compute(self, var_name, idx, assert_equals_result):
        np.random.seed(1)
        data = REP_VALUE_TEST_DATA[idx]
        reducer = AltitudeRepValueReducerFactory(infos={var_name: data})
        assert_equals_result(
            build_expected_result(
                data,
                {language: reducer.compute() for language in reducer.iter_languages()},
...
class TestRepValueBuilder:
    ...
    @pytest.mark.parametrize(
        "infos,reduction,expected",
        [
            # Normal template keys
            ({}, {}, ""),
            ({}, {"plain_value": ...}, "plain"),
            ...
            # ME template keys
            ({"ME": ...}, {}, ""),
            ({"ME": ...}, {"plain_value": ...}, "ME_plain"),
            ({"ME": ...}, {"mountain_value": ...}, "ME_mountain"),
            (
                {"ME": ...},
    ...
    def test_template_key(self, infos, reduction, expected):
        builder = RepValueBuilderFactory(
            infos=infos, reducer=RepValueReducerFactory(reduction=reduction)
        )
...
class TestFFRepValueBuilder:
    ...
    def test_compute(self, idx, assert_equals_result):
        np.random.seed(1)
        data = REP_VALUE_TEST_DATA[idx]
        builder = FFRepValueBuilderFactory(infos=format_data(data, units="km/h"))
        assert_equals_result(
            build_expected_result(
                data,
                {language: builder.compute() for language in builder.iter_languages()},
...
class TestFFRafRepValueBuilder:
    ...
    def test_compute(self, idx, assert_equals_result):
        np.random.seed(1)
        data = REP_VALUE_TEST_DATA[idx]
        builder = FFRafRepValueBuilderFactory(infos=format_data(data, units="km/h"))
        assert_equals_result(
            build_expected_result(
                data,
                {language: builder.compute() for language in builder.iter_languages()},
...
class TestAccumulationRepValueBuilder:
    @pytest.mark.parametrize(
        "infos,reduction,can_merge_values,expected",
        [
            ({}, {}, False, ""),
            ({"plain": ...}, {}, False, "no_acc_plain"),
            ({"plain": ...}, {"plain_value": ...}, False, "plain"),
            (
                {"plain": ...},
                {"local_plain_value": ...},
                False,
                "no_acc_plain_local_plain",
            ),
            (
                {"plain": ...},
                {"plain_value": ..., "local_plain_value": ...},
            ...
            ({"mountain": ...}, {}, False, "no_acc_mountain"),
            ({"mountain": ...}, {"mountain_value": ...}, False, "mountain"),
            (
                {"mountain": ...},
                {"local_mountain_value": ...},
                False,
            ...
            # ME keys
            ({"ME": ...}, {}, False, ""),
            ({"ME": ..., "plain": ...}, {}, False, "ME_no_acc_plain"),
            ({"ME": ..., "plain": ...}, {"plain_value": ...}, False, "ME_plain"),
            (
                {"ME": ..., "plain": ...},
                {"local_plain_value": ...},
                False,
                "ME_no_acc_plain_local_plain",
            ),
            (
                {"ME": ..., "plain": ...},
                {"plain_value": ..., "local_plain_value": ...},
            ...
            ({"ME": ..., "mountain": ...}, {}, False, "ME_no_acc_mountain"),
            (
                {"ME": ..., "mountain": ...},
                {"mountain_value": ...},
                False,
            ...
            (
                ...
                {"local_mountain_value": ...},
                False,
                "ME_no_acc_mountain_local_mountain",
            ),
            (
                {"ME": ..., "mountain": ...},
                {"mountain_value": ..., "local_mountain_value": ...},
            ...
            (
                ...
                {},
                False,
                "ME_no_acc_plain_no_acc_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"plain_value": ...},
                False,
                "ME_plain_no_acc_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"mountain_value": ...},
                False,
                "ME_no_acc_plain_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"local_plain_value": ...},
                False,
                "ME_no_acc_plain_local_plain_no_acc_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"local_mountain_value": ...},
                False,
                "ME_no_acc_plain_no_acc_mountain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"plain_value": ..., "mountain_value": ...},
            ...
            (
                ...
                {"plain_value": ..., "local_plain_value": ...},
                False,
                "ME_local_plain_no_acc_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"plain_value": ..., "local_mountain_value": ...},
                False,
                "ME_plain_no_acc_mountain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"mountain_value": ..., "local_plain_value": ...},
                False,
                "ME_no_acc_plain_local_plain_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"mountain_value": ..., "local_mountain_value": ...},
                False,
                "ME_no_acc_plain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"local_plain_value": ..., "local_mountain_value": ...},
                False,
                "ME_no_acc_plain_local_plain_no_acc_mountain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {"plain_value": ..., "mountain_value": ..., "local_plain_value": ...},
            ...
            (
                ...
                False,
                "ME_local_plain_no_acc_mountain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {
                ...
                False,
                "ME_no_acc_plain_local_plain_local_mountain",
            ),
            (
                {"ME": ..., "plain": ..., "mountain": ...},
                {
    ...
    def test_template_key(self, infos, reduction, can_merge_values, expected):
        builder = AccumulationRepValueBuilderFactory(
            infos=infos,
            reducer=AccumulationRepValueReducerFactory(
                infos=infos,
                reduction=reduction,
...
class TestAltitudeRepValueBuilder:
    ...
    def test_compute_both(self, idx1, idx2, assert_equals_result):
        ...
        builder = AltitudeRepValueBuilderFactory(
            infos={"NEIPOT1__SOL": data1, "NEIPOT24__SOL": data2}
        )
        assert_equals_result(
            build_expected_result(
