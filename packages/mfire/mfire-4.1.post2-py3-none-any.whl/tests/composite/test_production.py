...
class TestProductionComposite:
    ...
    @pytest.mark.parametrize(
        ...
        [
                ...
                [
                    {
                        ...
                        "risk_infos": {},
                        "critical_values": {
                            "RAF__HAUTEUR10": {"plain": {"value": 66.0}}
                        },
                    }
                ],
            ),
            ...
            # are empty -> empty returning risk_infos
            (
                ["Rafales"],  # hazard_names
                [
                    {
            ...
            # critical_values conf are empty -> returning risk_infos contains
            ...
            # critical_values conf are not empty -> returning risk_infos contains
            ...
            (
                ...
                [
                    ...
                    },
                    {
                        ...
                        "risk_infos": {},
                        "critical_values": {
                            "RAF__HAUTEUR10": {"mountain": {"value": 105.0}}
                        },
                    },
                ],
            ),
                ...
                [
                    {
                        ...
                        "risk_infos": {},
                        "critical_values": {
                            "RAF__HAUTEUR10": {"plain": {"value": 70.0}}
                        },
                    }
                ],
            ),
    ...
    def test_get_risk_infos(self, hazard_names, conf: list[dict], assert_equals_result):
        """Test ProductionComposite.get_risk_infos.

        synth_geo_id, hazard_names and field_name are the arguments of the test function
        ProductionComposite.get_risk_infos.

        conf is a list of RiskComponentComposite configurations. For each risk component
        conf:
        ...
        def all_sub_areas(geo):
            """Factory of all_sub_areas method.

            It simulates that id3 synth_geo_id is the union of id2 and id1 geo ids.
            """
            if geo in ["id1", "id2"]:
                return [geo]
            if geo == "id3":
        ...
        with patch(
            "mfire.text.risk.builder.RiskBuilder.compute", lambda builder: "Risque text"
        ), patch(
            "mfire.text.manager.Manager._compute_text",
