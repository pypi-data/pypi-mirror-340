...
class ServiceParam(object):
    ...
    def __init__(self, name=None, values=None):  # noqa: E501
        """ServiceParam - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._values = None
    ...
    @property
    def name(self):
        """Gets the name of this ServiceParam.  # noqa: E501


        :return: The name of this ServiceParam.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ServiceParam.


        :param name: The name of this ServiceParam.  # noqa: E501
        :type: str
        """
    ...
    @property
    def values(self):
        """Gets the values of this ServiceParam.  # noqa: E501


        :return: The values of this ServiceParam.  # noqa: E501
        :rtype: list[str]
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this ServiceParam.


        :param values: The values of this ServiceParam.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ServiceParam, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ServiceParam):
            return False
