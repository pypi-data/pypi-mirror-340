...
Refer to the Terraform Registry for docs: [`okta_email_template_settings`](https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings).
'''
...
class EmailTemplateSettings(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings okta_email_template_settings}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings okta_email_template_settings} Resource.

        :param scope: The scope in which to define this construct.
        :param id: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param brand_id: The ID of the brand. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#brand_id EmailTemplateSettings#brand_id}
        :param recipients: The recipients the emails of this template will be sent to - Valid values: ``ALL_USERS``, ``ADMINS_ONLY``, ``NO_USERS``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#recipients EmailTemplateSettings#recipients}
        :param template_name: Email template name - Example values: ``AccountLockout``,``ADForgotPassword``,``ADForgotPasswordDenied``,``ADSelfServiceUnlock``,``ADUserActivation``,``AuthenticatorEnrolled``,``AuthenticatorReset``,``ChangeEmailConfirmation``,``EmailChallenge``,``EmailChangeConfirmation``,``EmailFactorVerification``,``ForgotPassword``,``ForgotPasswordDenied``,``IGAReviewerEndNotification``,``IGAReviewerNotification``,``IGAReviewerPendingNotification``,``IGAReviewerReassigned``,``LDAPForgotPassword``,``LDAPForgotPasswordDenied``,``LDAPSelfServiceUnlock``,``LDAPUserActivation``,``MyAccountChangeConfirmation``,``NewSignOnNotification``,``OktaVerifyActivation``,``PasswordChanged``,``PasswordResetByAdmin``,``PendingEmailChange``,``RegistrationActivation``,``RegistrationEmailVerification``,``SelfServiceUnlock``,``SelfServiceUnlockOnUnlockedAccount``,``UserActivation``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#template_name EmailTemplateSettings#template_name}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing EmailTemplateSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#import import section} in the documentation of this resource for the id to use
...
class EmailTemplateSettingsConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def brand_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#brand_id EmailTemplateSettings#brand_id}
        '''
    ...
    def recipients(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/4.16.0/docs/resources/email_template_settings#recipients EmailTemplateSettings#recipients}
        '''
