...
- Add pagination headers to the response object from metadata_api
...
- Pull classes 'up' a level to allow shorter imports like `from metadata_api import MetadataClient`.
