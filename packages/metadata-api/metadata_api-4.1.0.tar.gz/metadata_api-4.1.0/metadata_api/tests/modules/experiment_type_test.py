...
from metadata_api.metadata_api import MetadataClient
...
class ExperimentTypeTest(ModuleBase, unittest.TestCase):
    def setUp(self):
        ...
        __unique_name1 = Generators.generate_unique_name('ExperimentType01')
        ...
        __unique_name_upd = Generators.generate_unique_name('ExperimTypeUpd1')
    ...
    def test_create_experiment_type(self):
        exp_typ_01 = ExperimentType(
            metadata_api=self.mdc_client,
        ...
        # Get entry by name
        #
        result3 = ExperimentType.get_by_name(self.mdc_client,
