...
class DataTypeTest(ModuleBase, unittest.TestCase):
    def setUp(self):
        ...
        __unique_name1 = Generators.generate_unique_name('DataType01')
        ...
        __unique_name_upd = Generators.generate_unique_name('DataTypeUpd1')
    ...
    def test_create_data_type(self):
        ...
        # Get entry by name
        #
        result3 = DataType.get_by_name(self.mdc_client,
                                       data_type_name)
