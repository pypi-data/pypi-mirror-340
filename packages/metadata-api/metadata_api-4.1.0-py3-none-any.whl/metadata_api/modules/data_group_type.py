...
class DataGroupType:
    def __init__(self, metadata_api,
                 name, identifier,
    ...
    def create(self):
        mdc_client = self.metadata_api
        response = mdc_client.create_data_group_type_api(self.__get_resource())
    ...
    def update(self):
        mdc_client = self.metadata_api
        response = mdc_client.update_data_group_type_api(self.id,
                                                         self.__get_resource())
    ...
    def get_all_by_name(mdc_client, name, page=DEF_PAGE,
        ...
        response = mdc_client.get_all_data_group_types_by_name_api(
            name, page, page_size)
    ...
    @staticmethod
    def get_all(mdc_client, page=DEF_PAGE, page_size=DEF_PAGE_SIZE):
        response = mdc_client.get_all_data_group_types_api(page, page_size)
