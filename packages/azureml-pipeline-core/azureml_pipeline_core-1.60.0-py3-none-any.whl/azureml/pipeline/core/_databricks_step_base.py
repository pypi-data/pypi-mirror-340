    ...
    def __init__(self, name, inputs=None, outputs=None, existing_cluster_id=None, spark_version=None,
        ...
        if existing_cluster_id is None:
            ...
            if init_scripts is not None:
                logging.warning(
                    "Init script stored in DBFS will stop work after Dec 1, 2023 announced by Databricks. "
                    "To mitigate the issue, please 1) use global init scripts in databricks following "
                    "https://learn.microsoft.com/azure/databricks/init-scripts/global "  # noqa: E501
                    "2) comment out the line of init_scripts in your AzureML databricks step.")
