...
class MetricGroup(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('job_name', 'metric_name', 'metrics')
    job_name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='jobName')

    metric_name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='metricName')

    metrics = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(JSON))), graphql_name='metrics')
...
class Query(sgqlc.types.Type):
    ...
    advanced_metric_groups = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MetricGroup))), graphql_name='advancedMetricGroups', args=sgqlc.types.ArgDict((
    ...
    * `job_names` (`[String!]!`)None
    ...
    list_metric_jobs = sgqlc.types.Field(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(MetricGroup))), graphql_name='listMetricJobs', args=sgqlc.types.ArgDict((
        ('job_names', sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))), graphql_name='jobNames', default=None)),
