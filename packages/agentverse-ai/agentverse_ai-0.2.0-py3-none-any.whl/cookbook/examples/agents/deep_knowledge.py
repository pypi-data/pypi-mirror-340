...
In this example, the agent uses the AgentVerse-AI documentation as a knowledge base

Key Features:
- Iteratively searches a knowledge base
- Source attribution and citations

Run `pip install openai lancedb tantivy inquirer agentverse_ai` to install dependencies.
"""
...
def initialize_knowledge_base():
    ...
    Here we use AgentVerse-AI docs as an example, but you can replace with any relevant URLs
    """
...
def get_example_topics() -> List[str]:
    ...
    return [
        "What are AI agents and how do they work in AgentVerse-AI?",
        "What chunking strategies does AgentVerse-AI support for text processing?",
        "How can I implement custom tools in AgentVerse-AI?",
        "How does knowledge retrieval work in AgentVerse-AI?",
        "What types of embeddings does AgentVerse-AI support?",
    ]
...
"""
Explore AgentVerse-AI's capabilities with these queries:
1. "What are the different types of agents in AgentVerse-AI?"
2. "How does AgentVerse-AI handle knowledge base management?"
3. "What embedding models does AgentVerse-AI support?"
4. "How can I implement custom tools in AgentVerse-AI?"
5. "What storage options are available for workflow caching?"
6. "How does AgentVerse-AI handle streaming responses?"
7. "What types of LLM providers does AgentVerse-AI support?"
