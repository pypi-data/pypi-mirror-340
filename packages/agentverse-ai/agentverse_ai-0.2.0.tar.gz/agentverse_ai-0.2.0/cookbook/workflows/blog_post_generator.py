...
Run `pip install openai duckduckgo-search newspaper4k lxml_html_clean sqlalchemy agentverse_ai` to install dependencies.
"""
...
from agentverse_ai.workflow import RunEvent, RunResponse, Workflow
...
if __name__ == "__main__":
    ...
    generate_blog_post = BlogPostGenerator(
        ...
        storage=SqliteStorage(
            ...
            db_file="tmp/agentverse_ai_workflows.db",
        ),
        debug_mode=True,
    )
