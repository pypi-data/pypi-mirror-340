...
from ledwallcontroller import Controller, Multivision, OnlyGlass, TCPHandler
...
class TestMultivision:
    ...
    def test_parse_response_invalid_format(self, multivision):
        ...
        assert multivision.parse_response(response) is None
...
class TestOnlyGlass:
    ...
    def test_parse_response_invalid_format(self, onlyglass):
        response = b"WRONGFORMAT"
        assert onlyglass.parse_response(response) is None
