import argparse
import inspect
from .core import Sort, DoublyLinkedList, Pushdown, DEA
...
def main() -> None:
    ...
    get_parser.add_argument(
        "target",
        choices=["bubble", "quick", "merge", "heap", "shell", "radix", "selection", "insertion", "counting", "bucket", "cocktail", "all", "DoublyLinkedList", "Pushdown", "DEA"],
    ...
    if args.command == "sort":
        ...
        elif args.target == "DEA":
            code = inspect.getsource(DEA)  # Retrieve DEA class code
        else:
