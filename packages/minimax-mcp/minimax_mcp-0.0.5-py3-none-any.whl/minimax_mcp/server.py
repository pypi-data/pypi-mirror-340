...
def voice_clone(
    ...
    try:
        ...
        with open(file, 'rb') as f:
            ...
            response_data = api_client.post("/v1/files/upload", files=files, data=data, headers={'Authorization': f'Bearer {api_key}'})
        ...
        demo_audio_response = requests.get(response_data.get("demo_audio"))
