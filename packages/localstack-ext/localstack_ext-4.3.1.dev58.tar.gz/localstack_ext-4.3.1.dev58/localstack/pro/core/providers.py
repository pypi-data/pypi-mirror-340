...
@pro_aws_provider(api=_G,name=_D)
...
@pro_aws_provider(api=_H,name=_D)
...
@pro_aws_provider(should_load=lambda:is_pro_activated(),requires_license=_C)
...
@pro_aws_provider(api='bedrock-runtime',should_load=lambda:is_pro_activated(),requires_license=_C)
...
@pro_aws_provider(should_load=lambda:is_pro_activated()and config_ext.ENABLE_DMS,requires_license=_C)
...
@pro_aws_provider(api='kinesisanalyticsv2',name=_I)
...
@pro_aws_provider(api='rds',name=_I)
def rds_legacy():from localstack.pro.core.services.rds.legacy.provider import RdsProvider as A;B=A();return Service.for_provider(B,dispatch_table_factory=MotoFallbackDispatcher)
...
@pro_aws_provider(api=_J,name=_D)
...
@pro_aws_provider(api=_E,name='asf_pro')
...
@pro_aws_provider(api='verifiedpermissions',requires_license=_C)
