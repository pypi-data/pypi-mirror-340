...
def generate_original_array() -> np.ndarray:
    ...
    array = load_volume(
        get_atlas_path(Resolution.MICRONS_25),
...
class ImageWidget(QtWidgets.QWidget):
    def __init__(
        ...
        transformation: Optional[transform.AffineTransform | QtGui.QTransform] = None,
        ...
        if isinstance(transformation, QtGui.QTransform):
            pixmap_item.setTransform(transformation)
...
class RegistrationWidget(QtWidgets.QWidget):
    def __init__(self, parent: Optional[QtWidgets.QWidget] = None) -> None:
        ...
        #
        registered_image_widget = ImageWidget(transformed_image_widget.array)

        self.registered_image_widget = registered_image_widget
        ...
        layout.addWidget(registered_image_widget, 0, 2)
    ...
    def transform(self) -> None:
        ...
        self.registered_image_widget.pixmap_item.setTransform(q_transform.inverted()[0])
    ...
    def clear(self) -> None:
        ...
        self.registered_image_widget.pixmap_item.resetTransform()
