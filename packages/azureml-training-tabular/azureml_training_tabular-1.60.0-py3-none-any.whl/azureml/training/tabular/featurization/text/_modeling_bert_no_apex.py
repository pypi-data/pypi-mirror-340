...
if torch_present:
    ...
    class BertModel(BertPreTrainedModel):
        ...
        def forward(self, input_ids, token_type_ids=None, attention_mask=None, position_ids=None, head_mask=None):
            ...
            # Commenting out below block as it no longer works in upgraded environments.
            # fp16 has been disabled for years in prod.
            ...
            if head_mask is not None:
                ...
                # Commenting out below line for compatibility in upgraded environments -- fp16 is also disabled.
