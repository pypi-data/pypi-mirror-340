...
class TimeSeriesDataConfig(object):
    ...
    def __init__(
        ...
        if (
            time_series_id_column_names == TimeSeriesInternal.DUMMY_GRAIN_COLUMN
            or time_series_id_column_names == [TimeSeriesInternal.DUMMY_GRAIN_COLUMN]
        ) and TimeSeriesInternal.DUMMY_GRAIN_COLUMN not in X.columns:
