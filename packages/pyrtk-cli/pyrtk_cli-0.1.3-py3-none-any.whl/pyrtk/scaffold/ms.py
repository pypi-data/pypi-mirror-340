...
def create_ms_structure(name: str):
    base = Path(name)
...
""",
    ...
    # Archivos vacíos
    empty_files = [
        base / "app/schemas/response.py",
        base / "app/models/user.py",
        base / "app/services/user_service.py",
        base / "app/lib/db.py",
        base / "README.md",
        base / ".env",
        base / ".gitignore",
    ...
    with Progress() as progress:
        task = progress.add_task("[magenta]Creating MS project files...", total=len(folders) + len(files_with_content) + len(empty_files))
