...
latt_const = 1
latt, sites, all_neigh_idx, rotvecs = build_latt(lat_type,nx,ny,nz, vacuum=10, latt_const=latt_const)
nat=sites.shape[-2]
...
if __name__ == '__main__':
    """ Example of building a   bimodal   EA model with 
    unbalanced positive (FM) and negative (AFM) exchanges """
    ...
    """ Example of building a Gaussian-random EA model with 
    ...
    """ Statistics of the random bonds for double-checking """
    ...
    """ Verbose the bond exchanges for double-checking """
    #print (ham._BL_exch[0]._J_iso)
    #ham.verbose_all_interactions()
    ham.save_ham_for_spirit(latt_sc, sites_sc, latt_const, input_file='input.cfg')
