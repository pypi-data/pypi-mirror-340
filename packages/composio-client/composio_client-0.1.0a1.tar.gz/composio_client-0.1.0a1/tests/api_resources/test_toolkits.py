...
class TestToolkits:
    ...
    @parametrize
    def test_method_retrieve_categories(self, client: ComposioSDK) -> None:
        toolkit = client.toolkits.retrieve_categories()
        assert_matches_type(ToolkitRetrieveCategoriesResponse, toolkit, path=["response"])

    @parametrize
    def test_raw_response_retrieve_categories(self, client: ComposioSDK) -> None:
    ...
    @parametrize
    def test_streaming_response_retrieve_categories(self, client: ComposioSDK) -> None:
...
class TestAsyncToolkits:
    ...
    @parametrize
    async def test_method_retrieve_categories(self, async_client: AsyncComposioSDK) -> None:
        toolkit = await async_client.toolkits.retrieve_categories()
        assert_matches_type(ToolkitRetrieveCategoriesResponse, toolkit, path=["response"])

    @parametrize
    async def test_raw_response_retrieve_categories(self, async_client: AsyncComposioSDK) -> None:
    ...
    @parametrize
    async def test_streaming_response_retrieve_categories(self, async_client: AsyncComposioSDK) -> None:
