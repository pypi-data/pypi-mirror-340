...
class TestAPIKey:
    ...
    @parametrize
    def test_method_regenerate(self, client: ComposioSDK) -> None:
        api_key = client.org.api_key.regenerate()
        assert_matches_type(APIKeyRegenerateResponse, api_key, path=["response"])

    @parametrize
    def test_raw_response_regenerate(self, client: ComposioSDK) -> None:
    ...
    @parametrize
    def test_streaming_response_regenerate(self, client: ComposioSDK) -> None:
...
class TestAsyncAPIKey:
    ...
    @parametrize
    async def test_method_regenerate(self, async_client: AsyncComposioSDK) -> None:
        api_key = await async_client.org.api_key.regenerate()
        assert_matches_type(APIKeyRegenerateResponse, api_key, path=["response"])

    @parametrize
    async def test_raw_response_regenerate(self, async_client: AsyncComposioSDK) -> None:
    ...
    @parametrize
    async def test_streaming_response_regenerate(self, async_client: AsyncComposioSDK) -> None:
