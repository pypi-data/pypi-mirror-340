...
class RemoteUI:
    ...
    async def load_backend(self) -> bool:
        ...
        try:
            ...
            msg = "Can't update remote details from KS Assistant cloud"
        ...
        # Extract data
        _LOGGER.warning("Retrieve instance data: %s", data)
        ...
        if self.cloud.client.aiohttp_runner is None:
            ...
            # aiohttp_runner comes available when KS Assistant has started.
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            self.cloud.client.user_message(
                ...
                "KS Assistant Cloud error",
                "Remote connection is disabled because this KS Assistant instance "
