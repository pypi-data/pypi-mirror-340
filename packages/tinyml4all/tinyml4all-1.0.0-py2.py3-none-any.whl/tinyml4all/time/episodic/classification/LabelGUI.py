...
class LabelGUI:
    ...
    def __call__(self, *args, **kwargs):
        ...
        chart.add_var("T", T)
        chart.set_alpine(script=asset("time-episodic-label-ui/alpine.js"), template=asset("time-episodic-label-ui/alpine.html"))
        chart.before_init(asset("time-episodic-label-ui/beforeInit.js"))
