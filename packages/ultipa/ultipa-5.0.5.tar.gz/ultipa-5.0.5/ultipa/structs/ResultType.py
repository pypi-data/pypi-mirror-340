...
class ResultType(Enum):
	...
	def getTypeStr(type):
		...
		elif type == UltipaPropertyType.LIST.value:
			return ResultType.RESULT_TYPE_ATTR
	...
	@staticmethod
	def getTypeen(type):
		if type == ResultType.RESULT_TYPE_PATH.value:
			return ResultType.RESULT_TYPE_PATH
		elif type == ResultType.RESULT_TYPE_NODE.value:
			return ResultType.RESULT_TYPE_NODE
		elif type == ResultType.RESULT_TYPE_EDGE.value:
			return ResultType.RESULT_TYPE_EDGE
		elif type == ResultType.RESULT_TYPE_ATTR.value:
			return ResultType.RESULT_TYPE_ATTR
		elif type == UltipaPropertyType.LIST.value:
			return ResultType.RESULT_TYPE_ATTR
		elif type == ResultType.RESULT_TYPE_TABLE.value:
			return ResultType.RESULT_TYPE_TABLE
		elif type == ResultType.RESULT_TYPE_UNSET.value:
			return ResultType.RESULT_TYPE_UNSET
		# elif type == ResultType.RESULT_TYPE_GRAPH:
		# 	return "GRAPH"
		elif type == ResultType.RESULT_TYPE_ExplainPlan.value:
			return ResultType.RESULT_TYPE_ExplainPlan
		else:
			return type