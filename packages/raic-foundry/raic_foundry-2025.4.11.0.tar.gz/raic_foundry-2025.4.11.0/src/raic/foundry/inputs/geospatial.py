...
def prepare(image_file_path: Path, root_path: Path, max_size_px: int = 4896) -> Generator[Path, Any, None]:
...
def tile_raster(source_dataset: DatasetReader, output_folder: Path | str | None = None, tile_size_px: int = 4896, tile_oxerlap_px: int = 0, bindexes = None,  src_alpha = None, dst_alpha = None) -> list[Path]:
