...
# Monkey-patch Datura in the datura_py package
import datura_py
datura_py.Datura = lambda api_key: DummyDatura()

# Import the tool to test
from langchain_datura.tools import DaturaToolTool
