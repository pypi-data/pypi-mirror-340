...
def encode_image(path: str, data: Annotated[ArrayLike, dict(dtype='uint8', order='C', device='cuda')], *, pix_fmt: str = 'rgb24', encode_config: "spdl::core::EncodeConfig" | None = None) -> None: ...
