...
def gnow_hour():
    '''
Get Current Hour | 获取当前小时

gnow_hour() retrieves the current hour in the 24-hour format based on the system time.

Returns | 返回:
- int: The current hour (0-23).

Example | 示例:
current_hour = gnow_hour()
gout("Current Hour:", current_hour)
'''
...
def __dir__():
    return [
        ...
        "gnow_hour","gnow_min","gnow_second"
    ]
