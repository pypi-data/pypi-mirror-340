...
class NetworkStructure:
    ...
    def find_nearest(self, data_coord: Coord, max_dist: float) -> tuple[int | None, float, int | None]: ...
    def road_distance(
        self, data_coord: Coord, nd_a_idx: int, nd_b_idx: int
    ) -> tuple[float, int | None, int | None]: ...
    def closest_intersections(
        self, data_coord: Coord, pred_map: list[int | None], last_nd_idx: int
    ) -> tuple[float, int | None, int | None]: ...
    def assign_to_network(self, data_coord: Coord, max_dist: float) -> tuple[int | None, int | None]: ...
