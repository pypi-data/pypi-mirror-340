...
from gable.cli.commands.asset_plugins.baseclass import AssetPluginAbstract
...
from gable.cli.commands.data_asset_register_plugin import (
    extracted_asset_to_register_asset_request,
    plugin_register,
)
...
def register_data_asset(
    ...
    if source_type == SourceType.mysql:
        ...
        plugin_register(asset_plugin, kwargs, ctx)
        return
    elif source_type in SCHEMA_SOURCE_TYPES:
