...
class TestUploadModel:
    ...
    def test_run_framework_empty(self, mock_user):
        ...
        current_dir = Path(__file__).parent
        model_path = os.path.join(current_dir, "test_models/invalid_model_empty_framework")
    ...
    def test_run_classes_empty(self, mock_user):
        """Test that model upload fails appropriately with invalid model"""
        current_dir = Path(__file__).parent
        model_path = os.path.join(current_dir, "test_models/invalid_model_empty_classes")
    ...
    def test_run_num_features_empty(self, mock_user):
        """Test that model upload fails appropriately with invalid model"""
        current_dir = Path(__file__).parent
        model_path = os.path.join(current_dir, "test_models/invalid_model_empty_num_features")
