...
from nasr.__past__ import BytesIO, long, to_byte, unicode, xrange
from nasr.build.DataComposerInterface import deriveModuleConstantsBlobName
from nasr.Builtins import builtin_exception_values_list, builtin_named_values
...
from nasr.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from nasr.Tracing import data_composer_logger
from nasr.utils.FileOperations import getFileSize, listDir, syncFileOutput
from nasr.utils.Json import writeJsonToFilename
...
def main():
    ...
    # where main PyTanic put the .const files.
