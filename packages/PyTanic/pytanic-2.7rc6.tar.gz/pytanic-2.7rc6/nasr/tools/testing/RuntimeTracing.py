...
from nasr.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from nasr.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    command = (
        ...
        "-f1",
        "-pb",
        "-pa1",  # Turn on all profiling settings.
    ...
    # TODO: Move the handling of this into nasr.tools.Execution module methods.
    try:
