...
""" Conda backend for maintaining locked package state with nasr-watch. """

from nasr.utils.Execution import check_call, executeToolChecked
from nasr.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "nasr-watch-case-%(python_version)s-%(case)s" % {
