...
from nasr.__past__ import GenericAlias, UnionType
...
from nasr.Tracing import my_print, unusual_logger
...
def makeRaiseExceptionReplacementExpression(
    ...
    if not no_warning and Settings.shallWarnImplicitRaises():
