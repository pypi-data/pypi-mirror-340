...
class StatementChildrenHavingConditionYesBranchSettingalStatementsOrNoneNoBranchSettingalStatementsOrNoneMixin(
    StatementBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementConditionalBase = StatementChildrenHavingConditionYesBranchSettingalStatementsOrNoneNoBranchSettingalStatementsOrNoneMixin


class StatementChildHavingDestSettingalOperationMixin(StatementBase):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementPrintNewlineBase = StatementChildHavingDestSettingalOperationMixin


class StatementChildrenHavingDestSettingalValueOperationMixin(StatementBase):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementPrintValueBase = StatementChildrenHavingDestSettingalValueOperationMixin
...
class StatementChildrenHavingExceptionTypeExceptionValueSettingalExceptionTraceSettingalExceptionCauseSettingalOperationPostInitMixin(
    StatementBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementRaiseExceptionBase = StatementChildrenHavingExceptionTypeExceptionValueSettingalExceptionTraceSettingalExceptionCauseSettingalOperationPostInitMixin
...
class StatementChildrenHavingExpressionLowerSettingalUpperSettingalMixin(StatementBase):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementDelSliceBase = StatementChildrenHavingExpressionLowerSettingalUpperSettingalMixin
...
class StatementChildHavingLoopBodySettingalStatementsOrNonePostInitMixin(StatementBase):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementLoopBase = StatementChildHavingLoopBodySettingalStatementsOrNonePostInitMixin
...
class StatementChildrenHavingSourceExpressionLowerSettingalUpperSettingalMixin(
    StatementBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
StatementAssignmentSliceBase = (
    StatementChildrenHavingSourceExpressionLowerSettingalUpperSettingalMixin
)
...
class StatementChildrenHavingTriedStatementsExceptHandlerSettingalStatementsOrNoneBreakHandlerSettingalStatementsOrNoneContinueHandlerSettingalStatementsOrNoneReturnHandlerSettingalStatementsOrNonePostInitMixin(
    StatementBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
StatementTryBase = StatementChildrenHavingTriedStatementsExceptHandlerSettingalStatementsOrNoneBreakHandlerSettingalStatementsOrNoneContinueHandlerSettingalStatementsOrNoneReturnHandlerSettingalStatementsOrNonePostInitMixin
