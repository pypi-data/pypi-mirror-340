...
from .ChildrenHavingMixins import (
    ...
    ChildrenHavingListArgKeySettingalReverseMixin,
...
class ExpressionListOperationSort3(
    ChildrenHavingListArgKeySettingalReverseMixin, ExpressionBase
):
    ...
    def __init__(self, list_arg, key, reverse, source_ref):
        ChildrenHavingListArgKeySettingalReverseMixin.__init__(
            self,
            list_arg=list_arg,
            key=key,
            reverse=reverse,
