...
class ChildrenHavingArgsTupleNameSettingalObjSettingalFinalNoRaiseForRaiseMixin(
    ExpressionBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ExpressionBuiltinMakeExceptionAttributeErrorBase = (
    ChildrenHavingArgsTupleNameSettingalObjSettingalFinalNoRaiseForRaiseMixin
)


class ChildrenHavingArgsTupleNameSettingalPathSettingalFinalNoRaiseForRaiseMixin(
    ExpressionBase
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ExpressionBuiltinMakeExceptionImportErrorBase = (
    ChildrenHavingArgsTupleNameSettingalPathSettingalFinalNoRaiseForRaiseMixin
)
...
class ChildHavingPromptSettingalFinalMixin(ExpressionBase):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ExpressionBuiltinInputBase = ChildHavingPromptSettingalFinalMixin
