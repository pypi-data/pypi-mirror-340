...
spell-checker: ignore experimental_attributes experimental_autograph_settings
...
class ModuleChildrenHavingBodySettingalStatementsOrNoneFunctionsTupleMixin(object):
...
ChildrenCompiledPythonModuleMixin = (
    ModuleChildrenHavingBodySettingalStatementsOrNoneFunctionsTupleMixin
)
...
class ChildHavingBodySettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionAsyncgenObjectBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionClassDictBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionClassDictBodyP2Mixin = ChildHavingBodySettingalMixin
ChildrenExpressionClassMappingBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionCoroutineObjectBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionFunctionBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionFunctionPureBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionFunctionPureInlineConstBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionGeneratorObjectBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionOutlineBodyMixin = ChildHavingBodySettingalMixin
ChildrenExpressionOutlineFunctionMixin = ChildHavingBodySettingalMixin
...
class ChildrenHavingDefaultsTupleKwDefaultsSettingalAnnotationsSettingalFunctionRefMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionFunctionCreationMixin = (
    ChildrenHavingDefaultsTupleKwDefaultsSettingalAnnotationsSettingalFunctionRefMixin
)
...
class ChildHavingExitCodeSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionSysExitMixin = ChildHavingExitCodeSettingalMixin
...
class ChildrenHavingExpressionNameDefaultSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinGetattrMixin = ChildrenHavingExpressionNameDefaultSettingalMixin
...
class ChildrenHavingFilenameModeSettingalBufferingSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionBuiltinOpenP2Mixin = (
    ChildrenHavingFilenameModeSettingalBufferingSettingalMixin
)


class ChildrenHavingFilenameModeSettingalBufferingSettingalEncodingSettingalErrorsSettingalNewlineSettingalClosefdSettingalOpenerSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinOpenP3Mixin = ChildrenHavingFilenameModeSettingalBufferingSettingalEncodingSettingalErrorsSettingalNewlineSettingalClosefdSettingalOpenerSettingalMixin


class (
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
    ...
    def __init__(
        ...
        experimental_autograph_settings,
        ...
        if experimental_autograph_settings is not None:
            experimental_autograph_settings.parent = self

        self.subnode_experimental_autograph_settings = experimental_autograph_settings
    ...
    def getVisitableNodes(self):
        ...
        if value is None:
            ...
            result.append(value)
        value = self.subnode_experimental_autograph_settings
        if value is None:
            pass
        else:
            result.append(value)
    ...
    def getVisitableNodesNamed(self):
        ...
        return (
            ...
            (
                "experimental_autograph_settings",
                self.subnode_experimental_autograph_settings,
            ),
    ...
    def replaceChild(self, old_node, new_node):
        ...
        if old_node is value:
            ...
            self.subnode_experimental_autograph_settings = new_node
    ...
    def getCloneArgs(self):
        ...
        values = {
            ...
            "experimental_autograph_settings": (
                self.subnode_experimental_autograph_settings.makeClone()
                if self.subnode_experimental_autograph_settings is not None
                else None
            ),
            "experimental_attributes": (
    ...
    def finalize(self):
        ...
        if self.subnode_experimental_autograph_settings is not None:
            self.subnode_experimental_autograph_settings.finalize()
        del self.subnode_experimental_autograph_settings
        if self.subnode_experimental_attributes is not None:
    ...
    def collectVariableAccesses(self, emit_read, emit_write):
        ...
        subnode_experimental_autograph_settings = (
            self.subnode_experimental_autograph_settings
        )

        if subnode_experimental_autograph_settings is not None:
            self.subnode_experimental_autograph_settings.collectVariableAccesses(
                emit_read, emit_write
            )
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionTensorflowFunctionMixin = 
ChildrenExpressionTensorflowFunctionCallMixin = 
...
class ChildrenHavingGroupNameSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionPkgResourcesIterEntryPointsMixin = (
    ChildrenHavingGroupNameSettingalMixin
)
...
class ChildrenHavingKwDefaultsSettingalDefaultsTupleAnnotationsSettingalFunctionRefMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionFunctionCreationOldMixin = (
    ChildrenHavingKwDefaultsSettingalDefaultsTupleAnnotationsSettingalFunctionRefMixin
)
...
class ChildrenHavingListArgKeySettingalReverseMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionListOperationSort3Mixin = ChildrenHavingListArgKeySettingalReverseMixin
...
class ChildrenHavingNameGlobalsArgSettingalLocalsArgSettingalFromlistSettingalLevelSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinImportMixin = ChildrenHavingNameGlobalsArgSettingalLocalsArgSettingalFromlistSettingalLevelSettingalMixin


class ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionCtypesCdllMixin = ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalMixin


class ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalWinmodeSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionCtypesCdllMixin = ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalWinmodeSettingalMixin


class ChildrenHavingNamePackageSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionImportlibImportModuleCallMixin = (
    ChildrenHavingNamePackageSettingalMixin
)
...
class ChildrenHavingPackageResourceEncodingSettingalErrorsSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionImportlibResourcesBackportReadTextMixin = (
    ChildrenHavingPackageResourceEncodingSettingalErrorsSettingalMixin
)
...
class ChildrenHavingPackageSettingalResourcesTupleEncodingSettingalErrorsSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionImportlibResourcesReadTextMixin = (
    ChildrenHavingPackageSettingalResourcesTupleEncodingSettingalErrorsSettingalMixin
)
...
class ChildHavingPathSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionOsListdirMixin = ChildHavingPathSettingalMixin


class ChildrenHavingPathSettingalDirFdSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionOsLstatMixin = ChildrenHavingPathSettingalDirFdSettingalMixin


class ChildrenHavingPathSettingalDirFdSettingalFollowSymlinksSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionOsStatMixin = (
    ChildrenHavingPathSettingalDirFdSettingalFollowSymlinksSettingalMixin
)


class ChildrenHavingPosArgSettingalPairsTupleMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinDictMixin = ChildrenHavingPosArgSettingalPairsTupleMixin


class ChildrenHavingRealSettingalImagMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinComplex2Mixin = ChildrenHavingRealSettingalImagMixin
...
class ChildrenHavingSourceFilenameModeFlagsSettingalDontInheritSettingalOptimizeSettingalMixin(
    object
):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinCompileMixin = ChildrenHavingSourceFilenameModeFlagsSettingalDontInheritSettingalOptimizeSettingalMixin
...
class ChildrenHavingSourceCodeGlobalsArgLocalsArgClosureSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionBuiltinExecMixin = (
    ChildrenHavingSourceCodeGlobalsArgLocalsArgClosureSettingalMixin
)
...
class ChildrenHavingStringEncodingSettingalErrorsSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionBuiltinBytearray3Mixin = (
    ChildrenHavingStringEncodingSettingalErrorsSettingalMixin
)
...
class ChildrenHavingTypeArgArgsSettingalKwargsSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionTypeOperationPrepareMixin = (
    ChildrenHavingTypeArgArgsSettingalKwargsSettingalMixin
)
...
class ChildrenHavingValueSettingalBaseMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
# Assign the names that are easier to import with a stable name.
ChildrenExpressionBuiltinInt2Mixin = ChildrenHavingValueSettingalBaseMixin
ChildrenExpressionBuiltinLong2Mixin = ChildrenHavingValueSettingalBaseMixin


class ChildrenHavingValueSettingalEncodingSettingalErrorsSettingalMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionBuiltinBytes3Mixin = (
    ChildrenHavingValueSettingalEncodingSettingalErrorsSettingalMixin
)
...
class ChildrenHavingValueFormatSpecSettingalAutoNoneEmptyStrMixin(object):
    # Mixins are not allowed to specify slots, pylint: disable=assigning-non-slot
    __slots__ = ()
...
ChildrenExpressionBuiltinFormatMixin = (
    ChildrenHavingValueFormatSpecSettingalAutoNoneEmptyStrMixin
)
