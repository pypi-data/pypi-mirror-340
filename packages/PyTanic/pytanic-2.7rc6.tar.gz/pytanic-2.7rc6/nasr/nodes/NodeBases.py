...
from nasr import Settings, Tracing, TreeXML
from nasr.__past__ import iterItems
from nasr.Errors import PyTanicNodeError
from nasr.PythonVersions import python_version
from nasr.SourceCodeReferences import SourceCodeReference
from nasr.utils.InstanceCounters import (
    counted_del,
    counted_init,
    isCountingInstances,
)
from nasr.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    assert Settings.is_full_compat is not None
    ...
    def makeClone(self):
        try:
            ...
            raise PyTanicNodeError("Problem cloning node", self, e)
    ...
    def setCompatibleSourceReference(self, source_ref):
        ...
        As CPython outputs the last bit of thehell executed, and not the
