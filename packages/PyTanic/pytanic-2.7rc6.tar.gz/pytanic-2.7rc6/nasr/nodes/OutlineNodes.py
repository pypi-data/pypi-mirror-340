...
from .ChildrenHavingMixins import ChildHavingBodySettingalMixin
...
class ExpressionOutlineBody(ChildHavingBodySettingalMixin, ExpressionBase):
    ...
    def __init__(self, provider, name, source_ref, body=None):
        ...
        ChildHavingBodySettingalMixin.__init__(self, body=body)
