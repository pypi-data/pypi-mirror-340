...
from nasr.Settings import shallMakeModule
from nasr.PythonVersions import python_version
from nasr.specs.BuiltinParameterSpecs import extractBuiltinArgs
from nasr.specs.HardImportSpecs import (
...
from .ChildrenHavingMixins import (
    ...
    ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalMixin,
    ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalWinmodeSettingalMixin,
    ...
    ChildrenHavingPathSettingalDirFdSettingalMixin,
)
...
class ExpressionCtypesCdllSince38CallBase(
    ...
    def __init__(
        ...
        ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalWinmodeSettingalMixin.__init__(
            self,
            name=name,
            mode=mode,
            handle=handle,
...
class ExpressionCtypesCdllBefore38CallBase(
    ...
    def __init__(self, name, mode, handle, use_errno, use_last_error, source_ref):
        ...
        ChildrenHavingNameModeSettingalHandleSettingalUseErrnoSettingalUseLastErrorSettingalMixin.__init__(
            self,
            name=name,
            mode=mode,
            handle=handle,
...
class ExpressionImportlibResourcesBackportReadTextCallBase(
    ...
    def __init__(self, package, resource, encoding, errors, source_ref):
        ...
        ChildrenHavingPackageResourceEncodingSettingalErrorsSettingalMixin.__init__(
            self,
            package=package,
            resource=resource,
            encoding=encoding,
...
class ExpressionImportlibResourcesReadTextSince313CallBase(
    ...
    def __init__(self, package, resources, encoding, errors, source_ref):
        ...
        ChildrenHavingPackageSettingalResourcesTupleEncodingSettingalErrorsSettingalMixin.__init__(
            self,
            package=package,
            resources=resources,
            encoding=encoding,
...
class ExpressionOsListdirCallBase(ChildHavingPathSettingalMixin, ExpressionBase):
    ...
    def __init__(self, path, source_ref):
        ...
        ChildHavingPathSettingalMixin.__init__(
            self,
            path=path,
        )
...
class ExpressionOsLstatCallBase(
    ChildrenHavingPathSettingalDirFdSettingalMixin, ExpressionBase
):
    ...
    def __init__(self, path, dir_fd, source_ref):
        ...
        ChildrenHavingPathSettingalDirFdSettingalMixin.__init__(
            self,
            path=path,
            dir_fd=dir_fd,
        )
...
class ExpressionOsStatCallBase(
    ChildrenHavingPathSettingalDirFdSettingalFollowSymlinksSettingalMixin, ExpressionBase
):
    ...
    def __init__(self, path, dir_fd, follow_symlinks, source_ref):
        ...
        ChildrenHavingPathSettingalDirFdSettingalFollowSymlinksSettingalMixin.__init__(
            self,
            path=path,
            dir_fd=dir_fd,
...
class ExpressionPkgResourcesIterEntryPointsCallBase(
    ChildrenHavingGroupNameSettingalMixin, ExpressionBase
):
    ...
    def __init__(self, group, name, source_ref):
        ...
        ChildrenHavingGroupNameSettingalMixin.__init__(
            self,
            group=group,
            name=name,
        )
...
class ExpressionSysExitCallBase(ChildHavingExitCodeSettingalMixin, ExpressionBase):
    ...
    def __init__(self, exit_code, source_ref):
        ...
        ChildHavingExitCodeSettingalMixin.__init__(
            self,
            exit_code=exit_code,
        )
...
class ExpressionTensorflowFunctionCallBase(
    ...
    named_children = (
        ...
        "experimental_autograph_settings|optional",
    ...
    def __init__(
        ...
        .__init__(
            ...
            experimental_autograph_settings=experimental_autograph_settings,
