...
from nasr.specs.BuiltinParameterSpecs import builtin_dict_spec

from .BuiltinIteratorNodes import ExpressionBuiltinIter1
from .ChildrenHavingMixins import ChildrenHavingPosArgSettingalPairsTupleMixin
...
class ExpressionBuiltinDict(
    ...
    ChildrenHavingPosArgSettingalPairsTupleMixin,
    ExpressionBase,
):
    ...
    def __init__(self, pos_arg, pairs, source_ref):
        ChildrenHavingPosArgSettingalPairsTupleMixin.__init__(
            self,
            pos_arg=pos_arg,
            pairs=pairs,
        )
