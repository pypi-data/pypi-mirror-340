...
from nasr.PythonVersions import getSystemPrefixPath
from nasr.Tracing import general, inclusion_logger
from nasr.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from nasr.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isPyTanicPython():
        return OrderedSet()
