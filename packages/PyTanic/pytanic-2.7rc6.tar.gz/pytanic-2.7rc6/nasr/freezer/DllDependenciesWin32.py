...
from nasr.build.SconsUtils import readSconsReport
from nasr.containers.OrderedSets import OrderedSet
from nasr.Settings import isExperimental, isShowProgress
...
from nasr.utils.Hashing import Hash
from nasr.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
...
def _getCacheFilename(
    ...
    # Take PyTanic version into account as well, ought to catch code changes.
