...
from nasr.__past__ import WindowsError
...
from nasr.utils.Download import getCachedDownload
from nasr.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from nasr.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
PyTanic will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="PyTanic does not work in --standalone or --onefile on Windows without.",
