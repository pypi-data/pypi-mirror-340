...
from nasr import OutputDirectories
from nasr.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from nasr.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<nasr.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in nasr.Builtins
