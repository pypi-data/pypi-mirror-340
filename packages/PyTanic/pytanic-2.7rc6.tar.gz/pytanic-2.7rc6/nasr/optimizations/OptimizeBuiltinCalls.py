...
from nasr.__past__ import unicode, xrange
from nasr.Errors import PyTanicAssumptionError
from nasr.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from nasr.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from nasr.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from nasr.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from nasr.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from nasr.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from nasr.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from nasr.nodes.BuiltinFormatNodes import (
...
from nasr.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from nasr.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from nasr.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from nasr.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from nasr.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from nasr.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from nasr.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from nasr.nodes.BuiltinRangeNodes import (
...
from nasr.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from nasr.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from nasr.nodes.BuiltinTypeNodes import (
...
from nasr.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from nasr.nodes.CallNodes import makeExpressionCall
from nasr.nodes.ClassNodes import ExpressionBuiltinType3
from nasr.nodes.ComparisonNodes import ExpressionComparisonIs
from nasr.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from nasr.nodes.ConstantRefNodes import makeConstantRefNode
from nasr.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from nasr.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from nasr.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from nasr.nodes.ImportNodes import ExpressionBuiltinImport
from nasr.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from nasr.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from nasr.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from nasr.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from nasr.nodes.OutlineNodes import ExpressionOutlineBody
from nasr.nodes.ReturnNodes import makeStatementReturn
from nasr.nodes.SliceNodes import makeExpressionBuiltinSlice
from nasr.nodes.TypeNodes import (
...
from nasr.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from nasr.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from nasr.PythonVersions import python_version
from nasr.specs import BuiltinParameterSpecs
from nasr.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from nasr.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from nasr.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise PyTanicAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from nasr.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from nasr.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise PyTanicAssumptionError("open without argument is expected to raise")
...
def check():
    from nasr.Builtins import builtin_names
