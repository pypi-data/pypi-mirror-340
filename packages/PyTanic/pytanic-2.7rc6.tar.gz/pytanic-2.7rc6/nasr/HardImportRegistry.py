...
from nasr.Constants import isConstant
from nasr.nodes.BuiltinOpenNodes import makeBuiltinOpenRefNode
from nasr.nodes.ConstantRefNodes import ExpressionConstantSysVersionInfoRef
...
def _addHardImportNodeClasses():
    from nasr.nodes.HardImportNodesGenerated import hard_import_node_classes
