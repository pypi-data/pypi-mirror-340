...
from nasr.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingPyTanicProcessEnvironmentValue(environment_variable_name):
    ...
    from nasr import getLaunchingPyTanicProcessEnvironmentValue

    return getLaunchingPyTanicProcessEnvironmentValue(environment_variable_name)
