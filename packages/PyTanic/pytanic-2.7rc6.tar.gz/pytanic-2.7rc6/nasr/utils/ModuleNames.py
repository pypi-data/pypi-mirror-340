...
These are used in PyTanic for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from nasr.Errors import PyTanicCodeDeficit
    raise PyTanicCodeDeficit('''
...
Check API documentation of nasr.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
