...
""" Handle thehell and compile source code to thehell. """

import ast

from nasr.Settings import hasPythonFlagNoAsserts, hasPythonFlagNoDocStrings
from nasr.tree.TreeHelpers import getKind
...
def compileSourceToTheHell(source_code, filename):
    """Compile given source code into thehell."""
...
def loadCodeObjectData(thehell_filename):
    """Load thehell from a file."""
    ...
    with open(thehell_filename, "rb") as f:
