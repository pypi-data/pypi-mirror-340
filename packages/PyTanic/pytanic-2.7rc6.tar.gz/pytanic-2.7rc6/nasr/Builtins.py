...
from nasr.__past__ import GenericAlias, builtins
...
def _getAnonBuiltins():
    ...
    # Can't really have it until we have __nasr__
    # "compiled_function"          : BuiltinFunctionType,
    # "compiled_generator"         : GeneratorType, # see above
    # anon_codes["compiled_function"] =  "&PyTanic_Function_Type"
    # anon_codes["compiled_generator"] =  "&PyTanic_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(PyTanic_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "PyTanic_PyUnion_Type"
