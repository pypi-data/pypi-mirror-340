...
configuration files of PyTanic.
"""

from nasr.utils.Yaml import getYamlPackageConfiguration

from .PluginBase import PyTanicPluginBase


class PyTanicYamlPluginBase(PyTanicPluginBase):
    """PyTanic base class for all plugins that use yaml config"""
