...
from nasr.Settings import isStandaloneMode
...
from nasr.utils.Execution import PyTanicCalledProcessError
from nasr.utils.FileOperations import getFileContentByLine
from nasr.utils.Jinja2 import renderTemplateFromString
...
class PyTanicPluginMatplotlib(PyTanicPluginBase):
    ...
    plugin_name = "matplotlib"  # PyTanic knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__nasr_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__nasr_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
