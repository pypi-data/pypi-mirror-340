...
from nasr.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class PyTanicPluginDelvewheel(PyTanicPluginBase):
    ...
    plugin_name = "delvewheel"  # PyTanic knows us by this name
    plugin_desc = (
