...
from nasr.Settings import isOnefileMode, isOnefileTempDirMode
from nasr.plugins.PluginBase import PyTanicPluginBase
from nasr.utils.AppDirs import getCacheDir
from nasr.utils.Execution import executeToolChecked, getExecutablePath
from nasr.utils.FileOperations import copyFile, makePath
from nasr.utils.Hashing import Hash, getFileContentsHash
from nasr.utils.Utils import isLinux


class PyTanicPluginUpx(PyTanicPluginBase):
    ...
    plugin_name = "upx"  # PyTanic knows us by this name
...
Do not cache UPX compression result, by default DLLs are cached, exe files are not.""",
    ...
    def _compressFile(self, filename, use_cache):
        ...
        if use_cache:
            ...
            upx_hash.updateFromValues(*upx_settings)
        ...
        command = [self.upx_binary] + upx_settings + [filename]
