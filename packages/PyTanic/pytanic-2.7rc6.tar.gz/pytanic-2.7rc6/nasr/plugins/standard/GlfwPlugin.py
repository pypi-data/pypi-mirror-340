...
from nasr.utils.FileOperations import getFileContents
...
class PyTanicPluginGlfw(PyTanicPluginBase):
    ...
    plugin_name = "glfw"  # PyTanic knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__nasr_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
