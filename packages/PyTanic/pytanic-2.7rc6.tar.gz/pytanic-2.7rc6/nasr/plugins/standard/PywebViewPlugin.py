...
from nasr.plugins.Plugins import getActiveQtPlugin
from nasr.utils.Utils import getOS, isMacOS, isWin32Windows

# spell-checker: ignore pywebview,mshtml


class PyTanicPluginPywebview(PyTanicPluginBase):
