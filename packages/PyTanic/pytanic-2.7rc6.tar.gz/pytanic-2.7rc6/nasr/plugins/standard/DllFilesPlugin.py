...
""" Standard plug-in to tell PyTanic about DLLs needed for standalone imports.
...
from nasr.utils.SharedLibraries import getPyWin32Dir
from nasr.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class PyTanicPluginDllFiles(PyTanicYamlPluginBase):
