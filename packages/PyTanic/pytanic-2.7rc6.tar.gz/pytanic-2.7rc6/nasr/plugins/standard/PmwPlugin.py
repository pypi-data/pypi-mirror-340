...
from nasr.__past__ import StringIO
from nasr.plugins.PluginBase import PyTanicPluginBase
from nasr.utils.FileOperations import getFileContents, listDir
...
class PyTanicPluginPmw(PyTanicPluginBase):
...
class PyTanicPluginDetectorPmw(PyTanicPluginBase):
    detector_for = PyTanicPluginPmw
