...
from nasr.plugins.PluginBase import PyTanicPluginBase, standalone_only


class PyTanicPluginGi(PyTanicPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__nasr_binary_dir, "girepository")"""
