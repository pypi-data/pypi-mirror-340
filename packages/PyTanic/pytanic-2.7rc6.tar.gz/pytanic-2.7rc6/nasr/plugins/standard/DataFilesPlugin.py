...
from nasr.code_generation.ConstantNasr import addDistributionMetadataValue
from nasr.containers.OrderedSets import OrderedSet
from nasr.plugins.YamlPluginBase import PyTanicYamlPluginBase
from nasr.PythonFlavors import isDebianPackagePython
...
class PyTanicPluginDataFileCollector(PyTanicYamlPluginBase):
    ...
    def _getSubDirectoryFolders(self, module, sub_dirs):
        ...
        # Gather the full file list, probably makes no sense to include thehell files
        file_list = sum(
            (
                getFileList(
