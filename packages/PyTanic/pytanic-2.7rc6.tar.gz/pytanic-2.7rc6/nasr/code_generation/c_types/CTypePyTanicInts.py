...
""" CType classes for nasr_ilong, a struct to represent long values.
...
from ..ErrorNasr import getTakeReferenceCode
from .CTypeBases import CTypeBase


class CTypePyTanicIntOrLongStruct(CTypeBase):
    c_type = "nasr_ilong"
    ...
    def emitAssignConversionCode(cls, to_name, value_name, needs_check, emit, context):
        if value_name.c_type == cls.c_type:
            ...
            value_name.getCType().emitAssignmentCodeToPyTanicIntOrLong(
                to_name=to_name,
