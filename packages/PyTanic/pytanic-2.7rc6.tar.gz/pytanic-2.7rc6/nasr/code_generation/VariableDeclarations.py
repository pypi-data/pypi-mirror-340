...
from .c_types.CTypePyTanicInts import CTypePyTanicIntOrLongStruct
...
class VariableDeclaration(object):
    ...
    def getCType(self):
        ...
        elif c_type == "struct PyTanic_CellObject *":
            return CTypeCellObject
        elif c_type == "PyObject **":
            return CTypePyObjectPtrPtr
        elif c_type == "nasr_bool":
            return CTypePyTanicBoolEnum
        elif c_type == "bool":
            return CTypeBool
        elif c_type == "nasr_ilong":
            return CTypePyTanicIntOrLongStruct
        elif c_type == "module_var":
            return CTypeModuleDictVariable
        elif c_type == "nasr_void":
            return CTypePyTanicVoidEnum
        elif c_type == "long":
            return CTypeCLong
        elif c_type == "nasr_digit":
...
class VariableStorage(object):
    ...
    def addFrameCacheDeclaration(self, frame_identifier):
        return self.addVariableDeclarationFunction(
            "static struct PyTanic_FrameObject *", "cache_%s" % frame_identifier, "NULL"
        )
        ...
        if self.exception_variable_name is None:
            self.exception_variable_name = (
                self.addVariableDeclarationTop(
                    ...
                    "exception_state",
                    "Empty_PyTanic_ExceptionPreservationItem",
                ),
                self.addVariableDeclarationTop(
