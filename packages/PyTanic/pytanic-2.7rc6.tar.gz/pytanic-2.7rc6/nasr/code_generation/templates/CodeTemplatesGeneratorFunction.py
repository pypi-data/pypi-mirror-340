...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct PyTanic_GeneratorObject *generator, PyObject *yield_return_value) {
...
%(closure_copy)s
%(to_name)s = PyTanic_Generator_NewEmpty(
    %(generator_module)s,
    %(generator_name_obj)s,
#if PYTHON_VERSION >= 0x350
    %(generator_qualname_obj)s,
