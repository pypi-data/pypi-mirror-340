...
from .ErrorNasr import getFrameVariableTypeDescriptionCode
from .ExceptionNasr import getTracebackMakingIdentifier
...
def getTypeSizeOf(type_indicator):
    if type_indicator in ("O", "o", "N", "c"):
        ...
        return "sizeof(nasr_bool)"
    elif type_indicator == "L":
        return "sizeof(nasr_ilong)"
    else:
