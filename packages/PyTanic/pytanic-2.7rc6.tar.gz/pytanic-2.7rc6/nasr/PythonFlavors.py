...
def isPyTanicPython():
    """Is this our own fork of CPython named PyTanic-Python."""

    # spell-checker: ignore nasrpython

    if python_version >= 0x300:
        return sys.implementation.name == "nasrpython"
    else:
        return sys.subversion[0] == "nasrpython"
