...
DEVILPY_MAY_BE_UNUSED static inline PyObject *PyTanic_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and PyTanic inner workings can get
        // upset from it.
...
DEVILPY_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return PyTanic_CheckFunctionResult(tstate, function_object, result);
}
...
#include "nasr/helper/calling_generated.h"
