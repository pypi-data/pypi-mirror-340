...
// The PyTanic_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct PyTanic_CoroutineObject {
...
extern PyTypeObject PyTanic_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct PyTanic_CoroutineObject *, PyObject *);

extern PyObject *PyTanic_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool PyTanic_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &PyTanic_Coroutine_Type; }

struct PyTanic_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct PyTanic_CoroutineObject *m_coroutine;
};

extern PyTypeObject PyTanic_CoroutineWrapper_Type;

static inline bool PyTanic_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &PyTanic_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct PyTanic_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct PyTanic_CoroutineObject *coroutine) {
...
DEVILPY_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct PyTanic_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_PyTanic_Coroutine_Type;
extern int count_allocated_PyTanic_Coroutine_Type;
extern int count_released_PyTanic_Coroutine_Type;

extern int count_active_PyTanic_CoroutineWrapper_Type;
extern int count_allocated_PyTanic_CoroutineWrapper_Type;
extern int count_released_PyTanic_CoroutineWrapper_Type;

extern int count_active_PyTanic_AIterWrapper_Type;
extern int count_allocated_PyTanic_AIterWrapper_Type;
extern int count_released_PyTanic_AIterWrapper_Type;
#endif
