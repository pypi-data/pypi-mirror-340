...
#include "nasr/checkers.h"
#include "nasr/constants.h"
#include "nasr/printing.h"
...
struct PyTanic_FrameObject;

extern PyTracebackObject *MAKE_TRACEBACK(struct PyTanic_FrameObject *frame, int lineno);
...
DEVILPY_MAY_BE_UNUSED static PyTracebackObject *ADD_TRACEBACK(PyTracebackObject *exception_tb,
                                                             struct PyTanic_FrameObject *frame, int lineno) {
...
struct PyTanic_ExceptionStackItem {
...
static const struct PyTanic_ExceptionStackItem PyTanic_ExceptionStackItem_Empty = {NULL, NULL, NULL};
#else
#define PyTanic_ExceptionStackItem_Empty                                                                                \
    (struct PyTanic_ExceptionStackItem) { .exception_type = NULL, .exception_value = NULL, .exception_tb = NULL }
#endif
#else
struct PyTanic_ExceptionStackItem {
    PyObject *exception_value;
...
#if defined(__cplusplus)
static const struct PyTanic_ExceptionStackItem PyTanic_ExceptionStackItem_Empty = {NULL};
#else
#define PyTanic_ExceptionStackItem_Empty                                                                                \
    (struct PyTanic_ExceptionStackItem) { .exception_value = NULL }
#endif

#endif

// Helper that gets the current thread exception, for use in exception handlers
DEVILPY_MAY_BE_UNUSED inline static struct PyTanic_ExceptionStackItem GET_CURRENT_EXCEPTION(PyThreadState *tstate) {
    struct PyTanic_ExceptionStackItem result;
#if PYTHON_VERSION < 0x3b0
...
DEVILPY_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION(PyThreadState *tstate,
                                                              struct PyTanic_ExceptionStackItem *exc_state) {
#if PYTHON_VERSION < 0x3b0
...
DEVILPY_MAY_BE_UNUSED inline static void SET_CURRENT_EXCEPTION_TYPE0_STR(PyThreadState *tstate, PyObject *exception_type,
                                                                        char const *value) {
    PyObject *exception_value = PyTanic_String_FromString(value);
...
DEVILPY_MAY_BE_UNUSED static inline void PRESERVE_FRAME_EXCEPTION(PyThreadState *tstate,
                                                                 struct PyTanic_FrameObject *frame_object) {
...
#if PYTHON_VERSION < 0x3c0
struct PyTanic_ExceptionPreservationItem {
    PyObject *exception_type;
    PyObject *exception_value;
    PyTracebackObject *exception_tb;
};

static const struct PyTanic_ExceptionPreservationItem Empty_PyTanic_ExceptionPreservationItem = {0};
...
RESTORE_ERROR_OCCURRED_STATE(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
    RESTORE_ERROR_OCCURRED(tstate, exception_state->exception_type, exception_state->exception_value,
                           exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
FETCH_ERROR_OCCURRED_STATE_UNTRACED(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
    FETCH_ERROR_OCCURRED_UNTRACED(tstate, &exception_state->exception_type, &exception_state->exception_value,
                                  &exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
RESTORE_ERROR_OCCURRED_STATE_UNTRACED(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
    RESTORE_ERROR_OCCURRED_UNTRACED(tstate, exception_state->exception_type, exception_state->exception_value,
                                    exception_state->exception_tb);
}

DEVILPY_MAY_BE_UNUSED static void
ASSERT_SAME_EXCEPTION_STATE(struct PyTanic_ExceptionPreservationItem const *exception_state1,
                            struct PyTanic_ExceptionPreservationItem const *exception_state2) {
...
DEVILPY_MAY_BE_UNUSED static void
ASSERT_EMPTY_EXCEPTION_STATE(struct PyTanic_ExceptionPreservationItem const *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void INIT_ERROR_OCCURRED_STATE(struct PyTanic_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void
RELEASE_ERROR_OCCURRED_STATE(struct PyTanic_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void
RELEASE_ERROR_OCCURRED_STATE_X(struct PyTanic_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void SET_EXCEPTION_PRESERVATION_STATE_FROM_ARGS(
    PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state, PyObject *exception_type,
...
DEVILPY_MAY_BE_UNUSED static void
ASSIGN_ARGS_FROM_EXCEPTION_PRESERVATION_STATE(struct PyTanic_ExceptionPreservationItem *exception_state,
...
GET_EXCEPTION_STATE_TRACEBACK(struct PyTanic_ExceptionPreservationItem *exception_state) {
    return exception_state->exception_tb;
}

// Transfer ownership of the traceback to the exception state.
DEVILPY_MAY_BE_UNUSED static void SET_EXCEPTION_STATE_TRACEBACK(struct PyTanic_ExceptionPreservationItem *exception_state,
                                                               PyTracebackObject *exception_tb) {
    CHECK_OBJECT_X(exception_state->exception_tb);
    CHECK_OBJECT_X(exception_tb);
...
DEVILPY_MAY_BE_UNUSED static bool HAS_EXCEPTION_STATE(struct PyTanic_ExceptionPreservationItem const *exception_state) {
    return exception_state->exception_type != NULL;
}

DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_BOOL_SINGLE(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state,
                                  PyObject *exception_checked) {
    return EXCEPTION_MATCH_BOOL_SINGLE(tstate, exception_state->exception_type, exception_checked);
}

DEVILPY_MAY_BE_UNUSED inline static void
CHECK_EXCEPTION_STATE(struct PyTanic_ExceptionPreservationItem const *exception_state) {
    CHECK_OBJECT(exception_state->exception_type);
    CHECK_OBJECT_X(exception_state->exception_value);
    CHECK_OBJECT_X(exception_state->exception_tb);
}
...
DEVILPY_MAY_BE_UNUSED inline static void
CHECK_EXCEPTION_STATE_X(struct PyTanic_ExceptionPreservationItem const *exception_state) {
    CHECK_OBJECT_X(exception_state->exception_type);
    CHECK_OBJECT_X(exception_state->exception_value);
    CHECK_OBJECT_X(exception_state->exception_tb);
}
...
DEVILPY_MAY_BE_UNUSED static void
ASSERT_SAME_EXCEPTION_STATE(struct PyTanic_ExceptionPreservationItem *exception_state1,
                            struct PyTanic_ExceptionPreservationItem *exception_state2) {
    assert(exception_state1->exception_value == exception_state2->exception_value);
}
...
DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_BOOL_SINGLE(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem const *exception_state,
                                  PyObject *exception_checked) {
...
#define SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_FORMAT1(tstate, exception_state, exception_type, message, arg1)    \
    {                                                                                                                  \
        PyObject *exception_value = PyTanic_String_FromFormat(message, arg1);                                           \
        CHECK_OBJECT(exception_value);                                                                                 \
        SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_VALUE1(tstate, exception_state, exception_type, exception_value);  \
    }
...
#define SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_FORMAT2(tstate, exception_state, exception_type, message, arg1,    \
                                                            arg2)                                                      \
    {                                                                                                                  \
        PyObject *exception_value = PyTanic_String_FromFormat(message, arg1, arg2);                                     \
        CHECK_OBJECT(exception_value);                                                                                 \
        SET_EXCEPTION_PRESERVATION_STATE_FROM_TYPE0_VALUE1(tstate, exception_state, exception_type, exception_value);  \
    }
...
DEVILPY_MAY_BE_UNUSED static bool
EXCEPTION_STATE_MATCH_GENERATOR(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
#if PYTHON_VERSION < 0x3c0
...
DEVILPY_MAY_BE_UNUSED static bool EXCEPTION_MATCH_BOOL_SINGLE(PyThreadState *tstate, PyObject *exception_value,
    ...
    if (PyExceptionClass_Check(exception_value)) {
        ...
        return res == 1;
#else
        int res = PyTanic_Type_IsSubtype((PyTypeObject *)exception_value, (PyTypeObject *)exception_checked);
        return res == 1;
#endif
    }
...
#else
    if (PyExceptionClass_Check(exception_class) && PyExceptionClass_Check(exception_checked)) {
        return PyTanic_Type_IsSubtype((PyTypeObject *)exception_class, (PyTypeObject *)exception_checked);
    } else {
        return exception_class == exception_checked;
    }
#endif
...
extern void PyTanic_Err_NormalizeException(PyThreadState *tstate, PyObject **exc, PyObject **val,
...
DEVILPY_MAY_BE_UNUSED static inline void NORMALIZE_EXCEPTION(PyThreadState *tstate, PyObject **exception_type,
    ...
    if (*exception_type != Py_None && *exception_type != NULL) {
        PyTanic_Err_NormalizeException(tstate, exception_type, exception_value, exception_tb);
    }
...
PUBLISH_CURRENT_EXCEPTION(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
#if _DEBUG_EXCEPTIONS
...
DEVILPY_MAY_BE_UNUSED static bool
_CHECK_AND_CLEAR_EXCEPTION_STATE(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state,
                                 PyObject *exception_type) {
#if PYTHON_VERSION < 0x3c0
...
// its name.
DEVILPY_MAY_BE_UNUSED static bool
CHECK_AND_CLEAR_STOP_ITERATION_STATE(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
...
extern void FORMAT_UNBOUND_LOCAL_ERROR(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state,
...
// reference.
DEVILPY_MAY_BE_UNUSED static inline PyObject *PyTanic_Exception_GetContext(PyObject *self) {
...
// consume a reference.
DEVILPY_MAY_BE_UNUSED static inline void PyTanic_Exception_SetContext(PyObject *self, PyObject *context) {
...
DEVILPY_MAY_BE_UNUSED static inline void PyTanic_Exception_DeleteContext(PyObject *self) {
...
DEVILPY_MAY_BE_UNUSED static inline void
ADD_EXCEPTION_CONTEXT(PyThreadState *tstate, struct PyTanic_ExceptionPreservationItem *exception_state) {
    ...
    if (context != NULL) {
        ...
        NORMALIZE_EXCEPTION_STATE(tstate, exception_state);
#endif
        PyTanic_Exception_SetContext(exception_state->exception_value, context);
    }
}
#endif

// Our replacement for "PyException_SetCause", consumes a reference.
DEVILPY_MAY_BE_UNUSED static inline void PyTanic_Exception_SetCause(PyObject *self, PyObject *cause) {
