...
// The PyTanic_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct PyTanic_AsyncgenObject {
...
extern PyTypeObject PyTanic_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct PyTanic_AsyncgenObject *, PyObject *);

extern PyObject *PyTanic_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct PyTanic_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool PyTanic_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &PyTanic_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct PyTanic_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct PyTanic_AsyncgenObject *asyncgen) {
...
DEVILPY_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct PyTanic_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_PyTanic_Asyncgen_Type;
extern int count_allocated_PyTanic_Asyncgen_Type;
extern int count_released_PyTanic_Asyncgen_Type;

extern int count_active_PyTanic_AsyncgenValueWrapper_Type;
extern int count_allocated_PyTanic_AsyncgenValueWrapper_Type;
extern int count_released_PyTanic_AsyncgenValueWrapper_Type;

extern int count_active_PyTanic_AsyncgenAsend_Type;
extern int count_allocated_PyTanic_AsyncgenAsend_Type;
extern int count_released_PyTanic_AsyncgenAsend_Type;

extern int count_active_PyTanic_AsyncgenAthrow_Type;
extern int count_allocated_PyTanic_AsyncgenAthrow_Type;
extern int count_released_PyTanic_AsyncgenAthrow_Type;
