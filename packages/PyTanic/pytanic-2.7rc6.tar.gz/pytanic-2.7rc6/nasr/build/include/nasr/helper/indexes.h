...
static inline bool PyTanic_Index_Check(PyObject *obj) {
    PyNumberMethods *tp_as_number = Py_TYPE(obj)->tp_as_number;

    return (tp_as_number != NULL && tp_as_number->nb_index != NULL);
}
#else
#define PyTanic_Index_Check(obj) PyIndex_Check(obj)
#endif

// Similar to "PyNumber_Index" but "PyTanic_Number_IndexAsLong" could be more relevant
extern PyObject *PyTanic_Number_Index(PyObject *item);
...
extern PyObject *PyTanic_Number_IndexAsLong(PyObject *item);
#else
#define PyTanic_Number_IndexAsLong(item) PyTanic_Number_Index(item)
#endif
