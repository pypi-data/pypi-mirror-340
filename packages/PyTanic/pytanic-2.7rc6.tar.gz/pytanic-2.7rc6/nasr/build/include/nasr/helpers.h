...
// For profiling of PyTanic compiled binaries
#if _DEVILPY_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "nasr/helper/boolean.h"
#include "nasr/helper/dictionaries.h"
#include "nasr/helper/indexes.h"
#include "nasr/helper/mappings.h"
#include "nasr/helper/operations_builtin_types.h"
#include "nasr/helper/sets.h"
#include "nasr/helper/strings.h"

#include "nasr/helper/raising.h"

#include "nasr/helper/ints.h"
#include "nasr/helper/richcomparisons.h"
#include "nasr/helper/sequences.h"

static inline bool PyTanic_Function_Check(PyObject *object);
static inline PyObject *PyTanic_Function_GetName(PyObject *object);

static inline bool PyTanic_Generator_Check(PyObject *object);
static inline PyObject *PyTanic_Generator_GetName(PyObject *object);

#include "nasr/calling.h"
#include "nasr/helper/bytes.h"
#include "nasr/helper/complex.h"
#include "nasr/helper/floats.h"
...
#include "nasr/helper/attributes.h"
#include "nasr/helper/bytearrays.h"
#include "nasr/helper/iterators.h"
#include "nasr/helper/lists.h"
#include "nasr/helper/rangeobjects.h"
#include "nasr/helper/slices.h"
#include "nasr/helper/subscripts.h"
#include "nasr/helper/tuples.h"

#include "nasr/builtins.h"
...
nasr_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "nasr/importing.h"

// Hard imports have their own helpers.
#include "nasr/helper/import_hard.h"
...
extern PyTypeObject *PyTanic_PyUnion_Type;
...
extern void PyTanic_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "nasr/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "nasr/type_aliases.h"
#endif
