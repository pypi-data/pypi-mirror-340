...
// The PyTanic_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct PyTanic_GeneratorObject {
...
extern PyTypeObject PyTanic_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct PyTanic_GeneratorObject *, PyObject *);

extern PyObject *PyTanic_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *PyTanic_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct PyTanic_CellObject **closure,
...
extern PyObject *PyTanic_Generator_qiter(PyThreadState *tstate, struct PyTanic_GeneratorObject *generator,
                                        bool *finished);

static inline bool PyTanic_Generator_Check(PyObject *object) { return Py_TYPE(object) == &PyTanic_Generator_Type; }

static inline PyObject *PyTanic_Generator_GetName(PyObject *object) {
    return ((struct PyTanic_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct PyTanic_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct PyTanic_GeneratorObject *generator) {
...
extern void PyTanic_PreserveHeap(void *dest, ...);
extern void PyTanic_RestoreHeap(void *source, ...);
...
DEVILPY_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct PyTanic_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_PyTanic_Generator_Type;
extern int count_allocated_PyTanic_Generator_Type;
extern int count_released_PyTanic_Generator_Type;
#endif
