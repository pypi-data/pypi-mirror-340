...
PyObject *PyTanic_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step) {
    ...
    if (*slice_cache_ptr != NULL) {
        ...
        *slice_cache_ptr = NULL;
        ...
        PyTanic_Py_NewReference((PyObject *)result_slice);
    } else {
        result_slice = (PySliceObject *)PyTanic_GC_New(&PySlice_Type);
