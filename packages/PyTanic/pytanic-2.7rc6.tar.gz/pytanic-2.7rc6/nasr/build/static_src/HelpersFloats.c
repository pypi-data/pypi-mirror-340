...
static PyFloatObject *_PyTanic_AllocatePyFloatObject(PyThreadState *tstate) {
    ...
    if (result_float) {
        ...
        *free_list = (PyFloatObject *)Py_TYPE(result_float);
        ...
        result_float = (PyFloatObject *)PyTanicObject_Malloc(sizeof(PyFloatObject));
    }

    Py_SET_TYPE(result_float, &PyFloat_Type);
    PyTanic_Py_NewReference((PyObject *)result_float);
...
PyObject *MAKE_FLOAT_FROM_DOUBLE(double value) {
    ...
    PyFloatObject *result = _PyTanic_AllocatePyFloatObject(tstate);
