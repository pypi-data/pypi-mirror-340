...
#include "nasr/compiled_method.h"
...
#if _DEBUG_REFCOUNTS
int count_active_PyTanic_Function_Type;
int count_allocated_PyTanic_Function_Type;
int count_released_PyTanic_Function_Type;
#endif

// tp_descr_get slot, bind a function to an object.
static PyObject *PyTanic_Function_descr_get(PyObject *function, PyObject *object, PyObject *class_object) {
    assert(PyTanic_Function_Check(function));
    ...
    return PyTanic_Method_New((struct PyTanic_FunctionObject *)function, object == Py_None ? NULL : object, class_object);
}

// tp_repr slot, decide how compiled function shall be output to "repr" built-in
static PyObject *PyTanic_Function_tp_repr(struct PyTanic_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));

#if PYTHON_VERSION < 0x300
    return PyTanic_String_FromFormat("<compiled_function %s at %p>", PyTanic_String_AsString(function->m_name), function);
#else
    return PyTanic_String_FromFormat("<compiled_function %U at %p>", function->m_qualname, function);
#endif
}

static long PyTanic_Function_tp_traverse(struct PyTanic_FunctionObject *function, visitproc visit, void *arg) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static long PyTanic_Function_tp_hash(struct PyTanic_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *PyTanic_Function_get_name(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    struct PyTanic_FunctionObject *function = (struct PyTanic_FunctionObject *)self;
...
static int PyTanic_Function_set_name(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
#if PYTHON_VERSION >= 0x300
static PyObject *PyTanic_Function_get_qualname(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_qualname(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *PyTanic_Function_get_doc(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_doc(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *PyTanic_Function_get_dict(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_dict(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *PyTanic_Function_get_code(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_code(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyThreadState *tstate = PyThreadState_GET();
    SET_CURRENT_EXCEPTION_TYPE0_STR(tstate, PyExc_RuntimeError, "__code__ is not writable in PyTanic");
    return -1;
}

static PyObject *PyTanic_Function_get_compiled(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));

    PyObject *result = PyTanic_dunder_compiled_value;
    CHECK_OBJECT(result);
...
static int PyTanic_Function_set_compiled(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_compiled_constant(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_compiled_constant(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_closure(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_closure(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_defaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static void _onUpdatedCompiledFunctionDefaultsValue(struct PyTanic_FunctionObject *function) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
...
static int PyTanic_Function_set_defaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
#if PYTHON_VERSION >= 0x300
static PyObject *PyTanic_Function_get_kwdefaults(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_kwdefaults(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *PyTanic_Function_get_annotations(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_annotations(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_globals(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_globals(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_builtins(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_builtins(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_type_params(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    CHECK_OBJECT_X(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyObject *PyTanic_Function_get_type_params(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static int PyTanic_Function_set_module(PyObject *self, PyObject *value, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
    CHECK_OBJECT_X(value);
...
static PyObject *PyTanic_Function_get_module(PyObject *self, void *data) {
    CHECK_OBJECT(self);
    assert(PyTanic_Function_Check(self));
    assert(_PyObject_GC_IS_TRACKED(self));
...
static PyGetSetDef PyTanic_Function_getset[] = {
#if PYTHON_VERSION >= 0x300
    {(char *)"__qualname__", PyTanic_Function_get_qualname, PyTanic_Function_set_qualname, NULL},
#endif
#if PYTHON_VERSION < 0x300
    {(char *)"func_name", PyTanic_Function_get_name, PyTanic_Function_set_name, NULL},
#endif
    {(char *)"__name__", PyTanic_Function_get_name, PyTanic_Function_set_name, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_doc", PyTanic_Function_get_doc, PyTanic_Function_set_doc, NULL},
#endif
    {(char *)"__doc__", PyTanic_Function_get_doc, PyTanic_Function_set_doc, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_dict", PyTanic_Function_get_dict, PyTanic_Function_set_dict, NULL},
#endif
    {(char *)"__dict__", PyTanic_Function_get_dict, PyTanic_Function_set_dict, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_code", PyTanic_Function_get_code, PyTanic_Function_set_code, NULL},
#endif
    {(char *)"__code__", PyTanic_Function_get_code, PyTanic_Function_set_code, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_defaults", PyTanic_Function_get_defaults, PyTanic_Function_set_defaults, NULL},
#endif
    {(char *)"__defaults__", PyTanic_Function_get_defaults, PyTanic_Function_set_defaults, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_globals", PyTanic_Function_get_globals, PyTanic_Function_set_globals, NULL},
#endif
    {(char *)"__closure__", PyTanic_Function_get_closure, PyTanic_Function_set_closure, NULL},
#if PYTHON_VERSION < 0x300
    {(char *)"func_closure", PyTanic_Function_get_closure, PyTanic_Function_set_closure, NULL},
#endif
    {(char *)"__globals__", PyTanic_Function_get_globals, PyTanic_Function_set_globals, NULL},
    {(char *)"__module__", PyTanic_Function_get_module, PyTanic_Function_set_module, NULL},
#if PYTHON_VERSION >= 0x300
    {(char *)"__kwdefaults__", PyTanic_Function_get_kwdefaults, PyTanic_Function_set_kwdefaults, NULL},
    {(char *)"__annotations__", PyTanic_Function_get_annotations, PyTanic_Function_set_annotations, NULL},
#endif
#if PYTHON_VERSION >= 0x3a0
    {(char *)"__builtins__", PyTanic_Function_get_builtins, PyTanic_Function_set_builtins, NULL},
#endif
#if PYTHON_VERSION >= 0x3c0
    {(char *)"__type_params__", PyTanic_Function_get_type_params, PyTanic_Function_set_type_params, NULL},
#endif
    {(char *)"__compiled__", PyTanic_Function_get_compiled, PyTanic_Function_set_compiled, NULL},
    {(char *)"__compiled_constant__", PyTanic_Function_get_compiled_constant, PyTanic_Function_set_compiled_constant,
     NULL},
    {NULL}};

static PyObject *PyTanic_Function_reduce(struct PyTanic_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *PyTanic_Function_clone(struct PyTanic_FunctionObject *function, PyObject *unused) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
#if PYTHON_VERSION >= 0x300
#if 0
    PRINT_STRING("PyTanic_Function_clone:");
    ...
    struct PyTanic_FunctionObject *result =
        PyTanic_Function_New(function->m_c_code, function->m_name,
#if PYTHON_VERSION >= 0x300
                            function->m_qualname,
#endif
...
static struct PyTanic_FunctionObject *free_list_functions = NULL;
static int free_list_functions_count = 0;

static void PyTanic_Function_tp_dealloc(struct PyTanic_FunctionObject *function) {
#if _DEBUG_REFCOUNTS
    count_active_PyTanic_Function_Type -= 1;
    count_released_PyTanic_Function_Type += 1;
#endif
...
#ifndef __DEVILPY_NO_ASSERT__
    struct PyTanic_ExceptionPreservationItem saved_exception_state2;
...
static PyMethodDef PyTanic_Function_methods[] = {{"__reduce__", (PyCFunction)PyTanic_Function_reduce, METH_NOARGS, NULL},
                                                {"clone", (PyCFunction)PyTanic_Function_clone, METH_NOARGS, NULL},
                                                {NULL}};

static PyObject *PyTanic_Function_tp_call(struct PyTanic_FunctionObject *function, PyObject *tuple_args, PyObject *kw);

PyTypeObject PyTanic_Function_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "compiled_function", // tp_name
    sizeof(struct PyTanic_FunctionObject),               // tp_basicsize
    sizeof(struct PyTanic_CellObject *),                 // tp_itemsize
    (destructor)PyTanic_Function_tp_dealloc,             // tp_dealloc
#if PYTHON_VERSION < 0x380 || defined(_DEVILPY_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    0, // tp_print
#else
    offsetof(struct PyTanic_FunctionObject, m_vectorcall), // tp_vectorcall_offset
#endif
    0,                                    // tp_getattr
    0,                                    // tp_setattr
    0,                                    // tp_compare
    (reprfunc)PyTanic_Function_tp_repr,    // tp_repr
    0,                                    // tp_as_number
    0,                                    // tp_as_sequence
    0,                                    // tp_as_mapping
    (hashfunc)PyTanic_Function_tp_hash,    // tp_hash
    (ternaryfunc)PyTanic_Function_tp_call, // tp_call
    0,                                    // tp_str
    ...
    0,                                                  // tp_doc
    (traverseproc)PyTanic_Function_tp_traverse,          // tp_traverse
    0,                                                  // tp_clear
    0,                                                  // tp_richcompare
    offsetof(struct PyTanic_FunctionObject, m_weakrefs), // tp_weaklistoffset
    0,                                                  // tp_iter
    0,                                                  // tp_iternext
    PyTanic_Function_methods,                            // tp_methods
    0,                                                  // tp_members
    PyTanic_Function_getset,                             // tp_getset
    0,                                                  // tp_base
    0,                                                  // tp_dict
    PyTanic_Function_descr_get,                          // tp_descr_get
    0,                                                  // tp_descr_set
    offsetof(struct PyTanic_FunctionObject, m_dict),     // tp_dictoffset
    0,                                                  // tp_init
    0,                                                  // tp_alloc
    0,                                                  // tp_new
    0,                                                  // tp_free
...
void _initCompiledFunctionType(void) {
    PyTanic_PyType_Ready(&PyTanic_Function_Type, &PyFunction_Type, true, false, false, false, false);

    // Be a paranoid subtype of uncompiled function, we want nothing shared.
    assert(PyTanic_Function_Type.tp_doc != PyFunction_Type.tp_doc);
    assert(PyTanic_Function_Type.tp_traverse != PyFunction_Type.tp_traverse);
    assert(PyTanic_Function_Type.tp_clear != PyFunction_Type.tp_clear || PyFunction_Type.tp_clear == NULL);
    assert(PyTanic_Function_Type.tp_richcompare != PyFunction_Type.tp_richcompare ||
           PyFunction_Type.tp_richcompare == NULL);
    assert(PyTanic_Function_Type.tp_weaklistoffset != PyFunction_Type.tp_weaklistoffset);
    assert(PyTanic_Function_Type.tp_iter != PyFunction_Type.tp_iter || PyFunction_Type.tp_iter == NULL);
    assert(PyTanic_Function_Type.tp_iternext != PyFunction_Type.tp_iternext || PyFunction_Type.tp_iternext == NULL);
    assert(PyTanic_Function_Type.tp_methods != PyFunction_Type.tp_methods);
    assert(PyTanic_Function_Type.tp_members != PyFunction_Type.tp_members);
    assert(PyTanic_Function_Type.tp_getset != PyFunction_Type.tp_getset);
    assert(PyTanic_Function_Type.tp_dict != PyFunction_Type.tp_dict);
    assert(PyTanic_Function_Type.tp_descr_get != PyFunction_Type.tp_descr_get);

    assert(PyTanic_Function_Type.tp_descr_set != PyFunction_Type.tp_descr_set || PyFunction_Type.tp_descr_set == NULL);
    assert(PyTanic_Function_Type.tp_dictoffset != PyFunction_Type.tp_dictoffset);
    // TODO: These get changed and into the same thing, not sure what to compare against, project something
    // assert(PyTanic_Function_Type.tp_init != PyFunction_Type.tp_init || PyFunction_Type.tp_init == NULL);
    // assert(PyTanic_Function_Type.tp_alloc != PyFunction_Type.tp_alloc || PyFunction_Type.tp_alloc == NULL);
    // assert(PyTanic_Function_Type.tp_new != PyFunction_Type.tp_new || PyFunction_Type.tp_new == NULL);
    // assert(PyTanic_Function_Type.tp_free != PyFunction_Type.tp_free || PyFunction_Type.tp_free == NULL);
    assert(PyTanic_Function_Type.tp_bases != PyFunction_Type.tp_bases);
    assert(PyTanic_Function_Type.tp_mro != PyFunction_Type.tp_mro);
    assert(PyTanic_Function_Type.tp_cache != PyFunction_Type.tp_cache || PyFunction_Type.tp_cache == NULL);
    assert(PyTanic_Function_Type.tp_subclasses != PyFunction_Type.tp_subclasses || PyFunction_Type.tp_cache == NULL);
    assert(PyTanic_Function_Type.tp_weaklist != PyFunction_Type.tp_weaklist);
    assert(PyTanic_Function_Type.tp_del != PyFunction_Type.tp_del || PyFunction_Type.tp_del == NULL);
#if PYTHON_VERSION >= 0x300
    assert(PyTanic_Function_Type.tp_finalize != PyFunction_Type.tp_finalize || PyFunction_Type.tp_finalize == NULL);
#endif

    // Make sure we don't miss out on attributes we are not having or should not have.
#ifndef __DEVILPY_NO_ASSERT__
    for (struct PyGetSetDef *own = &PyTanic_Function_getset[0]; own->name != NULL; own++) {
        bool found = false;
...
// produce one.
static PyObject *_PyTanic_FunctionEmptyCodeNoneImpl(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static PyObject *_PyTanic_FunctionEmptyCodeTrueImpl(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                                   PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_PyTanic_FunctionEmptyCodeFalseImpl(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                                    PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *_PyTanic_FunctionEmptyCodeGenericImpl(PyThreadState *tstate,
                                                      struct PyTanic_FunctionObject const *function,
                                                      PyObject **python_pars) {
    CHECK_OBJECT((PyObject *)function);
    assert(PyTanic_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
void PyTanic_Function_EnableConstReturnTrue(struct PyTanic_FunctionObject *function) {
    function->m_constant_return_value = Py_True;
    function->m_c_code = _PyTanic_FunctionEmptyCodeTrueImpl;
}

void PyTanic_Function_EnableConstReturnFalse(struct PyTanic_FunctionObject *function) {
    function->m_constant_return_value = Py_False;
    function->m_c_code = _PyTanic_FunctionEmptyCodeFalseImpl;
}

void PyTanic_Function_EnableConstReturnGeneric(struct PyTanic_FunctionObject *function, PyObject *value) {
    function->m_constant_return_value = value;
    function->m_c_code = _PyTanic_FunctionEmptyCodeGenericImpl;
}

#ifdef _DEVILPY_PLUGIN_DILL_ENABLED
int PyTanic_Function_GetFunctionCodeIndex(struct PyTanic_FunctionObject *function,
                                         function_impl_code const *function_table) {

    if (function->m_c_code == _PyTanic_FunctionEmptyCodeTrueImpl) {
        return -2;
    }

    if (function->m_c_code == _PyTanic_FunctionEmptyCodeFalseImpl) {
        return -3;
    }

    if (function->m_c_code == _PyTanic_FunctionEmptyCodeNoneImpl) {
        return -4;
    }

    if (function->m_c_code == _PyTanic_FunctionEmptyCodeGenericImpl) {
        return -5;
    }
...
struct PyTanic_FunctionObject *
PyTanic_Function_CreateFunctionViaCodeIndex(PyObject *module, PyObject *function_qualname, PyObject *function_index,
    ...
    DEVILPY_DYNAMIC_ARRAY_DECL(closure_cells, struct PyTanic_CellObject *, closure_size);

    for (Py_ssize_t i = 0; i < closure_size; i++) {
        closure_cells[i] = PyTanic_Cell_New0(PyTuple_GET_ITEM(closure, i));
    }

    struct PyTanic_FunctionObject *result =
        PyTanic_Function_New(offset >= 0 ? function_table[offset] : NULL, code_object->co_name,
#if PYTHON_VERSION >= 0x300
    ...
    if (offset == -2) {
        PyTanic_Function_EnableConstReturnTrue(result);
    }
    if (offset == -3) {
        PyTanic_Function_EnableConstReturnFalse(result);
    }
    if (offset == -4) {
        result->m_c_code = _PyTanic_FunctionEmptyCodeNoneImpl;
    }
    if (offset == -5) {
        CHECK_OBJECT(constant_return_value);

        PyTanic_Function_EnableConstReturnGeneric(result, constant_return_value);
...
PyObject *PyTanic_Function_ExtractCodeObjectDescription(PyThreadState *tstate, struct PyTanic_FunctionObject *function) {
    PyObject *code_object_desc = MAKE_TUPLE_EMPTY(tstate, 8);

    PyTuple_SET_ITEM0(code_object_desc, 0, function->m_code_object->co_filename);
    PyTuple_SET_ITEM0(code_object_desc, 1, function->m_code_object->co_name);
    PyTuple_SET_ITEM(code_object_desc, 2, PyTanic_PyLong_FromLong(function->m_code_object->co_firstlineno));
...
#endif
    PyTuple_SET_ITEM(code_object_desc, 4, PyTanic_PyLong_FromLong(function->m_code_object->co_argcount));
    PyTuple_SET_ITEM(code_object_desc, 5, PyTanic_PyLong_FromLong(function->m_code_object->co_flags));

#if PYTHON_VERSION < 0x380
    PyTuple_SET_ITEM(code_object_desc, 6, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 6, PyTanic_PyLong_FromLong(function->m_code_object->co_posonlyargcount));
#endif

#if PYTHON_VERSION < 0x3b0
    PyTuple_SET_ITEM(code_object_desc, 7, const_int_0);
#else
    PyTuple_SET_ITEM(code_object_desc, 7, PyTanic_PyLong_FromLong(function->m_code_object->co_kwonlyargcount));
#endif
...
#if PYTHON_VERSION >= 0x380 && !defined(_DEVILPY_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
static PyObject *PyTanic_Function_tp_vectorcall(struct PyTanic_FunctionObject *function, PyObject *const *stack,
                                               size_t nargsf, PyObject *kw_names);
#endif

// Make a function with closure.
#if PYTHON_VERSION < 0x300
struct PyTanic_FunctionObject *PyTanic_Function_New(function_impl_code c_code, PyObject *name, PyCodeObject *code_object,
                                                  PyObject *defaults, PyObject *module, PyObject *doc,
                                                  struct PyTanic_CellObject **closure, Py_ssize_t closure_given)
#else
struct PyTanic_FunctionObject *PyTanic_Function_New(function_impl_code c_code, PyObject *name, PyObject *qualname,
...
#endif
{
#if _DEBUG_REFCOUNTS
    count_active_PyTanic_Function_Type += 1;
    count_allocated_PyTanic_Function_Type += 1;
#endif

    struct PyTanic_FunctionObject *result;

    // Macro to assign result memory from GC or free list.
    allocateFromFreeList(free_list_functions, struct PyTanic_FunctionObject, PyTanic_Function_Type, closure_given);
    ...
    result->m_varnames = PyTanic_GetCodeVarNames(code_object);
    ...
    static long PyTanic_Function_counter = 0;
    result->m_counter = PyTanic_Function_counter++;

#if PYTHON_VERSION >= 0x380 && !defined(_DEVILPY_EXPERIMENTAL_DISABLE_VECTORCALL_SLOT)
    result->m_vectorcall = (vectorcallfunc)PyTanic_Function_tp_vectorcall;
#endif
...
#if PYTHON_VERSION >= 0x300
static void formatErrorNoArgumentAllowedKwSplit(struct PyTanic_FunctionObject const *function, PyObject *kw_name,
                                                Py_ssize_t given) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = PyTanic_String_AsString(function->m_name);
#else
    char const *function_name = PyTanic_String_AsString(function->m_qualname);
#endif

    PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                 PyTanic_String_AsString(kw_name));
}
#endif

static void formatErrorNoArgumentAllowed(struct PyTanic_FunctionObject const *function,
#if PYTHON_VERSION >= 0x300
                                         PyObject *kw,
#endif
                                         Py_ssize_t given) {
    ...
    if (kw == NULL) {
        ...
        PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                     PyTanic_String_AsString(tmp_arg_name));
...
static void formatErrorMultipleValuesGiven(struct PyTanic_FunctionObject const *function, Py_ssize_t index) {
...
#endif
                 function_name, PyTanic_String_AsString(function->m_varnames[index]));
}

#if PYTHON_VERSION < 0x300
static void formatErrorTooFewArguments(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static void formatErrorTooFewArguments(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
    ...
    PyErr_Format(PyExc_TypeError, "%s() missing %zd required positional argument%s: %s", function_name, max_missing,
                 max_missing > 1 ? "s" : "", PyTanic_String_AsString(list_str));

    Py_DECREF(list_str);
}
#endif

static void formatErrorTooManyArguments(struct PyTanic_FunctionObject const *function, Py_ssize_t given
#if PYTHON_VERSION < 0x270
                                        ,
                                        Py_ssize_t kw_size
...
#if PYTHON_VERSION >= 0x300
static void formatErrorTooFewKwOnlyArguments(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                             PyObject **kw_vars) {
#if PYTHON_VERSION < 0x3a0
    char const *function_name = PyTanic_String_AsString(function->m_name);
#else
...
static void formatErrorKeywordsMustBeString(PyThreadState *tstate, struct PyTanic_FunctionObject const *function) {
#if PYTHON_VERSION < 0x390
    char const *function_name = PyTanic_String_AsString(function->m_name);
...
#if PYTHON_VERSION < 0x300
    nasr_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    nasr_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
#endif
{
    ...
    while (PyTanic_DictNext(kw, &pos, &key, &value)) {
        ...
        if (unlikely(found == false)) {
            ...
            if (pos_only_error == true) {
                PyErr_Format(PyExc_TypeError,
                             ...
                             PyTanic_String_Check(key) ? PyTanic_String_AsString(key) : "<non-string>");
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsSplit(struct PyTanic_FunctionObject const *function, PyObject **python_pars,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                           PyObject **python_pars, PyObject *kw) {
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                                PyObject **python_pars, PyObject *kw)
#else
static Py_ssize_t handleKeywordArgsWithStarDict(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                                PyObject **python_pars, Py_ssize_t *kw_only_found, PyObject *kw)
...
#if PYTHON_VERSION < 0x300
static Py_ssize_t
handleKeywordArgsSplitWithStarDict(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static void makeStarListTupleCopy(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static void makeStarListTupleCopyMethod(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                        PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    assert(function->m_args_star_list_index != -1);
    Py_ssize_t list_star_index = function->m_args_star_list_index;
...
static bool _handleArgumentsPlainOnly(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
...
static bool handleMethodArgumentsPlainOnly(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
#if PYTHON_VERSION < 0x270
static bool _handleArgumentsPlain(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                  PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
...
static void releaseParameters(struct PyTanic_FunctionObject const *function, PyObject *const *python_pars) {
    Py_ssize_t arg_count = function->m_args_overall_count;
...
static bool parseArgumentsPos(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                              PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsEmpty(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                PyObject **python_pars) {
    return parseArgumentsPos(tstate, function, python_pars, NULL, 0);
}

static bool parseArgumentsMethodPos(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                    PyObject **python_pars, PyObject *object, PyObject *const *args,
                                    Py_ssize_t args_size) {
    bool result;
...
static bool parseArgumentsFullKwSplit(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                      PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
                                      PyObject *const *kw_values, PyObject *kw_names) {
...
static bool parseArgumentsFull(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
PyObject *PyTanic_CallFunctionNoArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function) {
...
PyObject *PyTanic_CallFunctionPosArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
PyObject *PyTanic_CallFunctionPosArgsKwArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
PyObject *PyTanic_CallFunctionPosArgsKwSplit(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
PyObject *PyTanic_CallMethodFunctionNoArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                          PyObject *object) {
    DEVILPY_DYNAMIC_ARRAY_DECL(python_pars, PyObject *, function->m_args_overall_count);
    memset(python_pars, 0, function->m_args_overall_count * sizeof(PyObject *));
...
PyObject *PyTanic_CallMethodFunctionPosArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
PyObject *PyTanic_CallMethodFunctionPosArgsKwArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                                 PyObject *object, PyObject *const *args, Py_ssize_t args_size,
                                                 PyObject *kw) {
    ...
    return PyTanic_CallFunctionPosArgsKwArgs(tstate, function, new_args, args_size + 1, kw);
}

static Py_ssize_t _handleVectorcallKeywordArgs(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                               PyObject **python_pars, Py_ssize_t *kw_only_found,
...
static bool MAKE_STAR_DICT_DICTIONARY_COPY38(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static bool parseArgumentsVectorcall(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
                                     PyObject **python_pars, PyObject *const *args, Py_ssize_t args_size,
    ...
    if (unlikely(arg_count == 0 && function->m_args_simple && args_size + kw_size > 0)) {
        ...
        if (kw_size == 0) {
            ...
            PyErr_Format(PyExc_TypeError, "%s() got an unexpected keyword argument '%s'", function_name,
                         PyTanic_String_AsString(kw_names[0]));
        }
...
PyObject *PyTanic_CallFunctionVectorcall(PyThreadState *tstate, struct PyTanic_FunctionObject const *function,
...
static PyObject *PyTanic_Function_tp_call(struct PyTanic_FunctionObject *function, PyObject *tuple_args, PyObject *kw) {
    ...
    if (kw == NULL) {
        ...
        return PyTanic_CallFunctionPosArgsKwArgs(tstate, function, &PyTuple_GET_ITEM(tuple_args, 0),
...
static PyObject *PyTanic_Function_tp_vectorcall(struct PyTanic_FunctionObject *function, PyObject *const *stack,
    ...
    PyThreadState *tstate = PyThreadState_GET();
    return PyTanic_CallFunctionVectorcall(tstate, function, stack, nargs,
