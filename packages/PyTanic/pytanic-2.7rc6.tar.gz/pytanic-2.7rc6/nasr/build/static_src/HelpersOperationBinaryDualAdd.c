 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(nasr_ilong *result, nasr_ilong *operand1, nasr_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(nasr_ilong *result, nasr_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
