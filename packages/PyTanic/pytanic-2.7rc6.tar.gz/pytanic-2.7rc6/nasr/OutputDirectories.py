...
""" Directories and paths to for output of PyTanic.
...
from nasr.utils.SharedLibraries import getDllSuffix
from nasr.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".nasr-pgo"
