...
from nasr import Settings, SourceCodeReferences
...
from nasr.PythonVersions import python_version, python_version_str
from nasr.Tracing import general, inclusion_logger, my_print
from nasr.utils.FileOperations import getReportPath, putTextFileContents
from nasr.utils.ModuleNames import ModuleName, checkModuleName
from nasr.utils.Shebang import getShebangFromSource, parseShebang
from nasr.utils.Utils import isWin32OrPosixWindows
...
def readSourceCodeFromFilenameWithInformation(
    ...
    if (
        ...
        and Settings.shallShowSourceModifications(module_name)
...
PyTanic is currently running with Python version '%s', which seems to not
match that. PyTanic cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m nasr'.

That will make use the correct Python version for PyTanic.
"""
