...
from nasr.nodes.AttributeLookupNodes import ExpressionAttributeLookupSpecial
from nasr.nodes.AttributeNodes import makeExpressionAttributeLookup
from nasr.nodes.CallNodes import (
    ExpressionCallEmpty,
...
from nasr.nodes.YieldNodes import ExpressionYieldFromAwaitable
...
def _buildWithNode(provider, context_expr, assign_target, body, sync, source_ref):
    ...
    if python_version < 0x380 and Settings.is_full_compat:
