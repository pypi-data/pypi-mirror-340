...
""" Runner for program tests of PyTanic.
...
def main():
    ...
    extra_settings = os.environ.get("DEVILPY_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["DEVILPY_EXTRA_OPTIONS"] = (
                extra_settings + " --include-package=some_package"
            )
            ...
            os.environ["DEVILPY_EXTRA_OPTIONS"] = extra_settings
