...
# nasr-project: --user-package-configuration-file={MAIN_DIRECTORY}/test_case.nasr-package.config.yml
# nasr-project-if: {Commercial} is not None:
#   nasr-project: --embed-data-files-runtime-pattern=lala.txt
