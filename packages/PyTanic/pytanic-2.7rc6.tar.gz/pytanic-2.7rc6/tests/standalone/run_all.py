...
""" Runner for standalone program tests of PyTanic.
...
# Find nasr package relative to us. The replacement is for POSIX python
...
from nasr.tools.testing.RuntimeTracing import (
...
from nasr.utils.Utils import isBSD, isLinux, isMacOS, isWin32Windows
...
def main():
    # Complex stuff, even more should become common code or project settings though.
    ...
    for filename in scanDirectoryForTestCases("."):
        ...
        extra_flags = [
            "expect_success",
            # Note: Tests need to specify it themselves through project settings,
