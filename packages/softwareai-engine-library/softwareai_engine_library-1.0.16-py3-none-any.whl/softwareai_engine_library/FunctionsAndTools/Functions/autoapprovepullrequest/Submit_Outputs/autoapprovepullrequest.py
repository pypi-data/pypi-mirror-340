...
tool_outputs = []
def submit_output_autoapprovepullrequest(function_name,
                                function_arguments,
                                tool_call,
                                threead_id,
                                client,
    ...
    if function_name == 'autoapprovepullrequest':
        args = json.loads(function_arguments)
        result = autoapprovepullrequest(
            repo_owner=args['repo_owner'],
            repo_name=args['repo_name'],
            pull_number=args['pull_number'],
            githubtoken_aprove=args['githubtoken_aprove'],
            githubtoken_merge=args['githubtoken_merge'],
