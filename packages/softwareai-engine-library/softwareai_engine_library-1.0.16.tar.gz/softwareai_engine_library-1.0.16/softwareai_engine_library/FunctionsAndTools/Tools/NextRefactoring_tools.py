tools_NextRefactoring = [
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "autochangesrequestedinpullrequest",
            "description": "atualiza um pull request no repositorio GitHub.",
            "parameters": {
                "type": "object",
                "properties": {
                    "repo": {
                    ...
                    "file_update": {
                        "type": "string",
                        "description": "arquivo a ser atualizado"
                    },
                    "new_content": {
                        "type": "string",
    ...
    
    {
        ...
        "function": {
            ...
            "description": "cria um pull request no repositorio GitHub.",
            "parameters": {
                "type": "object",
                "properties": {
                    "repo_owner": {
                    ...
                    "improvements": {
                        "type": "string",
                        "description": "Novo codigo melhorado."
                    },
                    "pr_title": {
                        "type": "string",
