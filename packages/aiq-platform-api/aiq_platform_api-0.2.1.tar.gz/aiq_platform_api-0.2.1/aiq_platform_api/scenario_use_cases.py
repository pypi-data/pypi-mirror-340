...
def list_scenarios(
    ...
    logger.info(f"Listing scenarios with params: {filter_params}")
    count = 0
    try:
        scenarios = ScenarioUtils.list_scenarios(client, params=filter_params)
        for scenario in itertools.islice(scenarios, limit):
            count += 1
            logger.info(
