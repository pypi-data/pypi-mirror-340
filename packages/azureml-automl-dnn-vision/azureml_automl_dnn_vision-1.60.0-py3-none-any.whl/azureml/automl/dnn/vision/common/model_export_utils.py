...
def prepare_model_export(run: Run, output_dir: str, task_type: str,
                         ...
                         save_as_mlflow: bool = False, is_yolo: bool = False,
...
def _get_scoring_file(run: Run, task_type: str, model_settings: Optional[Dict[str, Any]] = {},
    ...
    :rtype: str
    """
    scoring_path = os.path.join('inference', 'score_images.txt')
    scoring_file_ref = package_resources.files(inference.PACKAGE_NAME) / scoring_path
    ...
    with package_resources.as_file(scoring_file_ref) as scoring_file_path:
