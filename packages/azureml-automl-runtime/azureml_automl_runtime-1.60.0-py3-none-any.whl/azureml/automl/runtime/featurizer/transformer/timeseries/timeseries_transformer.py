...
class TimeSeriesTransformer(AutoMLTransformer, FeaturizationInfoProvider):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self.y_min_dict = {}  # type: Dict[GrainType, float]
        self.y_max_dict = {}  # type: Dict[GrainType, float]
    ...
    def _internal_fit(self, df, y):
        ...
        for grain, df_one in tsds.groupby_time_series_id():
            ...
            if tsds_one.target_values is not None:
                self.y_min_dict[grain] = float(tsds_one.target_values.min())
                self.y_max_dict[grain] = float(tsds_one.target_values.max())
