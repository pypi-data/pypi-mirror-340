...
class RawExperimentData:
    ...
    def create(cls,
        ...
        The keys expected within the dictionary are:
            - X, y, sample_weight, X_valid, y_valid, sample_weight_valid, cv_splits_indices (For legacy data inputs)
        ...
        return RawExperimentData(
            ...
            weights=data_dictionary.get("sample_weight"),
            X_valid=data_dictionary.get("X_valid"),
            y_valid=data_dictionary.get("y_valid"),
            weights_valid=data_dictionary.get("sample_weight_valid"),
