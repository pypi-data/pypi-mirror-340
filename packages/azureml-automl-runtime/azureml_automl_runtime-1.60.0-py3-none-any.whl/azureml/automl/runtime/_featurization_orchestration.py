...
# ---------------------------------------------------------
"""Module for orchestration of featurization across AutoML Tasks."""
import logging
...
def orchestrate_featurization(
    ...
    if is_timeseries:
        ...
        # If featurization is disabled, this is used to initialize the experiment store later in the code
