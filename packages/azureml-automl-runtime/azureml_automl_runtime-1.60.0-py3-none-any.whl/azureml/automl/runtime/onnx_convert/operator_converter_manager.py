...
from .operator_converters import \
    ImputerConverter  # noqa: E402
from .operator_converters import \
    NormalizerConverter  # noqa: E402
...
class OperatorConverterManager:
    ...
    def _setup_default_operator_converters(self):
        ...
        self.register_op_converter(ImputerConverter())
        self.register_op_converter(NormalizerConverter())
