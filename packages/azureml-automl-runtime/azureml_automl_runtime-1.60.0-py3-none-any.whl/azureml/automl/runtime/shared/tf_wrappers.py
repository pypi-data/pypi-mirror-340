...
try:
    ...
    tensorflow_version_str = package_metadata.version("tensorflow")
    tensorflow_version = version.parse(tensorflow_version_str)

    if tensorflow_version <= version.parse("1.12.0") and \
       tensorflow_version >= version.parse("1.10.0"):
