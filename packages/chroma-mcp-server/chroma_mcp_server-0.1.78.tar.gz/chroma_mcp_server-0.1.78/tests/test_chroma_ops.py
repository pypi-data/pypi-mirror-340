...
class TestEmbeddingFunction:
    ...
    @pytest.mark.skipif(not platform.system() == "Darwin" or not ("Intel" in platform.processor() or platform.processor() == "i386"), reason="Test specific to Intel Mac environment where CPU provider is forced")
