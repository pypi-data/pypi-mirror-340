...
TOOL_NAMES = {
    ...
    "ADD_DOCS_IDS": "chroma_add_documents_with_ids",
    "ADD_DOCS_META": "chroma_add_documents_with_metadata",
    "ADD_DOCS_IDS_META": "chroma_add_documents_with_ids_and_metadata",
    ...
    "DELETE_DOCS_IDS": "chroma_delete_documents_by_ids",
    "DELETE_DOCS_WHERE": "chroma_delete_documents_by_where_filter",
    "DELETE_DOCS_DOC": "chroma_delete_documents_by_document_filter",
}
...
INPUT_MODELS = {
    ...
    TOOL_NAMES["ADD_DOCS_IDS"]: AddDocumentsWithIDsInput,
    TOOL_NAMES["ADD_DOCS_META"]: AddDocumentsWithMetadataInput,
    TOOL_NAMES["ADD_DOCS_IDS_META"]: AddDocumentsWithIDsAndMetadataInput,
    ...
    TOOL_NAMES["DELETE_DOCS_IDS"]: DeleteDocumentsByIdsInput,
    TOOL_NAMES["DELETE_DOCS_WHERE"]: DeleteDocumentsByWhereFilterInput,
    TOOL_NAMES["DELETE_DOCS_DOC"]: DeleteDocumentsByDocumentFilterInput,
...
IMPL_FUNCTIONS = {
    ...
    TOOL_NAMES["ADD_DOCS_IDS"]: _add_documents_with_ids_impl,
    TOOL_NAMES["ADD_DOCS_META"]: _add_documents_with_metadata_impl,
    TOOL_NAMES["ADD_DOCS_IDS_META"]: _add_documents_with_ids_and_metadata_impl,
    ...
    TOOL_NAMES["DELETE_DOCS_IDS"]: _delete_documents_by_ids_impl,
    TOOL_NAMES["DELETE_DOCS_WHERE"]: _delete_documents_by_where_filter_impl,
    TOOL_NAMES["DELETE_DOCS_DOC"]: _delete_documents_by_document_filter_impl,
...
async def list_tools() -> List[types.Tool]:
    ...
    tool_definitions = [
        ...
        types.Tool(
            ...
            inputSchema=INPUT_MODELS[TOOL_NAMES["CREATE_COLLECTION_WITH_META"]].model_json_schema(), # Schema now expects a string
        ),
        # --- End Re-enable --- #
        types.Tool(
        ...
        # --- Delisted due to API instability and client schema parsing issues ---
        # types.Tool(
        ...
        types.Tool(
            ...
            inputSchema=INPUT_MODELS[TOOL_NAMES["DELETE_DOCS_IDS"]].model_json_schema(),
        ),
        types.Tool(
            name=TOOL_NAMES["DELETE_DOCS_WHERE"],
            description="Delete documents from a collection using a metadata filter.",
            inputSchema=INPUT_MODELS[TOOL_NAMES["DELETE_DOCS_WHERE"]].model_json_schema(),
        ),
        types.Tool(
            name=TOOL_NAMES["DELETE_DOCS_DOC"],
            description="Delete documents from a collection using a document content filter.",
            inputSchema=INPUT_MODELS[TOOL_NAMES["DELETE_DOCS_DOC"]].model_json_schema(),
        ),
