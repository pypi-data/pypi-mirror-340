# Modified by jansturm1 11.4.2025 10:00
# Original source: https://github.com/pwollstadt/IDTxl
...
def test_import_fieldtrip():
    file_path = files(__name__).joinpath("data/ABA04_Up_10-140Hz_v7_3.mat")
...
def test_import_matarray():
    ...
    (dat, label, timestamps, fsample) = import_matarray(
        file_name=files(__name__).joinpath("data/one_dim_v7_3.mat"),
        array_name="a",
        dim_order="s",
        file_version="v7.3",
        normalise=False,
    ...
    (dat, label, timestamps, fsample) = import_matarray(
        file_name=files(__name__).joinpath("data/two_dim_v7_3.mat"),
        array_name="b",
        dim_order="sp",
        file_version="v7.3",
        normalise=False,
    ...
    (dat, label, timestamps, fsample) = import_matarray(
        file_name=files(__name__).joinpath("data/three_dim_v7_3.mat"),
        array_name="c",
        dim_order="rsp",
        file_version="v7.3",
        normalise=False,
    ...
    file_path = [
        files(__name__).joinpath("data/two_dim_v4.mat"),
        files(__name__).joinpath("data/two_dim_v6.mat"),
        files(__name__).joinpath("data/two_dim_v7.mat"),
    ]
