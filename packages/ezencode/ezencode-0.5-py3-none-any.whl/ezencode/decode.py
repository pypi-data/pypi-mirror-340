...
class Decode(object):
    ...
    @classmethod
    def character_stream(cls: type['Decode'], /) -> Generator[str | int]:
    ...
    @classmethod
    def binary_stream(cls: type['Decode'], /) -> Generator[str | int]:
    ...
    @classmethod
    def ascii_stream(cls: type['Decode'], /) -> Generator[str | int]:
    ...
    @classmethod
    def decoded(cls: type['Decode'], /) -> str:
