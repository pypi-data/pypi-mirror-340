import { createTypeSpecLibrary, paramMessage, resolvePath, getDoc, isDeclaredInNamespace, getEffectiveModelType, formatDiagnostic, getFriendlyName, isTemplateInstance, compilerAssert, isType, getTypeName } from '@typespec/compiler';
...
const TypeSpecProtobufLibrary = createTypeSpecLibrary({
    name: PACKAGE_NAME,
    capabilities: {
        dryRun: true,
    },
...
const __DIAGNOSTIC_CACHE = new WeakMap();
...
const reportDiagnostic = Object.assign(TypeSpecProtobufLibrary.reportDiagnostic, {
    /**
...
const state = Object.fromEntries(keys.map((k) => [k, TypeSpecProtobufLibrary.createStateSymbol(k)]));
 ...
 */
const PROTO_FULL_IDENT = /([a-zA-Z][a-zA-Z0-9_]*)+/;
/**
 ...
 */
const $package = (ctx, target, details) => {
...
const $externRef = (ctx, target, path, name) => {
    ctx.program
        .stateMap(state.externRef)
        .set(target, [path.value, name.value]);
};
const $stream = (ctx, target, mode) => {
...
const $reserve = (ctx, target, ...reservations) => {
 ...
 * @returns
 */
const $field = (ctx, target, fieldIndex) => {
...
const $lib = TypeSpecProtobufLibrary;
...
const TypeSpecSources = {
  "package.json": "{\"name\":\"@typespec/protobuf\",\"version\":\"0.67.0\",\"author\":\"Microsoft Corporation\",\"description\":\"TypeSpec library and emitter for Protobuf (gRPC)\",\"homepage\":\"https://github.com/microsoft/typespec\",\"readme\":\"https://github.com/microsoft/typespec/blob/main/packages/protobuf/README.md\",\"license\":\"MIT\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/microsoft/typespec.git\"},\"bugs\":{\"url\":\"https://github.com/microsoft/typespec/issues\"},\"keywords\":[\"typespec\",\"protobuf\",\"grpc\"],\"main\":\"dist/src/index.js\",\"exports\":{\".\":{\"typespec\":\"./lib/proto.tsp\",\"types\":\"./dist/src/index.d.ts\",\"default\":\"./dist/src/index.js\"},\"./testing\":\"./dist/src/testing/index.js\"},\"type\":\"module\",\"tspMain\":\"lib/proto.tsp\",\"scripts\":{\"clean\":\"rimraf ./dist ./temp\",\"build\":\"npm run gen-extern-signature && tsc -p .\",\"watch\":\"tsc -p . --watch\",\"gen-extern-signature\":\"tspd --enable-experimental gen-extern-signature .\",\"test\":\"vitest run\",\"test:ci\":\"vitest run --coverage --reporter=junit --reporter=default\",\"lint\":\"eslint . --max-warnings=0\",\"lint:fix\":\"eslint . --fix\",\"regen-docs\":\"tspd doc .  --enable-experimental  --output-dir ../../website/src/content/docs/docs/emitters/protobuf/reference\"},\"peerDependencies\":{\"@typespec/compiler\":\"workspace:^\"},\"devDependencies\":{\"@types/micromatch\":\"^4.0.9\",\"@types/node\":\"~22.13.9\",\"@typespec/compiler\":\"workspace:^\",\"@typespec/tspd\":\"workspace:^\",\"@vitest/coverage-v8\":\"^3.0.7\",\"@vitest/ui\":\"^3.0.7\",\"c8\":\"^10.1.3\",\"micromatch\":\"^4.0.8\",\"rimraf\":\"~6.0.1\",\"typescript\":\"~5.8.2\",\"vitest\":\"^3.0.7\"}}",
...
export { $_map, $decorators, $externRef, $field, $lib, $message, $onEmit, $onValidate, $package, $reserve, $service, $stream, PROTO_FULL_IDENT, _TypeSpecLibrary_, isMap, namespace };
