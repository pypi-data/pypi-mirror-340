...
from xecution.common.enums import Exchange, KlineType, Mode, OrderSide, OrderType, Symbol
...
class Engine(BaseEngine):
    ...
    async def on_candle_closed(self, kline_topic: KlineTopic):
        ...
        # await self.set_hedge_mode(True)
        # await self.place_order(order_config=OrderConfig(
