...
class BinanceService:
    ...
    async def listen_order_status(self, on_order_update, kline_topic: KlineTopic):
        """
        ...
        try:
            ...
            # 生成 WebSocket 連線 URL
            ws_url = (
                self.binanceHelper.get_websocket_user_data_base_url(kline_topic, self.config.mode)
                + f"/{listen_key}"
            )
