...
async def get_current_active_user(authorization_data: str):
    return await fetch_user_info(authorization_data, f"{user_setting.url}/api/v1/users/me/minify")


async def get_current_active_user_more_info(authorization_data: str):
    return await fetch_user_info(authorization_data, f"{user_setting.url}/api/v1/users/me")