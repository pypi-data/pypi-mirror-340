...
if platform.system() == 'Windows':
	...
	raise DataFrameDBException(f"YSDB not supported on platform {platform.system()} (macos)")
else:
	raise DataFrameDBException(f"YSDB not supported on platform {platform.system()}")
