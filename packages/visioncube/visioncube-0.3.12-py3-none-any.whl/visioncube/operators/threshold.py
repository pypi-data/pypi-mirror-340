...
class BarCodeMask(AbstractTransform):
    ...
    def __init__(self, threshold: float = 180, min_area: int = 100):
    ...
    def _apply(self, sample):
        ...
        image_gray = rgb_to_gray(sample.image)
        image_blurred = cv.GaussianBlur(image_gray, (51, 51), 0)  # 高斯模糊处理
        ...
        sample.image = binary_mask * sample.image
        return sample
