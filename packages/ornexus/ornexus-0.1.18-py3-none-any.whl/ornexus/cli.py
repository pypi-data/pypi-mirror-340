...
from ornexus.database import MongoDBAsyncIntegration
...
async def authenticate_user(email, password):
    ...
    try:
        ...
        if not mongo_uri:
            print("❌ Erro: Variável de ambiente MONGODB_CONN não definida")
            return None
        
        # Conectar ao MongoDB
        mongo = MongoDBAsyncIntegration(mongo_uri, "users")
