...
def deploy_api_structure(project_path=None, force=True):
    ...
    # Remover a verificação de projeto válido ou torná-la mais abrangente
    # Verificar estruturas tanto de projetos Agno quanto CrewAI
    ...
    if not is_valid_project:
        print(f"⚠️ Aviso: O diretório não parece ser um projeto OrNexus reconhecido.")
        print("  Continuando mesmo assim, pois a estrutura da API será criada independentemente.")
        # Note que removemos o return False aqui, para continuar mesmo sem ser um projeto reconhecido
