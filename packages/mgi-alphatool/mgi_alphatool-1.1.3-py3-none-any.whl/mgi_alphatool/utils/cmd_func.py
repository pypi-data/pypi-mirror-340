...
def process_change_tip_cmd(commands: List[Dict]) -> List[Dict]:
    # TODO: process change tip command
    # handle new tip == never
    # if command.get('use_new_tip', None) == 'never':
    #     # Remove previous drop tip commands
    #     while 'droptip' in cleaned_commands[-1]['commandType'].lower():
    #         cleaned_commands.pop()
    return commands
