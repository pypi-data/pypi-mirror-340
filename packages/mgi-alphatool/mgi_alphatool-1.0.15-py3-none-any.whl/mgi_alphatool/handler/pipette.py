...
class Pipette(Handler):
    ...
    def __execute_transfer(
        ...
        if drop_tip:
            self.drop_tip()
        # self._get_context()._await_drop_tip_before_next_command(self._get_mount())
    ...
    def transfer(self, 
        ...
        Args:
            ...
            drop_tip (bool, optional): Drop tip at the end of mixing. Defaults to True. In most cases, user do not need to modify this parameters, as the change tips logic is handled by the use_new_tip parameter.
