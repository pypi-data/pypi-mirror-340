...
from .utils.cmd_func import concat_pcr_run_cmd, clean_cmd, process_change_tip_cmd
...
class Context:
    def __init__(self, robot_type: str, 
        ...
        # self.__drop_tip_before_next_command = {"left": False, "right": False}
    ...
    def _export(self, save_dir: Optional[str] = None) -> str:
        ...
        self.__json['commands'] = process_change_tip_cmd(self.__json['commands'])
    ...
    def _append_command(self, command: Any) -> None:
        # for mount in ['left', 'right']:
        #     if self.__drop_tip_before_next_command[mount]:
        #         self.__drop_tip_before_next_command[mount] = False
    ...
    # def _await_drop_tip_before_next_command(self, mount: Literal['left', 'right']) -> None:
    #     """Await drop tip before next command.
        
    #     Args:
    #         pipette (Pipette): The pipette to await drop tip for.
    #     """
    #     self.__drop_tip_before_next_command[mount] = True
