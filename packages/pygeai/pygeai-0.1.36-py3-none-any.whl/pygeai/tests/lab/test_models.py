...
from pygeai.lab.models import (
    ...
    TaskList, Variable, VariableList, ProcessInstance, ProcessInstanceList
)
...
class TestLabModels(TestCase):
    ...
    def test_tool_model_validate(self):
        tool_data = {
            ...
            "scope": "builtin",
            "parameters": [{"key": "input", "dataType": "String", "description": "Input text", "isRequired": True}]
        }
    ...
    def test_tool_list_model_validate(self):
        tool_list_data = {
            "tools": [
                {"name": "Tool1", "description": "Tool 1", "scope": "builtin"},
                {"name": "Tool2", "description": "Tool 2", "scope": "builtin"}
            ]
        }
