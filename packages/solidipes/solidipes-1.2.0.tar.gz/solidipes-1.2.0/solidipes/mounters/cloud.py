...
class Mounter:
    ...
    @classmethod
    def run_and_check_return(cls, command, **kwargs):
    ...
    @classmethod
    def unmount(cls, path, headless=False, **kwargs):
        command = ["umount", path]
    ...
    def remove_keys_from_info(self, mount_info):
...
def set_cloud_info(config, path=None, *args, **kwargs):
