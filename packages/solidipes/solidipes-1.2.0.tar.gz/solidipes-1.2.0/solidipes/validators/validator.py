...
def add_validation_error(errors: Union[str, list[str]]):
...
class Validator(ABC, Generic[T]):
    ...
    def __init__(self, description: str, mandatory: bool = True):
...
class ValidationResult:
    ...
    def __init__(self, validator: Validator, valid: bool, errors: list[str]):
