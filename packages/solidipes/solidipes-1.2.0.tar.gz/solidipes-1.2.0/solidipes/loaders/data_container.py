...
class TemporaryFile:
    def __init__(self, delete=False, init=True):
        import os
        import tempfile
...
class DataContainer(ROCrateMetadata):
    ...
    def __init__(self, initial_data={}, name=None, unique_identifier=None, **kwargs):
        ...
        def register_to_data_collection(cls):
    ...
    def preferred_viewer_name(self, name: str):
    ...
    def preferred_viewer(self, viewer: Optional[Type["Viewer"]]):
        """Set the default viewer for this data container. Adds the viewer to the list of compatible viewers."""
