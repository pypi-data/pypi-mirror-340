...
class Scanner(ABC):
    ...
    def __init__(self, search_path=".", reload_excluded=True):
    ...
    def add_filepath(self, filestruct: FileStruct):
        ...
        if self.is_excluded(filepath):
            logger.warning(f"Exclude {filepath}")
            return
