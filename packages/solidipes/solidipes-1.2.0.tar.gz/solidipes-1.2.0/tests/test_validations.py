...
class TestLoaders:
    def test_file_valid(self, study_dir: Path):
        # Create file
    ...
    def test_file_empty(self, study_dir: Path):
        # Create file
        file_path = study_dir / "file.txt"
    ...
    def test_file_invalid_extension(self, study_dir: Path):
        # Create file
    ...
    def test_file_invalid_mime(self, study_dir: Path):
        # Create file
    ...
    def test_file_wrong_loader(self, study_dir: Path):
        # Create file
        file_path = study_dir / "file.txt"
    ...
    def test_code_snippet_valid(self, study_dir: Path):
        # Create file
    ...
    def test_code_snippet_invalid_lint(self, study_dir: Path):
        # Create file
        file_path = study_dir / "file.py"
    ...
    def test_binary(self, study_dir: Path):
        # Create file
    ...
    def test_disabling_validator(self, study_dir: Path):
        # Create file
        file_path = study_dir / "file.bin"
    ...
    def test_validator_cache(self, study_dir: Path):
        # Create file
        file_path = study_dir / "file.bin"
