...
class PluginPackageNames(LazyList):
    ...
    def __init__(self, plugins_group_name: str):
        super().__init__()
...
class ClassList(LazyList):
    ...
    def __init__(self, plugins_package_names: PluginPackageNames):
        super().__init__()
...
class LoaderList(ClassList):
    ...
    def _populate_mime_type2extensions(self):
        self._mime_type2extensions = {}
    ...
    def _populate_extension2_mime_types(self):
        self._extension2mime_types = {}
    ...
    def _populate_mime_type2loaders(self):
        self._mime_type2loaders = {}
    ...
    def _populate_extension2loaders(self):
        self._extension2loaders = {}
