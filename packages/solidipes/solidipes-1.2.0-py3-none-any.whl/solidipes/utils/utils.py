...
class parameter(property):
    def __init__(self, func, optional=False):
...
def populate_parser(cls, parser):
    ...
    def register_to_data_collection(_cls):
...
def run_and_check_return(command, headless=False, fail_message="Error", timeout=cloud_connection_timeout):
    import subprocess
