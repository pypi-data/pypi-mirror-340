...
def set_streamlit_layout(layout: "DeltaGenerator"):
...
class StreamlitSpinner(Spinner):
    def __init__(self, description: str, layout: Optional["DeltaGenerator"] = None):
        """Streamlit spinner."""
...
class ProgressBar(ProgressDisplay):
    def __init__(self, description: str, total: float = 100, show_datasize: bool = False):
...
class StreamlitProgressBar(ProgressBar):
    def __init__(self, *args, layout: Optional["DeltaGenerator"] = None, **kwargs):
