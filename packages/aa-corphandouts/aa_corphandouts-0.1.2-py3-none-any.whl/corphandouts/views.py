...
from corphandouts.models import DoctrineReport, FittingToCorrect
...
def doctrine(request, doctrine_id: int):
    ...
    return render(
        ...
        add_common_context({"fittings": fittings}),
    )
...
def fitting(request, fitting_id: int):
    """Fitting report"""
    fitting = get_object_or_404(FittingToCorrect, pk=fitting_id)
