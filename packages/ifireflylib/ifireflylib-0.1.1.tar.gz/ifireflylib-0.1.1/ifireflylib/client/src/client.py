...
class IFireflyClient:
    ...
    def _load_library(self):
        ...
        try:
            ...
            # From: ifireflylib/ifireflylib/client/src/client.py
            # To:   ifireflylib/ifireflylib/native/
            native_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), "native")
