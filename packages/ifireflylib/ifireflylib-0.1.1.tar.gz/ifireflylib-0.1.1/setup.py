...
setup(
    ...
    author="IDSolutions",
    packages=find_namespace_packages(include=["ifireflylib", "ifireflylib.*", "ifireflylib.*.*"]),
    ...
    package_data={
        'ifireflylib': [
            'native/windows/libFireflyClient.dll',
            'native/linux/libFireflyClient.so',
            'native/darwin/libFireflyClient.dylib'
        ]
    },
