    ...
    ***
    ...
    def __run_general_model_checks(self):
        try:
            ...
            model_checks_tabular = CheckModel(
                self.__progress_bar,
                model_name=self.__model_name,
                model_path=self.__model_file_path,
            )
            (
                ...
                self.__model_name,
                __progress_bar,
            ) = model_checks_tabular.model_func_checks()

            if not status:
                remove_tmp_file(tmp_dir_path=model_checks_tabular.tmp_file_path)
                text = colored(
                    self.__message,
                    "red",
                )
                ...
                return None
            self.__model = model_checks_tabular.model
            self.__general_checks_obj = model_checks_tabular
            gc.collect()
