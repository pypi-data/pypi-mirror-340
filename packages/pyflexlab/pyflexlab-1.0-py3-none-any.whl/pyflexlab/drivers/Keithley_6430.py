...
class Keithley_6430(VisaInstrument):
    ...
    def __init__(
        ...
        self.add_parameter(
            ...
            vals=Enum("VOLT", "CURR"),
            docstring="Either 'VOLT' to source voltage, or 'CURR' for current.",
        )
        self.add_parameter(
            "sense_mode",
        ...
        self.add_parameter(
            ...
            get_cmd=":TRIG:SOUR?",
            vals=Enum("IMM", "TLIN"),
            docstring="Specify trigger control source.IMMediate or TLINk.",
        )
        self.add_parameter(
            "arm_source",
            set_cmd=":ARM:SOUR {}",
        ...
        self.add_parameter(
            ...
            get_cmd=":MED:RANK?",
            vals=Ints(),
            docstring="Number of reading samples for the median filter process.",
        )
        self.add_parameter(
            "filter_moving",
            get_parser=int,
            ...
            get_cmd=":AVER:COUN?",
            vals=Ints(),
            docstring="Number of reading samples in the moving average filter.",
        )
    ...
    def _read_value(self, quantity: str):  # -> float:
        ...
        if quantity not in mode_now:
            warnings.warn(
                f"{self.short_name} tried reading {quantity}, but "
