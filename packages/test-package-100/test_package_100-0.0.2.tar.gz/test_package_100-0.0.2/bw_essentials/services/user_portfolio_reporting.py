...
metadata (e.g., tenant ID, request ID, headers) and encapsulates logic to prepare
...
class UserReporting(ApiClient):
    ...
    def __init__(self,
                 ...
                 headers: dict):
        """
        Initializes the UserReporting client with user, base URL, request ID, tenant ID, and headers.
