...
class Block(object):
    ...
    def __init__(self, hash=None, block_id=None, start_time=None, end_time=None, log_time=None, root=None, height=None, length=None, prev_hash=None, tree_file=None, log_file=None, valid=None, validation_time=None, deleted_at=None):  # noqa: E501
