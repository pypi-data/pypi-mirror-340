...
from fspacker.packers import Packer
...
def build(
    ...
    mode = PackMode(archive=archive, debug=debug, offline=offline, simplify=simplify, use_tk=use_tk)
