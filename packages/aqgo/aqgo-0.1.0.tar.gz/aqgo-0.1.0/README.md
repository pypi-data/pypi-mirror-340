# AletheIA Quantum Genetic Optimizer (AQGO)
...
```pip install aletheia-quantum-genetic-optimizer```
...
El Aletheia Quantum Genetic Optimizer está diseñado para resolver varios tipos de problemas de optimización. Uno de los escenarios para los que se ha programado, es encontrar los mejores hiperparámetros de modelos de IA, o problemas de tipo similar. 
...
### Ventajas de usar el AletheIA Quantum Genetic Optimizer para este tipo de problemas
...
Para este tipo de problemas, el AletheIA Quantum Genetic Optimizer es muy prometedor.

En general, en las pruebas realizadas para contrastar su potencialidad con respecto a otros algoritmos genético clásicos, a superado al AletheIA Classic Genetic Optimizer, que de por sí es muy bueno, en cantidad de generaciones requeridas para alcanzar la mejor métrica posible para el modelo y problema evaluado, tanto para problemas de clasificación como de regresión. Sin embargo, se debe tener en cuenta, que no converge a la manera que lo hace un optimizador clásico donde se puede notar que toda la población va acompañando la suba o baja de la métrica evaluada. En el caso del AletheIA Quantum Genetic Optimizer se aprecia un procedimiento más elitista, es decir, encuentra por capacidad explotaria máximos o mínimos globales muy buenos, pero lo hacen pocos individuos de cada población.
...
def example_tsp():
    ...
    # -- Creación de función objetivo que debe resolver el AletheIA Quantum Genetic Optimizer
...
El Aletheia Quantum Genetic Optimizer está diseñado para resolver varios tipos de problemas de optimización. Uno de los escenarios para los que se ha programado, es encontrar la ruta óptima o casi óptima en un TSP. 
...
![qc_reproduction_bound_restricted.png](imgs_readme%2Fqc_reproduction_bound_restricted.png)
