...
class Quest:
    ...
    def start_chain(self, prompt, warm_start=None) -> State:
        ...
        torch.cuda.nvtx.range_push("quest:model_generate")
        ...
        torch.cuda.nvtx.range_push("quest:compute_reward")
        state.reward = self.compute_reward(state.text)
    ...
    def draw_transition(
        ...
        torch.cuda.nvtx.range_push("quest:model_generation")
        proposal_state = self.proposal.transition(previous_state, prompt)
        torch.cuda.nvtx.range_pop()
