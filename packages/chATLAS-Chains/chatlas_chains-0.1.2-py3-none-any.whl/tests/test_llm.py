...
from chATLAS_Chains.llm.model_selection import get_chat_model, SUPPORTED_CHAT_MODELS  # Replace with actual path
...
def test_all_supported_models_resolve(mock_env_key, mock_model_class):
    ...
    with patch("importlib.import_module") as mock_import_module:
        ...
        for model_name in SUPPORTED_CHAT_MODELS.keys():
