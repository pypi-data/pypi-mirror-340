...
def initialize_vector_store(model_path, postgres_password, db_name):
    ...
    vectorstore = PostgresParentChildVectorStore(
    ...
    logger.info(f"Vector store initialised")
...
twiki_vectorstore = initialize_vector_store(model_path=embedding_model_path,postgres_password=os.getenv("CHATLAS_DB_PASSWORD"), db_name="twiki_prod")
cds_vectorstore = initialize_vector_store(model_path=embedding_model_path,postgres_password=os.getenv("CHATLAS_DB_PASSWORD"), db_name="cds_prod_v1")
indico_vectorstore = initialize_vector_store(model_path=embedding_model_path,postgres_password=os.getenv("CHATLAS_DB_PASSWORD"), db_name="indico_prod_v1")
