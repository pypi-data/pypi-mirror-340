...
class SlePointCalculationInput:
    ...
    pointtype : str
        Type of calculation. Allowed values are: `{'Fixed Pressure', 'Fixed Temperature/Pressure'}`
    units : str
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump an instance of `SlePointCalculationInput` to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Create an instance of `SlePointCalculationInput` from a dict."""
        d = src_dict.copy()
