...
T = TypeVar("T", bound="ApiOutputEosPropertiesTPnResultResidual")


@attr.s(auto_attribs=True)
class ApiOutputEosPropertiesTPnResultResidual:
    """Holds residual values. This is stored in the `ApiOutputEosPropertiesTPnResult.residual` attribute.
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump an instance of `ApiOutputEosPropertiesTPnResultResidual` to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Create an instance of `ApiOutputEosPropertiesTPnResultResidual` from a dict."""
        d = src_dict.copy()
    ...
    def __str__(self) -> str:
        """
        Returns a compact string of non-Unset residual properties.
        """
        items = []
