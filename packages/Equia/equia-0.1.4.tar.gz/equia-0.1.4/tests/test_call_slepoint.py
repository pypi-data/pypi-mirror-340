...
async def test_call_slepoint():
    ...
    input: SlePointCalculationInput = client.get_sle_point_input()
    input.pressure = 20
    input.components = [
    ...
    result: Union[SlePointCalculationResult, ProblemDetails] = await client.call_sle_point_async(input)
