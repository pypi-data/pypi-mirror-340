...
class CloudPointCalculationInput:
    ...
    pointtype : str
        Cloud point to look for: Allowed values are: `{'Fixed Temperature', 'Fixed Pressure'}`
    units : str
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump an instance of `CloudPointCalculationInput` to a dict."""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Create an instance of `CloudPointCalculationInput` from a dict."""
        d = src_dict.copy()
