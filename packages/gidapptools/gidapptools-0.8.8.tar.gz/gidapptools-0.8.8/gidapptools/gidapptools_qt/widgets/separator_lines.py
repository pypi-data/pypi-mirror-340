...
class SeparatorLine(QFrame):
    ...
    def _update_line_orientation(self) -> None:
        shape = QFrame.Shape.HLine if self._orientation is Qt.Orientation.Horizontal else QFrame.Shape.VLine
    ...
    def __repr__(self) -> str:
        return f"{__class__.__name__}(orientation={self.orientation!r}, parent={self.parent()})"


class HorizontalSeparatorLine(SeparatorLine):

    def __init__(self, parent: Optional[QWidget] = None) -> None:
        super().__init__(Qt.Orientation.Horizontal, parent)


class VerticalSeparatorLine(SeparatorLine):
