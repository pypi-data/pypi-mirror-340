...
def check_is_widget(in_class: type) -> bool:
    return issubclass(in_class, QWidget)


def check_has_data_set_methods(in_class: type) -> bool:
    return hasattr(in_class, "set_data") and hasattr(in_class, "setData")
