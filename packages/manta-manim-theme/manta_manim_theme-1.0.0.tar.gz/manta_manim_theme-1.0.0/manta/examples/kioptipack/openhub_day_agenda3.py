...
class OpenHubDaysAgenda3(CarolusTheme, TitleSlide):
    ...
    def construct(self):
        ...
        # book-lock-outline -> policy

        # book-search-outline
        # book_atlas -> ontologie
...
if __name__ == '__main__':
    ...
    #OpenHubDaysAgenda3.render_video_medium()
    OpenHubDaysAgenda3.save_sections_without_cache()