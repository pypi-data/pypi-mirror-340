...
set_target_properties(nanoarrow::nanoarrow PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/nanoarrow.lib"
  )

list(APPEND _cmake_import_check_targets nanoarrow::nanoarrow )
list(APPEND _cmake_import_check_files_for_nanoarrow::nanoarrow "${_IMPORT_PREFIX}/lib/nanoarrow.lib" )
