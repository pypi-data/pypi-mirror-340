...
class ScoringConfig(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ScoringConfig:
        ...
        _obj = ScoringConfig.parse_obj({
            ...
            obj.get("reranker"),
            "weights":
            Weights.from_dict(obj.get("weights"))
            if obj.get("weights") is not None else None,
        })
...
class ScoringConfigModel():
    ...
    def _to_model(self):
        return ScoringConfig(
            ...
            weights=self.weights._to_model()
    ...
    def _from_model(cls, model) -> ScoringConfigModel:
        return ScoringConfigModel(
            ...
            weights=WeightsModel._from_model(model.weights)
            if model.weights is not None else None,
        )
