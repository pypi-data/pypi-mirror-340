...
class GenerateVerifiedQuerySuggestionsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> GenerateVerifiedQuerySuggestionsResponse:
    ...
    def from_dict(cls, obj: dict) -> GenerateVerifiedQuerySuggestionsResponse:
        ...
        _obj = GenerateVerifiedQuerySuggestionsResponse.parse_obj({
            ...
            obj.get("request_id"),
            "vq_suggestions": [
                VerifiedQuerySuggestion.from_dict(_item)
                for _item in obj.get("vq_suggestions")
            ] if obj.get("vq_suggestions") is not None else None,
            "warnings":
...
class GenerateVerifiedQuerySuggestionsResponseModel():
    ...
    def _to_model(self):
        return GenerateVerifiedQuerySuggestionsResponse(
            ...
            vq_suggestions=[x._to_model() for x in self.vq_suggestions]
            if self.vq_suggestions is not None else None,
    ...
    @classmethod
    def _from_model(cls,
                    model) -> GenerateVerifiedQuerySuggestionsResponseModel:
        return GenerateVerifiedQuerySuggestionsResponseModel(
            request_id=model.request_id,
            vq_suggestions=[
                VerifiedQuerySuggestionModel._from_model(x)
                for x in model.vq_suggestions
            ] if model.vq_suggestions is not None else None,
            warnings=[WarningModel._from_model(x) for x in model.warnings]
            if model.warnings is not None else None,
        )

    def to_dict(self):
        """Creates a dictionary of the properties from a GenerateVerifiedQuerySuggestionsResponse.
    ...
    @classmethod
    def from_dict(cls,
                  obj: dict) -> GenerateVerifiedQuerySuggestionsResponseModel:
        """Creates an instance of GenerateVerifiedQuerySuggestionsResponse from a dict.
        ...
        return cls._from_model(
            GenerateVerifiedQuerySuggestionsResponse.from_dict(obj))
