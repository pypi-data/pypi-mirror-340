...
class WarningModel():
    ...
    def _to_model(self):
        return Warning(message=self.message, )

    @classmethod
    def _from_model(cls, model) -> WarningModel:
        return WarningModel(message=model.message, )

    def to_dict(self):
        """Creates a dictionary of the properties from a Warning.
    ...
    def from_dict(cls, obj: dict) -> WarningModel:
        """Creates an instance of Warning from a dict.
