...
class IcebergTableFromAWSGlueCatalog(BaseModel):
    ...
    __properties = [
        "name", "external_volume", "catalog_table_name", "catalog_namespace",
        "replace_invalid_characters", "auto_refresh", "catalog", "comment"
    ]
...
class IcebergTableFromAWSGlueCatalogModel():
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a IcebergTableFromAWSGlueCatalog.
    ...
    def from_dict(cls, obj: dict) -> IcebergTableFromAWSGlueCatalogModel:
        """Creates an instance of IcebergTableFromAWSGlueCatalog from a dict.
