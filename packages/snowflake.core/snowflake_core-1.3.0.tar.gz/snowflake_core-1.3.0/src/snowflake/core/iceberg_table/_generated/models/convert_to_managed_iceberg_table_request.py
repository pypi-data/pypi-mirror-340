...
class ConvertToManagedIcebergTableRequestModel():
    ...
    def to_dict(self):
        """Creates a dictionary of the properties from a ConvertToManagedIcebergTableRequest.
    ...
    def from_dict(cls, obj: dict) -> ConvertToManagedIcebergTableRequestModel:
        """Creates an instance of ConvertToManagedIcebergTableRequest from a dict.
        ...
        return cls._from_model(
            ConvertToManagedIcebergTableRequest.from_dict(obj))
