...
class MessageContentTextObjectModel(MessageContent):
    ...
    def _to_model(self):
        return MessageContentTextObject(text=self.text, )

    @classmethod
    def _from_model(cls, model) -> MessageContentTextObjectModel:
        return MessageContentTextObjectModel(text=model.text, )

    def to_dict(self):
        """Creates a dictionary of the properties from a MessageContentTextObject.
    ...
    def from_dict(cls, obj: dict) -> MessageContentTextObjectModel:
        """Creates an instance of MessageContentTextObject from a dict.
