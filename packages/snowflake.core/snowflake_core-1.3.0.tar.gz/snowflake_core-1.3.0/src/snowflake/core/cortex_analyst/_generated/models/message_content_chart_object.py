...
class MessageContentChartObjectModel(MessageContent):
    ...
    def _to_model(self):
        return MessageContentChartObject(chart_spec=self.chart_spec, )

    @classmethod
    def _from_model(cls, model) -> MessageContentChartObjectModel:
        return MessageContentChartObjectModel(chart_spec=model.chart_spec, )

    def to_dict(self):
        """Creates a dictionary of the properties from a MessageContentChartObject.
    ...
    def from_dict(cls, obj: dict) -> MessageContentChartObjectModel:
        """Creates an instance of MessageContentChartObject from a dict.
