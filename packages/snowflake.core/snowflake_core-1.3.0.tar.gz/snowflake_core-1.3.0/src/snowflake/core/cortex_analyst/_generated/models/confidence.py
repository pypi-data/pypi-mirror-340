...
class Confidence(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Confidence:
        ...
        _obj = Confidence.parse_obj({
            "verified_query_used":
            VerifiedQuery.from_dict(obj.get("verified_query_used"))
            if obj.get("verified_query_used") is not None else None,
        })
...
class ConfidenceModel():
    ...
    def _to_model(self):
        return Confidence(
            verified_query_used=self.verified_query_used._to_model()
            if self.verified_query_used is not None else None, )

    @classmethod
    def _from_model(cls, model) -> ConfidenceModel:
        return ConfidenceModel(
            verified_query_used=VerifiedQueryModel._from_model(
                model.verified_query_used)
            if model.verified_query_used is not None else None, )

    def to_dict(self):
        """Creates a dictionary of the properties from a Confidence.
    ...
    def from_dict(cls, obj: dict) -> ConfidenceModel:
        """Creates an instance of Confidence from a dict.
