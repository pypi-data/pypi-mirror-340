...
class MessageContentDeltaSuggestionsObject(MessageContentDelta):
    ...
    def from_dict(cls, obj: dict) -> MessageContentDeltaSuggestionsObject:
        ...
        _obj = MessageContentDeltaSuggestionsObject.parse_obj({
            ...
            obj.get("index"),
            "suggestions_delta":
            SuggestionDelta.from_dict(obj.get("suggestions_delta"))
            if obj.get("suggestions_delta") is not None else None,
        })
...
class MessageContentDeltaSuggestionsObjectModel(MessageContentDelta):
    ...
    def _to_model(self):
        return MessageContentDeltaSuggestionsObject(
            index=self.index,
            suggestions_delta=self.suggestions_delta._to_model()
            if self.suggestions_delta is not None else None,
        )
    ...
    def _from_model(cls, model) -> MessageContentDeltaSuggestionsObjectModel:
        return MessageContentDeltaSuggestionsObjectModel(
            index=model.index,
            suggestions_delta=SuggestionDeltaModel._from_model(
                model.suggestions_delta)
            if model.suggestions_delta is not None else None,
        )

    def to_dict(self):
        """Creates a dictionary of the properties from a MessageContentDeltaSuggestionsObject.
    ...
    def from_dict(cls, obj: dict) -> MessageContentDeltaSuggestionsObjectModel:
        """Creates an instance of MessageContentDeltaSuggestionsObject from a dict.
        ...
        return cls._from_model(
            MessageContentDeltaSuggestionsObject.from_dict(obj))
