...
class QueryRequest(BaseModel):
    ...
    query : str, optional
        Unstructured text query.  Exactly one of 'query' or 'queries' must be specified.
    queries : ColumnQuery, optional
        A search query expressed as a collection of multiple column-level queries.  Exactly one of 'query' or 'queries' must be specified.
    ...
    queries: Optional[Dict[str, ColumnQuery]] = None
    ...
    __properties = [
        "query", "queries", "columns", "filter", "limit", "scoring_config",
        "experimental"
    ]
    ...
    def to_dict(
        ...
        _field_dict = {}
        if self.queries:
            for _key in self.queries:
                if self.queries[_key]:
                    _field_dict[_key] = self.queries[_key].to_dict()
    ...
    def from_dict(cls, obj: dict) -> QueryRequest:
        ...
        _obj = QueryRequest.parse_obj({
            ...
            dict((_k, ColumnQuery.from_dict(_v))
                 for _k, _v in obj.get("queries").items())
            if obj.get("queries") is not None else None,
            "columns":
            obj.get("columns"),
            "filter":
            obj.get("filter"),
...
class QueryRequestModel():
    ...
    def __init__(
        ...
        queries: Optional[ColumnQuery] = None,
