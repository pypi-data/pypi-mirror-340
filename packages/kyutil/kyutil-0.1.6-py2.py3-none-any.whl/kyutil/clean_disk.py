...
def remove_file(size_percent, time_day_delta, dir_root=BUILD_PATH + "downloaded", logger=log_in):
    # 比对机器
...
def del_dir(dir_one, time_day_delta, white_list, logger=log_in):
...
def remove_dir_if_greater_than_size(dir_list: list, size_percent: float = 0.75, time_day_delta=-10, logger=log_in, white_list=None):
    """
    功能：
