...
from ceonmedia import config as ceonmedia_config
...
from ceonmedia.job_maker import CstockJobGenerator
...
def _get_frames_for_project(ceonmedia_project: CstockProject):
    ...
    def _get_frames_for_task(
        ...
        if app_type.lower() == "hou":
            ...
            #         ceonmedia_project.render_pipeline,
            #         ceon_render_job,
    ...
    all_task_frames = [
        ...
        for render_task in ceonmedia_project.render_pipeline.pipeline_jobs
    ]
    valid_task_frames = [
...
def create_jobs_for_project_input_example_video(
    ceonmedia_project: CstockProject,
    *,
    ...
    for project_input in ceonmedia_project.project_inputs:
    ...
    min_job_frame_length = ceonmedia_config.DEFAULT_FPS * 2
    project_frames = _get_frames_for_project(ceonmedia_project)
