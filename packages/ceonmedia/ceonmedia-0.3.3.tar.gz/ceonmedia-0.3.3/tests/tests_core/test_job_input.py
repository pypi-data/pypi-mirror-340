...
from .dicts import job_input_dicts
...
def test_job_input_dict_serialization() -> None:
...
def test_job_input_instantiation_success_cases():
    ...
    logger.warning(
        "TODO validate that values are appropriate for job_input_type"
    )


def test_job_input_instantiation_fail_cases():
