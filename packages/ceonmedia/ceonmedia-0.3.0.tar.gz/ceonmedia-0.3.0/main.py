...
ceon_render_dev_dir = (
    "/mnt/FileStorage/Dayne/Web/proj_ceonstock/assets/python/ceon_render"
)
...
# from ceonstock import CstockProjInput, CstockRenderTask
# from ceonstock import CstockProject
# from ceonstock.core.project import CstockProjectInfo
from ceonstock.log import formatters, printify

# from ceonstock.filesystem import CstockLocalProject
from ceonstock import json_io
...
def test_io_project():
    ...
    file_to_load = "/mnt/FileStorage/Dayne/Web/proj_ceonstock/assets/python/ceonstock/tests/test_json_io/ceonstock_project.json"
...
def test_io_job():
    ...
    file_to_load = "/mnt/FileStorage/Dayne/Web/proj_ceonstock/assets/python/ceonstock/tests/test_json_io/ceonstock_job.json"
    if not Path(file_to_load).exists():
        raise FileNotFoundError(f"File not found: {file_to_load}")
