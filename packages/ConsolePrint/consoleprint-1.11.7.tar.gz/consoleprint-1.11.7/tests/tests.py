...
prt.animate1("This text is masked with # before reveal", symbol="#", format='blue')
...
prt.star_square(10, symbol="x", align=15, flush="True", format="\033[104m")
...
prt.animate2("Prints letter by letter but masked with # first  ", symbol="#", delay=0.05, format="\033[48;5;150m")
prt.text_box("BOXED IN", symbol="X", padding=True, wall=True, align='center', spread=True, format='\033[48;5;4m')
prt.star_square(15, symbol="%", align=15, flush="True", format="\033[104m")
