...
You can install ChemInformant using pip:

```bash
pip install ChemInformant
```

(Note: Ensure your `pyproject.toml` has the correct package name `ChemInformant` and you eventually publish it to PyPI for this command to work directly. Otherwise, install from source.)

Alternatively, if you have cloned the repository, you can install it in editable mode:
