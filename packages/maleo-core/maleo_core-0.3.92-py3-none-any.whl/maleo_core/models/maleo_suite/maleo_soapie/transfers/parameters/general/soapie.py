...
class MaleoSOAPIESOAPIEGeneralParameters:
    ...
    class Expand(BaseModel):
        expand:list[MaleoSOAPIESOAPIEGeneralParameters.ExpandableFields] = Field([], description="Expanded field(s)")
    ...
    class CreateBody(BaseModel):
        soapie:MaleoSOAPIESOAPIEGeneralTransfers.Base = Field(..., description="SOAPIE's data")

    class Create(Expand, CreateBody): pass

MaleoSOAPIESOAPIEGeneralParameters.Expand.model_rebuild()