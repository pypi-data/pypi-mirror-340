...
class Compra(BaseModel):
    ...
    empresa = models.ForeignKey(Empresa, db_column='Empresa', to_field='empresa', on_delete=models.PROTECT,
...
class Vin(BaseModel, VinMixin):
    ...
    compra = models.ForeignKey(Compra, db_column='CompraID', to_field='id', on_delete=models.PROTECT,
                               related_name='vins', blank=True, null=True)
...
class SerieLote(BaseModel):
    ...
    sucursal = models.ForeignKey(Sucursal, db_column='Sucursal', to_field='sucursal', on_delete=models.PROTECT,
                                 related_name='series_lote')
    models.ForeignKey(Almacen, db_column='Almacen', to_field='almacen', on_delete=models.PROTECT,
                      related_name='series_lote')
...
class VinAccesorio(BaseModel):
    vin = models.ForeignKey(Vin, db_column='VIN', to_field='vin', on_delete=models.PROTECT, related_name='accessories')
    tipo = models.ForeignKey(VinTipoAccesorio, db_column='Tipo', to_field='tipo', on_delete=models.PROTECT,
