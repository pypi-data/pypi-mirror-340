import click
from leftweeks.plot import create_life_plot
from leftweeks.utils import validate_date, process_filename
...
@click.version_option(
    __version__, "-v", "--version", help="Show the version and exit."
)
