...
class Context:
    def __init__(self, version: tuple[int, int] = (1, 1), device_features: DeviceFeatures = 7, preferred_frames_in_flight: int = 2, enable_validation_layer: bool = False, enable_gpu_based_validation: bool = False, enable_synchronization_validation: bool = False) -> None: ...
