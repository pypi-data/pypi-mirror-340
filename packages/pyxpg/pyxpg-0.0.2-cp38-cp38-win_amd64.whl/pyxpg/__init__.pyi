import enum
from typing import Annotated, Callable, Optional, Sequence, Tuple
...
class CommandBuffer(GfxObject):
    ...
    def bind_pipeline_state(self, pipeline: GraphicsPipeline, descriptor_sets: Sequence[DescriptorSet] = [], push_constants: Optional[bytes] = None, vertex_buffers: Sequence[Buffer] = [], index_buffer: Optional[Buffer] = None, viewport: Sequence[int] = [0.0, 0.0, 0.0, 0.0], scissors: Sequence[int] = [0.0, 0.0, 0.0, 0.0]) -> None: ...
...
class Window:
    ...
    def set_callbacks(self, draw: Callable[[], None], mouse_move_event: Optional[Callable[[Tuple[int, int]], None]] = None, mouse_button_event: Optional[Callable[[Tuple[int, int], MouseButton, Action, Modifiers], None]] = None, mouse_scroll_event: Optional[Callable[[Tuple[int, int], Tuple[int, int]], None]] = None, key_event: Optional[Callable[[Key, Action, Modifiers], None]] = None) -> None: ...
