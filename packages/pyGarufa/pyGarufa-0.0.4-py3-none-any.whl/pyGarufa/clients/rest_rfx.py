...
class RestClient:
    ...
    def __init__(self, environment, user, password, active_token=None):
        ...
        if not active_token:
            ...
            self.environment["token"][self.user] = active_token
    ...
    def update_token(self):
        ...
        self.initialized = True
        self.environment["initialized"] = True
        self.environment["token"][self.user] = self.token
