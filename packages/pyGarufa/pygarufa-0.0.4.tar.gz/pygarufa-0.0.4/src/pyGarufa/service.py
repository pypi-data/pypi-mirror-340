...
def get_segments(environment=None):
    ...
    user_id = list(globals.environment_config[environment]["user"].keys())[0] if globals.environment_config[environment]["user"] else None
    response = get_restclient_client(environment, user_id).get_segments()
    return response
