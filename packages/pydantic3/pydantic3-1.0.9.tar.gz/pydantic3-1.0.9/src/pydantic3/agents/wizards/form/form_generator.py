...
class FormGenerator:
    ...
    def __init__(self, data: Dict[str, Any], model_name: str = "openai/gpt-4o-2024-11-20", api_key: Optional[str] = None, language: str = "en"):
        ...
        try:
            self.form_data = DataRequest.model_validate(data)
        except Exception as e:
            self.logger.error(f"Error parsing DataRequest: {str(e)}")
    ...
    async def generate_complete_structure(self) -> CompleteFormStructure:
        ...
        wizard_data = self.form_data.model_dump()
