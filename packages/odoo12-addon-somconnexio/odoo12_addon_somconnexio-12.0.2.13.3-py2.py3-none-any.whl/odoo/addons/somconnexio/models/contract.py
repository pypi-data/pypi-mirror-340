...
class Contract(models.Model):
    ...
    def _get_contract_group_id(self, contract):
        ...
        return (
            self.env["contract.group"].sudo().get_or_create_contract_group_id(contract)
        )
    ...
    def quit_pack_and_update_mobile_tariffs(self):
        ...
        # Change from 2 mobiles pack to non pack mobile product:
            ...
            if company_attr in current_product.attribute_value_ids:
