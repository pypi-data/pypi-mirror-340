...
1.0.3 Support inline image. For example, then you can use ::
    ...
    |test1| plot:: magick palms.jpg -grayscale rec601luma out.jpg

1.0.4 When the output is .gif, print the frames.
1.0.5 When the output is .gif, print the frames in 8 frames in every row by default.
1.0.6 When .gif is given width, then increase it in latexpdf output.
1.0.7 Support new commands: dwebp and others.
