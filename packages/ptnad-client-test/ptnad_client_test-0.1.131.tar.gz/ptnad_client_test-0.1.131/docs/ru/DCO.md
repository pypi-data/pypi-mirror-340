...
Эта команда автоматом допишет подпись и закоммитит.
...
При создании коммитов через веб-интерфейс есть особенность: по умолчанию GitHub не добавляет строку “Signed-off-by:“, которая требуется для соблюдения DCO (Developer Certificate of Origin).
