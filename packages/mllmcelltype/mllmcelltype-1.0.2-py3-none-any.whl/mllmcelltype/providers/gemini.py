        ...
        for attempt in range(max_retries):
            try:
                ...
                if response.status_code != 200:
                    ...
                    write_log(f"ERROR: Gemini API request failed: {error_message.get('error', {}).get('message', 'Unknown error')}")
                ...
                res = content['candidates'][0]['content']['parts'][0]['text'].strip().split('\n')
