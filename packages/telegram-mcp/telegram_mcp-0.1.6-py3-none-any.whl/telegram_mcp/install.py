...
# Define the standard template once
SERVER_TEMPLATE = {
    "command": "uvx",
    # Add -u flag to python for unbuffered stdio
    "args": ["python", "-u", "-m", "telegram_mcp.cli"],  # Run module directly
    "type": "stdio",
...
MCP_CONFIG_DATA = {
    "vscode": {
        ...
        "template": SERVER_TEMPLATE.copy(),  # Use the standard template
    },
    "vscode-insiders": {
