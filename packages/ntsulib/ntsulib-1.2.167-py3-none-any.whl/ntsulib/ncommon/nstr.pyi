class n_str:
    ...
    def split(self, delimiter: str = ..., limit: int = ...) -> list: ...
    def contains(self, s: str) -> bool: ...
    def index_of(self, s: str, start: int = ...) -> int: ...
    def last_index_of(self, s: str, start: int = ...) -> int: ...
    def matches(self, regex: str) -> bool: ...
    def substring(self, begin: int, end: int = ...) -> n_str: ...
