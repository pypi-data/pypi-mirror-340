...
class n_postgresql:
    ...
    def exec_language(self, sql_language: str, params: Incomplete | None = None, fetch: Incomplete | None = None) -> tuple[tuple[Any, ...], ...] | None: ...
    @property
    ...
    def resetPassword(self, new_password: str, username: str | None = None, require_old_password: bool = False, old_password: str | None = None): ...
