...
// '__aenter__'
#define const_str_plain___aenter__ global_constants[94]
// '__aexit__'
#define const_str_plain___aexit__ global_constants[95]
// 'split'
#define const_str_plain_split global_constants[96]
// 'fileno'
