 ...
 */
extern PyObject *modulecode_npostgre(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"npostgre", modulecode_npostgre, 0, 0, NUITKA_TRANSLATED_FLAG
