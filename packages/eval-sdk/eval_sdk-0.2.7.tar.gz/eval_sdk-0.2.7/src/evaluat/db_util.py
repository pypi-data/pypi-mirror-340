...
def get_logsim_task_result_by_dataset_id(task_id, dataset_id):
    sql = "select * from datacenter_logsim_task_result where task_id = %s and dataset_id = %s"
    params = (task_id, dataset_id, )

    dataset_list = query_data_all(sql, params)
    return dataset_list
