...
class Qt3DInput(Shiboken.Object):
    ...
    class QAbstractAxisInput(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def set_source_device(self, sourceDevice: PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice, /) -> None: ...
        def source_device(self, /) -> PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice: ...
    ...
    class QAbstractPhysicalDevice(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def add_axis_setting(self, axisSetting: PySide6.Qt3DInput.Qt3DInput.QAxisSetting, /) -> None: ...
        def axis_count(self, /) -> int: ...
        def axis_identifier(self, name: str, /) -> int: ...
        def axis_names(self, /) -> typing.List[str]: ...
        def axis_settings(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAxisSetting]: ...
        def button_count(self, /) -> int: ...
        def button_identifier(self, name: str, /) -> int: ...
        def button_names(self, /) -> typing.List[str]: ...
        def remove_axis_setting(self, axisSetting: PySide6.Qt3DInput.Qt3DInput.QAxisSetting, /) -> None: ...
    ...
    class QAction(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def add_input(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
        def inputs(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput]: ...
        def is_active(self, /) -> bool: ...
        def remove_input(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
    ...
    class QActionInput(PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, source_device: PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice | None = ..., buttons: collections.abc.Sequence[int] | None = ...) -> None: ...

        def buttons(self, /) -> typing.List[int]: ...
        def set_buttons(self, buttons: collections.abc.Sequence[int], /) -> None: ...
        def set_source_device(self, sourceDevice: PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice, /) -> None: ...
        def source_device(self, /) -> PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice: ...
    ...
    class QAxis(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def add_input(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractAxisInput, /) -> None: ...
        def inputs(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAbstractAxisInput]: ...
        def remove_input(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractAxisInput, /) -> None: ...
    ...
    class QAxisAccumulator(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, source_axis: PySide6.Qt3DInput.Qt3DInput.QAxis | None = ..., source_axis_type: PySide6.Qt3DInput.Qt3DInput.QAxisAccumulator.SourceAxisType | None = ..., scale: float | None = ..., value: float | None = ..., velocity: float | None = ...) -> None: ...

        def scale(self, /) -> float: ...
        def set_scale(self, scale: float, /) -> None: ...
        def set_source_axis(self, sourceAxis: PySide6.Qt3DInput.Qt3DInput.QAxis, /) -> None: ...
        def set_source_axis_type(self, sourceAxisType: PySide6.Qt3DInput.Qt3DInput.QAxisAccumulator.SourceAxisType, /) -> None: ...
        def source_axis(self, /) -> PySide6.Qt3DInput.Qt3DInput.QAxis: ...
        def source_axis_type(self, /) -> PySide6.Qt3DInput.Qt3DInput.QAxisAccumulator.SourceAxisType: ...
        def value(self, /) -> float: ...
    ...
    class QAxisSetting(PySide6.Qt3DCore.Qt3DCore.QNode):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, dead_zone_radius: float | None = ..., axes: collections.abc.Sequence[int] | None = ..., smooth: bool | None = ...) -> None: ...

        def axes(self, /) -> typing.List[int]: ...
        def dead_zone_radius(self, /) -> float: ...
        def is_smooth_enabled(self, /) -> bool: ...
        def set_axes(self, axes: collections.abc.Sequence[int], /) -> None: ...
        def set_dead_zone_radius(self, deadZoneRadius: float, /) -> None: ...
    ...
    class QInputAspect(PySide6.Qt3DCore.Qt3DCore.QAbstractAspect):
        ...
        def available_physical_devices(self, /) -> typing.List[str]: ...
        def create_physical_device(self, name: str, /) -> PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice: ...
    ...
    class QInputChord(PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput):
        ...
        def add_chord(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
        def chords(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput]: ...
        def remove_chord(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
    ...
    class QInputSequence(PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, timeout: int | None = ..., button_interval: int | None = ...) -> None: ...

        def add_sequence(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
        def button_interval(self, /) -> int: ...
        def remove_sequence(self, input: PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput, /) -> None: ...
        def sequences(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAbstractActionInput]: ...
        def set_button_interval(self, buttonInterval: int, /) -> None: ...
        def set_timeout(self, timeout: int, /) -> None: ...
        def timeout(self, /) -> int: ...
    ...
    class QInputSettings(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, event_source: PySide6.QtCore.QObject | None = ...) -> None: ...

        def event_source(self, /) -> PySide6.QtCore.QObject: ...
        def set_event_source(self, eventSource: PySide6.QtCore.QObject, /) -> None: ...

    class QKeyEvent(PySide6.QtCore.QObject):

        @typing.overload
        def __init__(self, type: PySide6.QtCore.QEvent.Type, key: int, modifiers: int, /, text: str = ..., autorep: bool = ..., count: int = ..., *, is_auto_repeat: bool | None = ..., native_scan_code: int | None = ..., accepted: bool | None = ...) -> None: ...
        @typing.overload
        def __init__(self, ke: PySide6.QtGui.QKeyEvent, /, *, key: int | None = ..., text: str | None = ..., modifiers: int | None = ..., is_auto_repeat: bool | None = ..., count: int | None = ..., native_scan_code: int | None = ..., accepted: bool | None = ...) -> None: ...
    ...
    class QKeyboardDevice(PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, active_input: PySide6.Qt3DInput.Qt3DInput.QKeyboardHandler | None = ...) -> None: ...

        def active_input(self, /) -> PySide6.Qt3DInput.Qt3DInput.QKeyboardHandler: ...
        def axis_count(self, /) -> int: ...
        def axis_identifier(self, name: str, /) -> int: ...
        def axis_names(self, /) -> typing.List[str]: ...
        def button_count(self, /) -> int: ...
    ...
    class QKeyboardHandler(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, source_device: PySide6.Qt3DInput.Qt3DInput.QKeyboardDevice | None = ..., focus: bool | None = ...) -> None: ...

        def focus(self, /) -> bool: ...
        def set_focus(self, focus: bool, /) -> None: ...
        def set_source_device(self, keyboardDevice: PySide6.Qt3DInput.Qt3DInput.QKeyboardDevice, /) -> None: ...
        def source_device(self, /) -> PySide6.Qt3DInput.Qt3DInput.QKeyboardDevice: ...
    ...
    class QLogicalDevice(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def add_action(self, action: PySide6.Qt3DInput.Qt3DInput.QAction, /) -> None: ...
        def add_axis(self, axis: PySide6.Qt3DInput.Qt3DInput.QAxis, /) -> None: ...
        def axes(self, /) -> typing.List[PySide6.Qt3DInput.Qt3DInput.QAxis]: ...
        def remove_action(self, action: PySide6.Qt3DInput.Qt3DInput.QAction, /) -> None: ...
        def remove_axis(self, axis: PySide6.Qt3DInput.Qt3DInput.QAxis, /) -> None: ...
    ...
    class QMouseDevice(PySide6.Qt3DInput.Qt3DInput.QAbstractPhysicalDevice):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, sensitivity: float | None = ..., update_axes_continuously: bool | None = ...) -> None: ...
        ...
        def set_update_axes_continuously(self, updateAxesContinuously: bool, /) -> None: ...
        def update_axes_continuously(self, /) -> bool: ...
    ...
    class QMouseEvent(PySide6.QtCore.QObject):
        ...
        def __init__(self, e: PySide6.QtGui.QMouseEvent, /, *, x: int | None = ..., y: int | None = ..., was_held: bool | None = ..., button: PySide6.Qt3DInput.Qt3DInput.QMouseEvent.Buttons | None = ..., buttons: int | None = ..., modifiers: PySide6.Qt3DInput.Qt3DInput.QMouseEvent.Modifiers | None = ..., accepted: bool | None = ...) -> None: ...
    ...
    class QMouseHandler(PySide6.Qt3DCore.Qt3DCore.QComponent):
        ...
        def __init__(self, /, parent: PySide6.Qt3DCore.Qt3DCore.QNode | None = ..., *, source_device: PySide6.Qt3DInput.Qt3DInput.QMouseDevice | None = ..., contains_mouse: bool | None = ...) -> None: ...

        def contains_mouse(self, /) -> bool: ...
        def set_contains_mouse(self, contains: bool, /) -> None: ...
        def set_source_device(self, mouseDevice: PySide6.Qt3DInput.Qt3DInput.QMouseDevice, /) -> None: ...
        def source_device(self, /) -> PySide6.Qt3DInput.Qt3DInput.QMouseDevice: ...
    ...
    class QWheelEvent(PySide6.QtCore.QObject):
        ...
        def __init__(self, e: PySide6.QtGui.QWheelEvent, /, *, x: int | None = ..., y: int | None = ..., angle_delta: PySide6.QtCore.QPoint | None = ..., buttons: int | None = ..., modifiers: PySide6.Qt3DInput.Qt3DInput.QWheelEvent.Modifiers | None = ..., accepted: bool | None = ...) -> None: ...

        def angle_delta(self, /) -> PySide6.QtCore.QPoint: ...
        def buttons(self, /) -> int: ...
        def is_accepted(self, /) -> bool: ...
