...
class QWebSocket(PySide6.QtCore.QObject):
    ...
    def close_code(self, /) -> PySide6.QtWebSockets.QWebSocketProtocol.CloseCode: ...
    def close_reason(self, /) -> str: ...
    def continue_interrupted_handshake(self, /) -> None: ...
    def error(self, /) -> PySide6.QtNetwork.QAbstractSocket.SocketError: ...
    def error_string(self, /) -> str: ...
    def flush(self, /) -> bool: ...
    def handshake_options(self, /) -> PySide6.QtWebSockets.QWebSocketHandshakeOptions: ...
    @typing.overload
    ...
    def mask_generator(self, /) -> PySide6.QtWebSockets.QMaskGenerator: ...
    def max_allowed_incoming_frame_size(self, /) -> int: ...
    def max_allowed_incoming_message_size(self, /) -> int: ...
    @staticmethod
    def max_incoming_frame_size() -> int: ...
    @staticmethod
    def max_incoming_message_size() -> int: ...
    @staticmethod
    def max_outgoing_frame_size() -> int: ...
    @typing.overload
    ...
    def origin(self, /) -> str: ...
    def outgoing_frame_size(self, /) -> int: ...
    ...
    def send_binary_message(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> int: ...
    def send_text_message(self, message: str, /) -> int: ...
    def set_mask_generator(self, maskGenerator: PySide6.QtWebSockets.QMaskGenerator, /) -> None: ...
    def set_max_allowed_incoming_frame_size(self, maxAllowedIncomingFrameSize: int, /) -> None: ...
    def set_max_allowed_incoming_message_size(self, maxAllowedIncomingMessageSize: int, /) -> None: ...
    def set_outgoing_frame_size(self, outgoingFrameSize: int, /) -> None: ...
...
class QWebSocketHandshakeOptions(Shiboken.Object):
    ...
    def set_subprotocols(self, protocols: collections.abc.Sequence[str], /) -> None: ...
...
class QWebSocketServer(PySide6.QtCore.QObject):
    ...
    def error_string(self, /) -> str: ...
    def handle_connection(self, socket: PySide6.QtNetwork.QTcpSocket, /) -> None: ...
    ...
    def next_pending_connection(self, /) -> PySide6.QtWebSockets.QWebSocket: ...
    def pause_accepting(self, /) -> None: ...
    def proxy(self, /) -> PySide6.QtNetwork.QNetworkProxy: ...
    def resume_accepting(self, /) -> None: ...
    def secure_mode(self, /) -> PySide6.QtWebSockets.QWebSocketServer.SslMode: ...
    def server_address(self, /) -> PySide6.QtNetwork.QHostAddress: ...
    def server_name(self, /) -> str: ...
    def server_port(self, /) -> int: ...
    def server_url(self, /) -> PySide6.QtCore.QUrl: ...
    def set_handshake_timeout(self, msec: int, /) -> None: ...
    def set_max_pending_connections(self, numConnections: int, /) -> None: ...
    def set_native_descriptor(self, descriptor: int, /) -> bool: ...
    def set_proxy(self, networkProxy: PySide6.QtNetwork.QNetworkProxy | PySide6.QtNetwork.QNetworkProxy.ProxyType, /) -> None: ...
    def set_server_name(self, serverName: str, /) -> None: ...
    def set_socket_descriptor(self, socketDescriptor: int, /) -> bool: ...
    def set_ssl_configuration(self, sslConfiguration: PySide6.QtNetwork.QSslConfiguration, /) -> None: ...
    def set_supported_subprotocols(self, protocols: collections.abc.Sequence[str], /) -> None: ...
    def socket_descriptor(self, /) -> int: ...
    def ssl_configuration(self, /) -> PySide6.QtNetwork.QSslConfiguration: ...
    def supported_subprotocols(self, /) -> typing.List[str]: ...
    def supported_versions(self, /) -> typing.List[PySide6.QtWebSockets.QWebSocketProtocol.Version]: ...
