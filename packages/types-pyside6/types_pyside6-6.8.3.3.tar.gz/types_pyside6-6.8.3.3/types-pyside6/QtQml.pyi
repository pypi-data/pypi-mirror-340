...
class QJSEngine(PySide6.QtCore.QObject):
    ...
    @uiLanguage.setter
    def uiLanguage(self, language: str, /) -> None: ...
...
class QQmlEngine(PySide6.QtQml.QJSEngine):
    ...
    @offlineStoragePath.setter
    def offlineStoragePath(self, dir: str, /) -> None: ...
...
def qmlRegisterModule(uri: str | bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, /) -> None: ...
def qmlRegisterSingletonInstance(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(url: PySide6.QtCore.QUrl | str, uri: str | bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, qmlName: str | bytes | bytearray | memoryview, /) -> int: ...
@typing.overload
def qmlRegisterType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, /) -> int: ...
@typing.overload
def qmlRegisterType(url: PySide6.QtCore.QUrl | str, uri: str | bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, qmlName: str | bytes | bytearray | memoryview, /) -> int: ...
def qmlRegisterUncreatableMetaObject(staticMetaObject: PySide6.QtCore.QMetaObject, uri: str | bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, qmlName: str | bytes | bytearray | memoryview, reason: str, /) -> int: ...
def qmlRegisterUncreatableType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str | bytes | bytearray | memoryview, message: str | bytes | bytearray | memoryview, /) -> int: ...
def qmlTypeId(uri: str | bytes | bytearray | memoryview, versionMajor: int, versionMinor: int, qmlName: str | bytes | bytearray | memoryview, /) -> int: ...
