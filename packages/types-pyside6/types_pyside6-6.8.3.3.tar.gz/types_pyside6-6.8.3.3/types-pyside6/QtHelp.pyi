...
class QHelpEngineCore(PySide6.QtCore.QObject):
    ...
    @autoSaveFilter.setter
    def autoSaveFilter(self, save: bool, /) -> None: ...
    @property
    def collectionFile(self, /) -> str: ...
    @collectionFile.setter
    def collectionFile(self, fileName: str, /) -> None: ...
    def copyCollectionFile(self, fileName: str, /) -> bool: ...
    @property
    def currentFilter(self, /) -> str: ...
    @currentFilter.setter
    def currentFilter(self, filterName: str, /) -> None: ...
    ...
    @readOnly.setter
    def readOnly(self, enable: bool, /) -> None: ...
