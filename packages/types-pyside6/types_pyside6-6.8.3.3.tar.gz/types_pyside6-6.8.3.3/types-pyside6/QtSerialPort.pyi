...
class QSerialPort(PySide6.QtCore.QIODevice):
    ...
    @property
    def baudRate_(self, /, directions: PySide6.QtSerialPort.QSerialPort.Direction = ...) -> int: ...
    @baudRate_.setter
    def baudRate_(self, baudRate: int, /, directions: PySide6.QtSerialPort.QSerialPort.Direction = ...) -> bool: ...
    @property
    def breakEnabled(self, /) -> bool: ...
    @breakEnabled.setter
    def breakEnabled(self, /, set: bool = ...) -> bool: ...
    ...
    @dataBits.setter
    def dataBits(self, dataBits: PySide6.QtSerialPort.QSerialPort.DataBits, /) -> bool: ...
    @property
    def dataTerminalReady(self, /) -> bool: ...
    @dataTerminalReady.setter
    def dataTerminalReady(self, set: bool, /) -> bool: ...
    @property
    ...
    @flowControl.setter
    def flowControl(self, flowControl: PySide6.QtSerialPort.QSerialPort.FlowControl, /) -> bool: ...
    def flush(self, /) -> bool: ...
    def handle(self, /) -> int: ...
    ...
    @parity.setter
    def parity(self, parity: PySide6.QtSerialPort.QSerialPort.Parity, /) -> bool: ...
    ...
    @property
    def requestToSend(self, /) -> bool: ...
    @requestToSend.setter
    def requestToSend(self, set: bool, /) -> bool: ...
    ...
    @stopBits.setter
    def stopBits(self, stopBits: PySide6.QtSerialPort.QSerialPort.StopBits, /) -> bool: ...
