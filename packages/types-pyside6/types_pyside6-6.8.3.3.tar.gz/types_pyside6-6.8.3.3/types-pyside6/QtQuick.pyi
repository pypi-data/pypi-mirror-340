...
class QQuickFramebufferObject(PySide6.QtQuick.QQuickItem):
    ...
    @mirrorVertically.setter
    def mirrorVertically(self, enable: bool, /) -> None: ...
    def releaseResources(self, /) -> None: ...
    @property
    def textureFollowsItemSize(self, /) -> bool: ...
    @textureFollowsItemSize.setter
    def textureFollowsItemSize(self, follows: bool, /) -> None: ...
...
class QQuickItem(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    @property
    def activeFocus(self, /) -> bool: ...
    @property
    def activeFocusOnTab(self, /) -> bool: ...
    @activeFocusOnTab.setter
    def activeFocusOnTab(self, arg__1: bool, /) -> None: ...
    @property
    def antialiasing(self, /) -> bool: ...
    @antialiasing.setter
    def antialiasing(self, arg__1: bool, /) -> None: ...
    @property
    def baselineOffset(self, /) -> float: ...
    @baselineOffset.setter
    def baselineOffset(self, arg__1: float, /) -> None: ...
    ...
    def clip(self, /) -> bool: ...
    @clip.setter
    def clip(self, arg__1: bool, /) -> None: ...
    def clipRect(self, /) -> PySide6.QtCore.QRectF: ...
    def componentComplete(self, /) -> None: ...
    @property
    def containmentMask(self, /) -> PySide6.QtCore.QObject: ...
    @containmentMask.setter
    def containmentMask(self, mask: PySide6.QtCore.QObject, /) -> None: ...
    ...
    @enabled.setter
    def enabled(self, arg__1: bool, /) -> None: ...
    ...
    def focus(self, /) -> bool: ...
    @typing.overload
    def focus(self, arg__1: bool, /) -> None: ...
    @typing.overload
    def focus(self, focus: bool, reason: PySide6.QtCore.Qt.FocusReason, /) -> None: ...
    ...
    @focusPolicy.setter
    def focusPolicy(self, policy: PySide6.QtCore.Qt.FocusPolicy, /) -> None: ...
    @typing.overload
    ...
    @height.setter
    def height(self, arg__1: float, /) -> None: ...
    ...
    @implicitHeight.setter
    def implicitHeight(self, arg__1: float, /) -> None: ...
    @property
    def implicitWidth(self, /) -> float: ...
    @implicitWidth.setter
    def implicitWidth(self, arg__1: float, /) -> None: ...
    ...
    @opacity.setter
    def opacity(self, arg__1: float, /) -> None: ...
    @property
    def parent(self, /) -> PySide6.QtQuick.QQuickItem: ...
    @parent.setter
    def parent(self, parent: PySide6.QtQuick.QQuickItem, /) -> None: ...
    ...
    @rotation.setter
    def rotation(self, arg__1: float, /) -> None: ...
    @property
    def scale(self, /) -> float: ...
    @scale.setter
    def scale(self, arg__1: float, /) -> None: ...
    ...
    def transformOrigin(self, arg__1: PySide6.QtQuick.QQuickItem.TransformOrigin, /) -> None: ...
    @property
    ...
    @visible.setter
    def visible(self, arg__1: bool, /) -> None: ...
    def wheelEvent(self, event: PySide6.QtGui.QWheelEvent, /) -> None: ...
    @property
    def width(self, /) -> float: ...
    @width.setter
    def width(self, arg__1: float, /) -> None: ...
    def widthValid(self, /) -> bool: ...
    def window(self, /) -> PySide6.QtQuick.QQuickWindow: ...
    @property
    def x(self, /) -> float: ...
    @x.setter
    def x(self, arg__1: float, /) -> None: ...
    @property
    def y(self, /) -> float: ...
    @y.setter
    def y(self, arg__1: float, /) -> None: ...
    @property
    def z(self, /) -> float: ...
    @z.setter
    def z(self, arg__1: float, /) -> None: ...
...
class QQuickPaintedItem(PySide6.QtQuick.QQuickItem):
    ...
    def antialiasing(self, /) -> bool: ...
    @antialiasing.setter
    def antialiasing(self, enable: bool, /) -> None: ...
    def contentsBoundingRect(self, /) -> PySide6.QtCore.QRectF: ...
    @property
    def contentsScale(self, /) -> float: ...
    @contentsScale.setter
    def contentsScale(self, arg__1: float, /) -> None: ...
    @property
    def contentsSize(self, /) -> PySide6.QtCore.QSize: ...
    @contentsSize.setter
    def contentsSize(self, arg__1: PySide6.QtCore.QSize, /) -> None: ...
    @property
    def fillColor(self, /) -> PySide6.QtGui.QColor: ...
    @fillColor.setter
    def fillColor(self, arg__1: PySide6.QtGui.QColor | str | PySide6.QtGui.QRgba64 | typing.Any | PySide6.QtCore.Qt.GlobalColor | int, /) -> None: ...
    def isTextureProvider(self, /) -> bool: ...
    ...
    @renderTarget.setter
    def renderTarget(self, target: PySide6.QtQuick.QQuickPaintedItem.RenderTarget, /) -> None: ...
    ...
    @textureSize.setter
    def textureSize(self, size: PySide6.QtCore.QSize, /) -> None: ...
...
class QQuickRhiItem(PySide6.QtQuick.QQuickItem):
    ...
    def alphaBlending(self, enable: bool, /) -> None: ...
    @property
    def colorBufferFormat(self, /) -> PySide6.QtQuick.QQuickRhiItem.TextureFormat: ...
    @colorBufferFormat.setter
    def colorBufferFormat(self, format: PySide6.QtQuick.QQuickRhiItem.TextureFormat, /) -> None: ...
    ...
    @fixedColorBufferHeight.setter
    def fixedColorBufferHeight(self, height: int, /) -> None: ...
    @property
    def fixedColorBufferWidth(self, /) -> int: ...
    @fixedColorBufferWidth.setter
    def fixedColorBufferWidth(self, width: int, /) -> None: ...
    def geometryChange(self, newGeometry: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, oldGeometry: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, /) -> None: ...
    ...
    @sampleCount.setter
    def sampleCount(self, samples: int, /) -> None: ...
...
class QQuickView(PySide6.QtQuick.QQuickWindow):
    ...
    @resizeMode.setter
    def resizeMode(self, arg__1: PySide6.QtQuick.QQuickView.ResizeMode, /) -> None: ...
    ...
    def source(self, /) -> PySide6.QtCore.QUrl: ...
    @source.setter
    def source(self, arg__1: PySide6.QtCore.QUrl | str, /) -> None: ...
    @property
