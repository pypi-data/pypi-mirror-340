...
class QRemoteObjectHost(PySide6.QtRemoteObjects.QRemoteObjectHostBase):
    ...
    @hostUrl.setter
    def hostUrl(self, hostAddress: PySide6.QtCore.QUrl | str, /, allowedSchemas: PySide6.QtRemoteObjects.QRemoteObjectHostBase.AllowedSchemas = ...) -> bool: ...
    @staticmethod
...
class QRemoteObjectNode(PySide6.QtCore.QObject):
    ...
    def heartbeatInterval(self, interval: int, /) -> None: ...
    ...
    @persistedStore.setter
    def persistedStore(self, persistedStore: PySide6.QtRemoteObjects.QRemoteObjectAbstractPersistedStore, /) -> None: ...
    def registry(self, /) -> PySide6.QtRemoteObjects.QRemoteObjectRegistry: ...
    @property
    def registryUrl(self, /) -> PySide6.QtCore.QUrl: ...
    @registryUrl.setter
    def registryUrl(self, registryAddress: PySide6.QtCore.QUrl | str, /) -> bool: ...
    def setName(self, name: str, /) -> None: ...
...
class QRemoteObjectReplica(PySide6.QtCore.QObject):
    ...
    @node.setter
    def node(self, node: PySide6.QtRemoteObjects.QRemoteObjectNode, /) -> None: ...
