...
class QDnsLookup(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def nameserver(self, protocol: PySide6.QtNetwork.QDnsLookup.Protocol, nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /, port: int | None = ...) -> None: ...
    @typing.overload
    def nameserver(self, nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, /) -> None: ...
    @typing.overload
    def nameserver(self, nameserver: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, port: int, /) -> None: ...
    @property
    def nameserverPort(self, /) -> int: ...
    @nameserverPort.setter
    def nameserverPort(self, port: int, /) -> None: ...
    @property
    def nameserverProtocol(self, /) -> PySide6.QtNetwork.QDnsLookup.Protocol: ...
    @nameserverProtocol.setter
    def nameserverProtocol(self, protocol: PySide6.QtNetwork.QDnsLookup.Protocol, /) -> None: ...
    ...
    @type.setter
    def type(self, arg__1: PySide6.QtNetwork.QDnsLookup.Type, /) -> None: ...
...
class QLocalServer(PySide6.QtCore.QObject):
    ...
    @socketOptions.setter
    def socketOptions(self, options: PySide6.QtNetwork.QLocalServer.SocketOption, /) -> None: ...
...
class QLocalSocket(PySide6.QtCore.QIODevice):
    ...
    @socketOptions.setter
    def socketOptions(self, option: PySide6.QtNetwork.QLocalSocket.SocketOption, /) -> None: ...
