...
class QDBusServiceWatcher(PySide6.QtCore.QObject):
    ...
    @watchMode.setter
    def watchMode(self, mode: PySide6.QtDBus.QDBusServiceWatcher.WatchModeFlag, /) -> None: ...
    @property
    def watchedServices(self, /) -> typing.List[str]: ...
    @watchedServices.setter
    def watchedServices(self, services: collections.abc.Sequence[str], /) -> None: ...
