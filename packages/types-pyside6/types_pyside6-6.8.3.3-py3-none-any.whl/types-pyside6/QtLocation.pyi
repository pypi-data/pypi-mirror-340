...
class QGeoRoute(Shiboken.Object):
    ...
    @path.setter
    def path(self, path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate], /) -> None: ...
...
class QPlaceIcon(Shiboken.Object):
    ...
    @manager.setter
    def manager(self, manager: PySide6.QtLocation.QPlaceManager, /) -> None: ...
    @property
    def parameters(self, /) -> typing.Dict[str, typing.Any]: ...
    @parameters.setter
    def parameters(self, parameters: typing.Dict[str, typing.Any], /) -> None: ...
...
class QPlaceSupplier(Shiboken.Object):
    ...
    def icon(self, /) -> PySide6.QtLocation.QPlaceIcon: ...
    @icon.setter
    def icon(self, icon: PySide6.QtLocation.QPlaceIcon, /) -> None: ...
    def isEmpty(self, /) -> bool: ...
    @property
    def name(self, /) -> str: ...
    @name.setter
    ...
    @supplierId.setter
    def supplierId(self, identifier: str, /) -> None: ...
    def swap(self, other: PySide6.QtLocation.QPlaceSupplier, /) -> None: ...
    @property
    def url(self, /) -> PySide6.QtCore.QUrl: ...
    @url.setter
    def url(self, data: PySide6.QtCore.QUrl | str, /) -> None: ...
...
class QPlaceUser(Shiboken.Object):
    ...
    def userId(self, /) -> str: ...
    @userId.setter
    def userId(self, identifier: str, /) -> None: ...
