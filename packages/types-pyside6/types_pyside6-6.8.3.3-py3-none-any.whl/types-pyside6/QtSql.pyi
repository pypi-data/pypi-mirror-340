...
class QSqlDatabase(Shiboken.Object):
    ...
    @numericalPrecisionPolicy.setter
    def numericalPrecisionPolicy(self, precisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy, /) -> None: ...
    @typing.overload
    def open(self, /) -> bool: ...
    @typing.overload
...
class QSqlField(Shiboken.Object):
    ...
    def __repr__(self, /) -> str: ...
    @property
    def autoValue(self, /) -> bool: ...
    @autoValue.setter
    def autoValue(self, autoVal: bool, /) -> None: ...
    def clear(self, /) -> None: ...
    @property
    def defaultValue(self, /) -> typing.Any: ...
    @defaultValue.setter
    def defaultValue(self, value: typing.Any, /) -> None: ...
    @property
    def generated(self, /) -> bool: ...
    @generated.setter
    def generated(self, gen: bool, /) -> None: ...
    def isNull(self, /) -> bool: ...
    def isValid(self, /) -> bool: ...
    @property
    def length(self, /) -> int: ...
    @length.setter
    def length(self, fieldLength: int, /) -> None: ...
    @property
    def metaType(self, /) -> PySide6.QtCore.QMetaType: ...
    @metaType.setter
    def metaType(self, type: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type, /) -> None: ...
    @property
    def name(self, /) -> str: ...
    @name.setter
    ...
    @requiredStatus.setter
    def requiredStatus(self, status: PySide6.QtSql.QSqlField.RequiredStatus, /) -> None: ...
...
class QSqlIndex(PySide6.QtSql.QSqlRecord):
    ...
    @cursorName.setter
    def cursorName(self, cursorName: str, /) -> None: ...
...
class QSqlQuery(Shiboken.Object):
    ...
    def first(self, /) -> bool: ...
    @property
    def forwardOnly(self, /) -> bool: ...
    @forwardOnly.setter
    def forwardOnly(self, forward: bool, /) -> None: ...
    ...
    def numericalPrecisionPolicy(self, precisionPolicy: PySide6.QtSql.QSql.NumericalPrecisionPolicy, /) -> None: ...
    @property
    def positionalBindingEnabled(self, /) -> bool: ...
    @positionalBindingEnabled.setter
    def positionalBindingEnabled(self, enable: bool, /) -> None: ...
