...
class QScxmlDataModel(PySide6.QtCore.QObject):
    ...
    @stateMachine.setter
    def stateMachine(self, stateMachine: PySide6.QtScxml.QScxmlStateMachine, /) -> None: ...
...
class QScxmlEvent(Shiboken.Object):
    ...
    def delay(self, /) -> int: ...
    @delay.setter
    def delay(self, delayInMiliSecs: int, /) -> None: ...
    @property
    def errorEvent(self, /) -> bool: ...
    @property
    ...
    @eventType.setter
    def eventType(self, type: PySide6.QtScxml.QScxmlEvent.EventType, /) -> None: ...
    @property
    def invokeId(self, /) -> str: ...
    @invokeId.setter
    def invokeId(self, invokeId: str, /) -> None: ...
    @property
    def name(self, /) -> str: ...
    @name.setter
    ...
    @originType.setter
    def originType(self, originType: str, /) -> None: ...
    @property
    def scxmlType(self, /) -> str: ...
    @property
    def sendId(self, /) -> str: ...
    @sendId.setter
    def sendId(self, sendId: str, /) -> None: ...
...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    ...
    @dataModel.setter
    def dataModel(self, model: PySide6.QtScxml.QScxmlDataModel, /) -> None: ...
    @staticmethod
    ...
    def initialValues(self, initialValues: typing.Dict[str, typing.Any], /) -> None: ...
    @property
    ...
    def loader(self, /) -> PySide6.QtScxml.QScxmlCompiler.Loader: ...
    @loader.setter
    def loader(self, loader: PySide6.QtScxml.QScxmlCompiler.Loader, /) -> None: ...
    @property
    def name(self, /) -> str: ...
    @property
    ...
    @tableData.setter
    def tableData(self, tableData: PySide6.QtScxml.QScxmlTableData, /) -> None: ...
