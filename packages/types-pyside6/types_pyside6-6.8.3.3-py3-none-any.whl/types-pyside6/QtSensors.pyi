...
class QAccelerometer(PySide6.QtSensors.QSensor):
    ...
    @accelerationMode.setter
    def accelerationMode(self, accelerationMode: PySide6.QtSensors.QAccelerometer.AccelerationMode, /) -> None: ...
    @property
...
class QMagnetometer(PySide6.QtSensors.QSensor):
    ...
    @returnGeoValues.setter
    def returnGeoValues(self, returnGeoValues: bool, /) -> None: ...
...
class QSensor(PySide6.QtCore.QObject):
    ...
    @property
    def alwaysOn(self, /) -> bool: ...
    @alwaysOn.setter
    def alwaysOn(self, alwaysOn: bool, /) -> None: ...
    @property
    ...
    @axesOrientationMode.setter
    def axesOrientationMode(self, axesOrientationMode: PySide6.QtSensors.QSensor.AxesOrientationMode, /) -> None: ...
    def backend(self, /) -> PySide6.QtSensors.QSensorBackend: ...
    @property
    def bufferSize(self, /) -> int: ...
    @bufferSize.setter
    def bufferSize(self, bufferSize: int, /) -> None: ...
    @property
    def busy(self, /) -> bool: ...
    def connectToBackend(self, /) -> bool: ...
    @property
    def connectedToBackend(self, /) -> bool: ...
    @property
    def currentOrientation(self, /) -> int: ...
    @property
    def dataRate(self, /) -> int: ...
    @dataRate.setter
    def dataRate(self, rate: int, /) -> None: ...
    @staticmethod
    ...
    @identifier.setter
    def identifier(self, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
    ...
    @outputRange.setter
    def outputRange(self, index: int, /) -> None: ...
    @property
    ...
    def skipDuplicates(self, skipDuplicates: bool, /) -> None: ...
    def start(self, /) -> bool: ...
    def stop(self, /) -> None: ...
    @property
    ...
    @userOrientation.setter
    def userOrientation(self, userOrientation: int, /) -> None: ...
...
class QTapSensor(PySide6.QtSensors.QSensor):
    ...
    @returnDoubleTapEvents.setter
    def returnDoubleTapEvents(self, returnDoubleTapEvents: bool, /) -> None: ...
