...
class QQuick3DInstancing(PySide6.QtQuick3D.QQuick3DObject):
    ...
    @depthSortingEnabled.setter
    def depthSortingEnabled(self, enabled: bool, /) -> None: ...
    def getInstanceBuffer(self, /) -> typing.Tuple[bool, str]: ...
    @property
    def hasTransparency(self, /) -> bool: ...
    @hasTransparency.setter
    def hasTransparency(self, hasTransparency: bool, /) -> None: ...
    ...
    @instanceCountOverride.setter
    def instanceCountOverride(self, instanceCountOverride: int, /) -> None: ...
...
class QQuick3DObject(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    def markAllDirty(self, /) -> None: ...
    @property
    def parent(self, /) -> PySide6.QtQuick3D.QQuick3DObject: ...
    @parent.setter
    def parent(self, parentItem: PySide6.QtQuick3D.QQuick3DObject, /) -> None: ...
