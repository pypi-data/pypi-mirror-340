...
class QSvgGenerator(PySide6.QtGui.QPaintDevice):
    ...
    @outputDevice.setter
    def outputDevice(self, outputDevice: PySide6.QtCore.QIODevice, /) -> None: ...
    def paintEngine(self, /) -> PySide6.QtGui.QPaintEngine: ...
    @property
    def resolution(self, /) -> int: ...
    @resolution.setter
    def resolution(self, dpi: int, /) -> None: ...
    @property
    ...
    @property
    def viewBox(self, /) -> PySide6.QtCore.QRectF: ...
    @typing.overload
    def viewBox(self, viewBox: PySide6.QtCore.QRect, /) -> None: ...
    @typing.overload
    def viewBox(self, viewBox: PySide6.QtCore.QRectF | PySide6.QtCore.QRect, /) -> None: ...
...
class QSvgRenderer(PySide6.QtCore.QObject):
    ...
    def animationEnabled(self, enable: bool, /) -> None: ...
    @property
    ...
    @currentFrame.setter
    def currentFrame(self, arg__1: int, /) -> None: ...
    ...
    def framesPerSecond(self, num: int, /) -> None: ...
    ...
    @options.setter
    def options(self, flags: PySide6.QtSvg.QtSvg.Option, /) -> None: ...
    @typing.overload
