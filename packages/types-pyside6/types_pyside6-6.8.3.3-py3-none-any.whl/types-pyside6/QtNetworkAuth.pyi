...
class QAbstractOAuth(PySide6.QtCore.QObject):
    ...
    def authorizationUrl(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
    def callback(self, /) -> str: ...
    @property
    def clientIdentifier(self, /) -> str: ...
    @clientIdentifier.setter
    def clientIdentifier(self, clientIdentifier: str, /) -> None: ...
    @property
    def contentType(self, /) -> PySide6.QtNetworkAuth.QAbstractOAuth.ContentType: ...
    @contentType.setter
    def contentType(self, contentType: PySide6.QtNetworkAuth.QAbstractOAuth.ContentType, /) -> None: ...
...
class QAbstractOAuth2(PySide6.QtNetworkAuth.QAbstractOAuth):
    ...
    @clientIdentifierSharedKey.setter
    def clientIdentifierSharedKey(self, clientIdentifierSharedKey: str, /) -> None: ...
    ...
    @refreshToken.setter
    def refreshToken(self, refreshToken: str, /) -> None: ...
    ...
    @userAgent.setter
    def userAgent(self, userAgent: str, /) -> None: ...
...
class QOAuth2AuthorizationCodeFlow(PySide6.QtNetworkAuth.QAbstractOAuth2):
    ...
    @accessTokenUrl.setter
    def accessTokenUrl(self, accessTokenUrl: PySide6.QtCore.QUrl | str, /) -> None: ...
...
class QOAuthUriSchemeReplyHandler(PySide6.QtNetworkAuth.QOAuthOobReplyHandler):
    ...
    @redirectUrl.setter
    def redirectUrl(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
