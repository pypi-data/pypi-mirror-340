...
class QGeoPath(PySide6.QtPositioning.QGeoShape):
    ...
    @property
    def path(self, /) -> typing.List[typing.Any]: ...
    @path.setter
    def path(self, path: collections.abc.Sequence[typing.Any], /) -> None: ...
    @typing.overload
...
class QGeoPolygon(PySide6.QtPositioning.QGeoShape):
    ...
    @perimeter.setter
    def perimeter(self, path: collections.abc.Sequence[PySide6.QtPositioning.QGeoCoordinate], /) -> None: ...
    @typing.overload
    def removeCoordinate(self, coordinate: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    @typing.overload
    def removeCoordinate(self, index: int, /) -> None: ...
...
class QGeoPositionInfoSource(PySide6.QtCore.QObject):
    ...
    @preferredPositioningMethods.setter
    def preferredPositioningMethods(self, methods: PySide6.QtPositioning.QGeoPositionInfoSource.PositioningMethod, /) -> None: ...
    ...
    def updateInterval(self, msec: int, /) -> None: ...
...
class QGeoRectangle(PySide6.QtPositioning.QGeoShape):
    ...
    @bottomLeft.setter
    def bottomLeft(self, bottomLeft: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    @property
    def bottomRight(self, /) -> PySide6.QtPositioning.QGeoCoordinate: ...
    @bottomRight.setter
    def bottomRight(self, bottomRight: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    @property
    def center(self, /) -> PySide6.QtPositioning.QGeoCoordinate: ...
    @typing.overload
    ...
    @height.setter
    def height(self, degreesHeight: float, /) -> None: ...
    ...
    @topLeft.setter
    def topLeft(self, topLeft: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    @property
    def topRight(self, /) -> PySide6.QtPositioning.QGeoCoordinate: ...
    @topRight.setter
    def topRight(self, topRight: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    def translate(self, degreesLatitude: float, degreesLongitude: float, /) -> None: ...
    ...
    def width(self, /) -> float: ...
    @width.setter
    def width(self, degreesWidth: float, /) -> None: ...
