...
class QBluetoothDeviceDiscoveryAgent(PySide6.QtCore.QObject):
    ...
    def discovered_devices(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothDeviceInfo]: ...
    def error(self, /) -> PySide6.QtBluetooth.QBluetoothDeviceDiscoveryAgent.Error: ...
    def error_string(self, /) -> str: ...
    def is_active(self, /) -> bool: ...
    def low_energy_discovery_timeout(self, /) -> int: ...
    def set_low_energy_discovery_timeout(self, msTimeout: int, /) -> None: ...
    @typing.overload
    def start(self, /) -> None: ...
    @typing.overload
    ...
    def stop(self, /) -> None: ...
    @staticmethod
    def supported_discovery_methods() -> PySide6.QtBluetooth.QBluetoothDeviceDiscoveryAgent.DiscoveryMethod: ...
...
class QBluetoothDeviceInfo(Shiboken.Object):
    ...
    def core_configurations(self, /) -> PySide6.QtBluetooth.QBluetoothDeviceInfo.CoreConfiguration: ...
    def device_uuid(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
    def is_cached(self, /) -> bool: ...
    def is_valid(self, /) -> bool: ...
    def major_device_class(self, /) -> PySide6.QtBluetooth.QBluetoothDeviceInfo.MajorDeviceClass: ...
    @typing.overload
    def manufacturer_data(self, /) -> typing.Dict[int, PySide6.QtCore.QByteArray]: ...
    @typing.overload
    def manufacturer_data(self, manufacturerId: int, /) -> PySide6.QtCore.QByteArray: ...
    def manufacturer_ids(self, /) -> typing.List[int]: ...
    def minor_device_class(self, /) -> int: ...
    def name(self, /) -> str: ...
    def rssi(self, /) -> int: ...
    def service_classes(self, /) -> PySide6.QtBluetooth.QBluetoothDeviceInfo.ServiceClass: ...
    @typing.overload
    def service_data(self, /) -> typing.Dict[PySide6.QtBluetooth.QBluetoothUuid, PySide6.QtCore.QByteArray]: ...
    @typing.overload
    def service_data(self, serviceId: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> PySide6.QtCore.QByteArray: ...
    def service_ids(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def service_uuids(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def set_cached(self, cached: bool, /) -> None: ...
    def set_core_configurations(self, coreConfigs: PySide6.QtBluetooth.QBluetoothDeviceInfo.CoreConfiguration, /) -> None: ...
    def set_device_uuid(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    def set_manufacturer_data(self, manufacturerId: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> bool: ...
    def set_name(self, name: str, /) -> None: ...
    def set_rssi(self, signal: int, /) -> None: ...
    def set_service_data(self, serviceId: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> bool: ...
    def set_service_uuids(self, uuids: collections.abc.Sequence[PySide6.QtBluetooth.QBluetoothUuid], /) -> None: ...
...
class QBluetoothHostInfo(Shiboken.Object):
    ...
    def address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def name(self, /) -> str: ...
    def set_address(self, address: PySide6.QtBluetooth.QBluetoothAddress, /) -> None: ...
    def set_name(self, name: str, /) -> None: ...
...
class QBluetoothLocalDevice(PySide6.QtCore.QObject):
    ...
    def address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    @staticmethod
    def all_devices() -> typing.List[PySide6.QtBluetooth.QBluetoothHostInfo]: ...
    def connected_devices(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothAddress]: ...
    def host_mode(self, /) -> PySide6.QtBluetooth.QBluetoothLocalDevice.HostMode: ...
    def is_valid(self, /) -> bool: ...
    def name(self, /) -> str: ...
    def pairing_status(self, address: PySide6.QtBluetooth.QBluetoothAddress, /) -> PySide6.QtBluetooth.QBluetoothLocalDevice.Pairing: ...
    def power_on(self, /) -> None: ...
    def request_pairing(self, address: PySide6.QtBluetooth.QBluetoothAddress, pairing: PySide6.QtBluetooth.QBluetoothLocalDevice.Pairing, /) -> None: ...
    def set_host_mode(self, mode: PySide6.QtBluetooth.QBluetoothLocalDevice.HostMode, /) -> None: ...
...
class QBluetoothServer(PySide6.QtCore.QObject):
    ...
    def next_pending_connection(self, /) -> PySide6.QtBluetooth.QBluetoothSocket: ...
    def security_flags(self, /) -> PySide6.QtBluetooth.QBluetooth.Security: ...
    def server_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def server_port(self, /) -> int: ...
    def server_type(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol: ...
    def set_max_pending_connections(self, numConnections: int, /) -> None: ...
    def set_security_flags(self, security: PySide6.QtBluetooth.QBluetooth.Security, /) -> None: ...
...
class QBluetoothServiceDiscoveryAgent(PySide6.QtCore.QObject):
    ...
    def clear(self, /) -> None: ...
    def discovered_services(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothServiceInfo]: ...
    def error(self, /) -> PySide6.QtBluetooth.QBluetoothServiceDiscoveryAgent.Error: ...
    def error_string(self, /) -> str: ...
    def is_active(self, /) -> bool: ...
    def remote_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def set_remote_address(self, address: PySide6.QtBluetooth.QBluetoothAddress, /) -> bool: ...
    @typing.overload
    def set_uuid_filter(self, uuids: collections.abc.Sequence[PySide6.QtBluetooth.QBluetoothUuid], /) -> None: ...
    @typing.overload
    def set_uuid_filter(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    def start(self, /, mode: PySide6.QtBluetooth.QBluetoothServiceDiscoveryAgent.DiscoveryMode = ...) -> None: ...
    def stop(self, /) -> None: ...
    def uuid_filter(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
...
class QBluetoothServiceInfo(Shiboken.Object):
    ...
    class Alternative(Shiboken.Object):
        ...
        def clear(self, /) -> None: ...
        def const_data(self, /) -> object: ...
        def const_first(self, /) -> typing.Any: ...
        def const_last(self, /) -> typing.Any: ...
        def count(self, /) -> int: ...
        ...
        @staticmethod
        def from_list(list: collections.abc.Sequence[typing.Any], /) -> typing.List[typing.Any]: ...
        @staticmethod
        def from_vector(vector: collections.abc.Sequence[typing.Any], /) -> typing.List[typing.Any]: ...
        def front(self, /) -> typing.Any: ...
        def insert(self, arg__1: int, arg__2: typing.Any, /) -> None: ...
        def is_empty(self, /) -> bool: ...
        def is_shared_with(self, other: collections.abc.Sequence[typing.Any], /) -> bool: ...
        @typing.overload
        ...
        def remove_all(self, arg__1: typing.Any, /) -> None: ...
        def remove_at(self, i: int, /) -> None: ...
        def remove_first(self, /) -> None: ...
        def remove_last(self, /) -> None: ...
        def remove_one(self, arg__1: typing.Any, /) -> None: ...
        ...
        def take_at(self, i: int, /) -> typing.Any: ...
        def to_list(self, /) -> typing.List[typing.Any]: ...
        def to_vector(self, /) -> typing.List[typing.Any]: ...
    ...
    def is_valid(self, /) -> bool: ...
    def protocol_descriptor(self, protocol: PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Sequence: ...
    def protocol_service_multiplexer(self, /) -> int: ...
    def register_service(self, /, localAdapter: PySide6.QtBluetooth.QBluetoothAddress = ...) -> bool: ...
    def remove_attribute(self, attributeId: int, /) -> None: ...
    def server_channel(self, /) -> int: ...
    def service_availability(self, /) -> int: ...
    def service_class_uuids(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def service_description(self, /) -> str: ...
    def service_name(self, /) -> str: ...
    def service_provider(self, /) -> str: ...
    def service_uuid(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
    @typing.overload
    def set_attribute(self, attributeId: int, value: PySide6.QtBluetooth.QBluetoothServiceInfo.Alternative | collections.abc.Sequence[typing.Any], /) -> None: ...
    @typing.overload
    def set_attribute(self, attributeId: int, value: PySide6.QtBluetooth.QBluetoothServiceInfo.Sequence | collections.abc.Sequence[typing.Any], /) -> None: ...
    @typing.overload
    def set_attribute(self, attributeId: int, value: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    @typing.overload
    def set_attribute(self, attributeId: int, value: typing.Any, /) -> None: ...
    def set_device(self, info: PySide6.QtBluetooth.QBluetoothDeviceInfo, /) -> None: ...
    def set_service_availability(self, availability: int, /) -> None: ...
    def set_service_description(self, description: str, /) -> None: ...
    def set_service_name(self, name: str, /) -> None: ...
    def set_service_provider(self, provider: str, /) -> None: ...
    def set_service_uuid(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    def socket_protocol(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol: ...
...
class QBluetoothSocket(PySide6.QtCore.QIODevice):
    ...
    def close(self, /) -> None: ...
    @typing.overload
    def connect_to_service(self, address: PySide6.QtBluetooth.QBluetoothAddress, uuid: PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, /, mode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...) -> None: ...
    @typing.overload
    def connect_to_service(self, address: PySide6.QtBluetooth.QBluetoothAddress, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /, openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...) -> None: ...
    @typing.overload
    def connect_to_service(self, address: PySide6.QtBluetooth.QBluetoothAddress, port: int, /, openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...) -> None: ...
    @typing.overload
    def connect_to_service(self, service: PySide6.QtBluetooth.QBluetoothServiceInfo, /, openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...) -> None: ...
    def disconnect_from_service(self, /) -> None: ...
    def do_device_discovery(self, service: PySide6.QtBluetooth.QBluetoothServiceInfo, openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag, /) -> None: ...
    def error(self, /) -> PySide6.QtBluetooth.QBluetoothSocket.SocketError: ...
    def error_string(self, /) -> str: ...
    def is_sequential(self, /) -> bool: ...
    def local_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def local_name(self, /) -> str: ...
    def local_port(self, /) -> int: ...
    def peer_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def peer_name(self, /) -> str: ...
    def peer_port(self, /) -> int: ...
    def preferred_security_flags(self, /) -> PySide6.QtBluetooth.QBluetooth.Security: ...
    def read_data(self, maxSize: int, /) -> object: ...
    def set_preferred_security_flags(self, flags: PySide6.QtBluetooth.QBluetooth.Security, /) -> None: ...
    def set_socket_descriptor(self, socketDescriptor: int, socketType: PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol, /, socketState: PySide6.QtBluetooth.QBluetoothSocket.SocketState = ..., openMode: PySide6.QtCore.QIODeviceBase.OpenModeFlag = ...) -> bool: ...
    def set_socket_error(self, error: PySide6.QtBluetooth.QBluetoothSocket.SocketError, /) -> None: ...
    def set_socket_state(self, state: PySide6.QtBluetooth.QBluetoothSocket.SocketState, /) -> None: ...
    def socket_descriptor(self, /) -> int: ...
    def socket_type(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Protocol: ...
...
class QBluetoothUuid(PySide6.QtCore.QUuid):
    ...
    @staticmethod
    def characteristic_to_string(uuid: PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType, /) -> str: ...
    @staticmethod
    def descriptor_to_string(uuid: PySide6.QtBluetooth.QBluetoothUuid.DescriptorType, /) -> str: ...
    def minimum_size(self, /) -> int: ...
    @staticmethod
    def protocol_to_string(uuid: PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid, /) -> str: ...
    @staticmethod
    def service_class_to_string(uuid: PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid, /) -> str: ...
...
class QLowEnergyAdvertisingData(Shiboken.Object):
    ...
    def include_power_level(self, /) -> bool: ...
    @staticmethod
    def invalid_manufacturer_id() -> int: ...
    def local_name(self, /) -> str: ...
    def manufacturer_data(self, /) -> PySide6.QtCore.QByteArray: ...
    def manufacturer_id(self, /) -> int: ...
    def raw_data(self, /) -> PySide6.QtCore.QByteArray: ...
    def services(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def set_discoverability(self, mode: PySide6.QtBluetooth.QLowEnergyAdvertisingData.Discoverability, /) -> None: ...
    def set_include_power_level(self, doInclude: bool, /) -> None: ...
    def set_local_name(self, name: str, /) -> None: ...
    def set_manufacturer_data(self, id: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
    def set_raw_data(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
    def set_services(self, services: collections.abc.Sequence[PySide6.QtBluetooth.QBluetoothUuid], /) -> None: ...
...
class QLowEnergyAdvertisingParameters(Shiboken.Object):
    ...
    def filter_policy(self, /) -> PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.FilterPolicy: ...
    ...
    def set_interval(self, minimum: int, maximum: int, /) -> None: ...
    def set_mode(self, mode: PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.Mode, /) -> None: ...
    def set_white_list(self, whiteList: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.AddressInfo], policy: PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.FilterPolicy, /) -> None: ...
    def swap(self, other: PySide6.QtBluetooth.QLowEnergyAdvertisingParameters, /) -> None: ...
    def white_list(self, /) -> typing.List[PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.AddressInfo]: ...
...
class QLowEnergyCharacteristic(Shiboken.Object):
    ...
    def client_characteristic_configuration(self, /) -> PySide6.QtBluetooth.QLowEnergyDescriptor: ...
...
class QLowEnergyCharacteristicData(Shiboken.Object):
    ...
    def add_descriptor(self, descriptor: PySide6.QtBluetooth.QLowEnergyDescriptorData, /) -> None: ...
    def descriptors(self, /) -> typing.List[PySide6.QtBluetooth.QLowEnergyDescriptorData]: ...
    def is_valid(self, /) -> bool: ...
    def maximum_value_length(self, /) -> int: ...
    def minimum_value_length(self, /) -> int: ...
    def properties(self, /) -> PySide6.QtBluetooth.QLowEnergyCharacteristic.PropertyType: ...
    def read_constraints(self, /) -> PySide6.QtBluetooth.QBluetooth.AttAccessConstraint: ...
    def set_descriptors(self, descriptors: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyDescriptorData], /) -> None: ...
    def set_properties(self, properties: PySide6.QtBluetooth.QLowEnergyCharacteristic.PropertyType, /) -> None: ...
    def set_read_constraints(self, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint, /) -> None: ...
    def set_uuid(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    def set_value(self, value: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
    def set_value_length(self, minimum: int, maximum: int, /) -> None: ...
    def set_write_constraints(self, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint, /) -> None: ...
    def swap(self, other: PySide6.QtBluetooth.QLowEnergyCharacteristicData, /) -> None: ...
    def uuid(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
    def value(self, /) -> PySide6.QtCore.QByteArray: ...
    def write_constraints(self, /) -> PySide6.QtBluetooth.QBluetooth.AttAccessConstraint: ...
...
class QLowEnergyConnectionParameters(Shiboken.Object):
    ...
    def set_interval_range(self, minimum: float, maximum: float, /) -> None: ...
    def set_latency(self, latency: int, /) -> None: ...
    def set_supervision_timeout(self, timeout: int, /) -> None: ...
    def supervision_timeout(self, /) -> int: ...
...
class QLowEnergyController(PySide6.QtCore.QObject):
    ...
    def add_service(self, service: PySide6.QtBluetooth.QLowEnergyServiceData, /, parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyService: ...
    def connect_to_device(self, /) -> None: ...
    @typing.overload
    @staticmethod
    def create_central(remoteDevice: PySide6.QtBluetooth.QBluetoothDeviceInfo, localDevice: PySide6.QtBluetooth.QBluetoothAddress, /, parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyController: ...
    @typing.overload
    @staticmethod
    def create_central(remoteDevice: PySide6.QtBluetooth.QBluetoothDeviceInfo, /, parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyController: ...
    @typing.overload
    @staticmethod
    def create_peripheral(localDevice: PySide6.QtBluetooth.QBluetoothAddress, /, parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyController: ...
    @typing.overload
    @staticmethod
    def create_peripheral(parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyController: ...
    def create_service_object(self, service: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /, parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtBluetooth.QLowEnergyService: ...
    ...
    def local_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def mtu(self, /) -> int: ...
    def read_rssi(self, /) -> None: ...
    def remote_address(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
    def remote_address_type(self, /) -> PySide6.QtBluetooth.QLowEnergyController.RemoteAddressType: ...
    def remote_device_uuid(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
    def remote_name(self, /) -> str: ...
    def request_connection_update(self, parameters: PySide6.QtBluetooth.QLowEnergyConnectionParameters, /) -> None: ...
    def role(self, /) -> PySide6.QtBluetooth.QLowEnergyController.Role: ...
    def services(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def set_remote_address_type(self, type: PySide6.QtBluetooth.QLowEnergyController.RemoteAddressType, /) -> None: ...
    def start_advertising(self, parameters: PySide6.QtBluetooth.QLowEnergyAdvertisingParameters, advertisingData: PySide6.QtBluetooth.QLowEnergyAdvertisingData, /, scanResponseData: PySide6.QtBluetooth.QLowEnergyAdvertisingData = ...) -> None: ...
...
class QLowEnergyDescriptorData(Shiboken.Object):
    ...
    def read_constraints(self, /) -> PySide6.QtBluetooth.QBluetooth.AttAccessConstraint: ...
    def set_read_permissions(self, readable: bool, /, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint = ...) -> None: ...
    def set_uuid(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
    def set_value(self, value: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
    def set_write_permissions(self, writable: bool, /, constraints: PySide6.QtBluetooth.QBluetooth.AttAccessConstraint = ...) -> None: ...
...
class QLowEnergyService(PySide6.QtCore.QObject):
    ...
    def discover_details(self, /, mode: PySide6.QtBluetooth.QLowEnergyService.DiscoveryMode = ...) -> None: ...
    def error(self, /) -> PySide6.QtBluetooth.QLowEnergyService.ServiceError: ...
    def included_services(self, /) -> typing.List[PySide6.QtBluetooth.QBluetoothUuid]: ...
    def read_characteristic(self, characteristic: PySide6.QtBluetooth.QLowEnergyCharacteristic, /) -> None: ...
    def read_descriptor(self, descriptor: PySide6.QtBluetooth.QLowEnergyDescriptor, /) -> None: ...
    def service_name(self, /) -> str: ...
    def service_uuid(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
    ...
    def write_characteristic(self, characteristic: PySide6.QtBluetooth.QLowEnergyCharacteristic, newValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /, mode: PySide6.QtBluetooth.QLowEnergyService.WriteMode = ...) -> None: ...
    def write_descriptor(self, descriptor: PySide6.QtBluetooth.QLowEnergyDescriptor, newValue: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, /) -> None: ...
...
class QLowEnergyServiceData(Shiboken.Object):
    ...
    def add_characteristic(self, characteristic: PySide6.QtBluetooth.QLowEnergyCharacteristicData, /) -> None: ...
    def add_included_service(self, service: PySide6.QtBluetooth.QLowEnergyService, /) -> None: ...
    def characteristics(self, /) -> typing.List[PySide6.QtBluetooth.QLowEnergyCharacteristicData]: ...
    def included_services(self, /) -> typing.List[PySide6.QtBluetooth.QLowEnergyService]: ...
    def is_valid(self, /) -> bool: ...
    def set_characteristics(self, characteristics: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyCharacteristicData], /) -> None: ...
    def set_included_services(self, services: collections.abc.Sequence[PySide6.QtBluetooth.QLowEnergyService], /) -> None: ...
    def set_type(self, type: PySide6.QtBluetooth.QLowEnergyServiceData.ServiceType, /) -> None: ...
    def set_uuid(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, /) -> None: ...
