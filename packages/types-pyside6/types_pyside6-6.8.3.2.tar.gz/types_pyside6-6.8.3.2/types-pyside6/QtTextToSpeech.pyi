...
class QTextToSpeech(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, engine: str, params: typing.Dict[str, typing.Any], /, parent: PySide6.QtCore.QObject | None = ..., *, state: PySide6.QtTextToSpeech.QTextToSpeech.State | None = ..., volume: float | None = ..., rate: float | None = ..., pitch: float | None = ..., locale: PySide6.QtCore.QLocale | None = ..., voice: PySide6.QtTextToSpeech.QVoice | None = ..., engine_capabilities: PySide6.QtTextToSpeech.QTextToSpeech.Capability | None = ...) -> None: ...
    @typing.overload
    ...
    def all_voices(self, locale: PySide6.QtCore.QLocale | PySide6.QtCore.QLocale.Language, /) -> typing.List[PySide6.QtTextToSpeech.QVoice]: ...
    @staticmethod
    def available_engines() -> typing.List[str]: ...
    def available_locales(self, /) -> typing.List[PySide6.QtCore.QLocale]: ...
    def available_voices(self, /) -> typing.List[PySide6.QtTextToSpeech.QVoice]: ...
    def engine(self, /) -> str: ...
    def engine_capabilities(self, /) -> PySide6.QtTextToSpeech.QTextToSpeech.Capability: ...
    def enqueue(self, text: str, /) -> int: ...
    def error_reason(self, /) -> PySide6.QtTextToSpeech.QTextToSpeech.ErrorReason: ...
    ...
    def set_engine(self, engine: str, /, params: typing.Dict[str, typing.Any] = ...) -> bool: ...
    def set_locale(self, locale: PySide6.QtCore.QLocale | PySide6.QtCore.QLocale.Language, /) -> None: ...
    def set_pitch(self, pitch: float, /) -> None: ...
    def set_rate(self, rate: float, /) -> None: ...
    def set_voice(self, voice: PySide6.QtTextToSpeech.QVoice, /) -> None: ...
...
class QTextToSpeechEngine(PySide6.QtCore.QObject):
    ...
    @staticmethod
    def create_voice(name: str, locale: PySide6.QtCore.QLocale | PySide6.QtCore.QLocale.Language, gender: PySide6.QtTextToSpeech.QVoice.Gender, age: PySide6.QtTextToSpeech.QVoice.Age, data: typing.Any, /) -> PySide6.QtTextToSpeech.QVoice: ...
    def error_reason(self, /) -> PySide6.QtTextToSpeech.QTextToSpeech.ErrorReason: ...
    def error_string(self, /) -> str: ...
    def locale(self, /) -> PySide6.QtCore.QLocale: ...
    def pause(self, boundaryHint: PySide6.QtTextToSpeech.QTextToSpeech.BoundaryHint, /) -> None: ...
    ...
    def resume(self, /) -> None: ...
    def say(self, text: str, /) -> None: ...
    def set_locale(self, locale: PySide6.QtCore.QLocale | PySide6.QtCore.QLocale.Language, /) -> bool: ...
    def set_pitch(self, pitch: float, /) -> bool: ...
    def set_rate(self, rate: float, /) -> bool: ...
    def set_voice(self, voice: PySide6.QtTextToSpeech.QVoice, /) -> bool: ...
    ...
    def voice(self, /) -> PySide6.QtTextToSpeech.QVoice: ...
    @staticmethod
    def voice_data(voice: PySide6.QtTextToSpeech.QVoice, /) -> typing.Any: ...
    def volume(self, /) -> float: ...
...
class QVoice(Shiboken.Object):
    ...
    @staticmethod
    def age_name(age: PySide6.QtTextToSpeech.QVoice.Age, /) -> str: ...
    def gender(self, /) -> PySide6.QtTextToSpeech.QVoice.Gender: ...
    @staticmethod
    def gender_name(gender: PySide6.QtTextToSpeech.QVoice.Gender, /) -> str: ...
