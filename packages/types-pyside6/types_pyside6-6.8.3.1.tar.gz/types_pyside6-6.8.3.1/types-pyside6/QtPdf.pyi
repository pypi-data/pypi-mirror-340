...
class QPdfDocument(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject, /, *, page_count: int | None = ..., password: str | None = ..., status: PySide6.QtPdf.QPdfDocument.Status | None = ..., page_model: PySide6.QtCore.QAbstractListModel | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, page_count: int | None = ..., password: str | None = ..., status: PySide6.QtPdf.QPdfDocument.Status | None = ..., page_model: PySide6.QtCore.QAbstractListModel | None = ...) -> None: ...

    def close(self, /) -> None: ...
    def error(self, /) -> PySide6.QtPdf.QPdfDocument.Error: ...
    def get_all_text(self, page: int, /) -> PySide6.QtPdf.QPdfSelection: ...
    def get_selection(self, page: int, start: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, end: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /) -> PySide6.QtPdf.QPdfSelection: ...
    def get_selection_at_index(self, page: int, startIndex: int, maxLength: int, /) -> PySide6.QtPdf.QPdfSelection: ...
    @typing.overload
    def load(self, device: PySide6.QtCore.QIODevice, /) -> None: ...
    @typing.overload
    def load(self, fileName: str, /) -> PySide6.QtPdf.QPdfDocument.Error: ...
    def meta_data(self, field: PySide6.QtPdf.QPdfDocument.MetaDataField, /) -> typing.Any: ...
    def page_count(self, /) -> int: ...
    def page_index_for_label(self, label: str, /) -> int: ...
    def page_label(self, page: int, /) -> str: ...
    def page_model(self, /) -> PySide6.QtCore.QAbstractListModel: ...
    def page_point_size(self, page: int, /) -> PySide6.QtCore.QSizeF: ...
...
class QPdfDocumentRenderOptions(Shiboken.Object):
    ...
    def render_flags(self, /) -> PySide6.QtPdf.QPdfDocumentRenderOptions.RenderFlag: ...
    def rotation(self, /) -> PySide6.QtPdf.QPdfDocumentRenderOptions.Rotation: ...
    def scaled_clip_rect(self, /) -> PySide6.QtCore.QRect: ...
    def scaled_size(self, /) -> PySide6.QtCore.QSize: ...
    def set_render_flags(self, r: PySide6.QtPdf.QPdfDocumentRenderOptions.RenderFlag, /) -> None: ...
    def set_rotation(self, r: PySide6.QtPdf.QPdfDocumentRenderOptions.Rotation, /) -> None: ...
    def set_scaled_clip_rect(self, r: PySide6.QtCore.QRect, /) -> None: ...
    def set_scaled_size(self, s: PySide6.QtCore.QSize, /) -> None: ...


class QPdfLink(Shiboken.Object):

    @typing.overload
    def __init__(self, other: PySide6.QtPdf.QPdfLink, /, *, valid: bool | None = ..., page: int | None = ..., location: PySide6.QtCore.QPointF | None = ..., zoom: float | None = ..., url: PySide6.QtCore.QUrl | None = ..., context_before: str | None = ..., context_after: str | None = ..., rectangles: collections.abc.Sequence[PySide6.QtCore.QRectF] | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, valid: bool | None = ..., page: int | None = ..., location: PySide6.QtCore.QPointF | None = ..., zoom: float | None = ..., url: PySide6.QtCore.QUrl | None = ..., context_before: str | None = ..., context_after: str | None = ..., rectangles: collections.abc.Sequence[PySide6.QtCore.QRectF] | None = ...) -> None: ...

    def __copy__(self, /) -> typing.Self: ...
    def __repr__(self, /) -> str: ...
    def context_after(self, /) -> str: ...
    def context_before(self, /) -> str: ...
    def copy_to_clipboard(self, /, mode: PySide6.QtGui.QClipboard.Mode = ...) -> None: ...
...
class QPdfLinkModel(PySide6.QtCore.QAbstractListModel):
    ...
    def data(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, role: int, /) -> typing.Any: ...
    def document(self, /) -> PySide6.QtPdf.QPdfDocument: ...
    def link_at(self, point: PySide6.QtCore.QPointF | PySide6.QtCore.QPoint | PySide6.QtGui.QPainterPath.Element, /) -> PySide6.QtPdf.QPdfLink: ...
    def page(self, /) -> int: ...
    def role_names(self, /) -> typing.Dict[int, PySide6.QtCore.QByteArray]: ...
    def row_count(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> int: ...
    def set_document(self, document: PySide6.QtPdf.QPdfDocument, /) -> None: ...
...
class QPdfPageNavigator(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject, /, *, current_page: int | None = ..., current_location: PySide6.QtCore.QPointF | None = ..., current_zoom: float | None = ..., back_available: bool | None = ..., forward_available: bool | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, current_page: int | None = ..., current_location: PySide6.QtCore.QPointF | None = ..., current_zoom: float | None = ..., back_available: bool | None = ..., forward_available: bool | None = ...) -> None: ...

    def back(self, /) -> None: ...
    def back_available(self, /) -> bool: ...
    def clear(self, /) -> None: ...
    def current_link(self, /) -> PySide6.QtPdf.QPdfLink: ...
    def current_location(self, /) -> PySide6.QtCore.QPointF: ...
...
class QPdfPageRenderer(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject, /, *, document: PySide6.QtPdf.QPdfDocument | None = ..., render_mode: PySide6.QtPdf.QPdfPageRenderer.RenderMode | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, document: PySide6.QtPdf.QPdfDocument | None = ..., render_mode: PySide6.QtPdf.QPdfPageRenderer.RenderMode | None = ...) -> None: ...

    def document(self, /) -> PySide6.QtPdf.QPdfDocument: ...
    def render_mode(self, /) -> PySide6.QtPdf.QPdfPageRenderer.RenderMode: ...
    def request_page(self, pageNumber: int, imageSize: PySide6.QtCore.QSize, /, options: PySide6.QtPdf.QPdfDocumentRenderOptions = ...) -> int: ...
    def set_document(self, document: PySide6.QtPdf.QPdfDocument, /) -> None: ...
    def set_render_mode(self, mode: PySide6.QtPdf.QPdfPageRenderer.RenderMode, /) -> None: ...
...
class QPdfSearchModel(PySide6.QtCore.QAbstractListModel):
    ...
    @typing.overload
    def __init__(self, parent: PySide6.QtCore.QObject, /, *, document: PySide6.QtPdf.QPdfDocument | None = ..., search_string: str | None = ..., count: int | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, *, document: PySide6.QtPdf.QPdfDocument | None = ..., search_string: str | None = ..., count: int | None = ...) -> None: ...

    def count(self, /) -> int: ...
    def data(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, role: int, /) -> typing.Any: ...
    def document(self, /) -> PySide6.QtPdf.QPdfDocument: ...
    def result_at_index(self, index: int, /) -> PySide6.QtPdf.QPdfLink: ...
    def results_on_page(self, page: int, /) -> typing.List[PySide6.QtPdf.QPdfLink]: ...
    def role_names(self, /) -> typing.Dict[int, PySide6.QtCore.QByteArray]: ...
    def row_count(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> int: ...
    def search_string(self, /) -> str: ...
    def set_document(self, document: PySide6.QtPdf.QPdfDocument, /) -> None: ...
    def set_search_string(self, searchString: str, /) -> None: ...
...
class QPdfSelection(Shiboken.Object):
    ...
    def __init__(self, other: PySide6.QtPdf.QPdfSelection, /, *, valid: bool | None = ..., bounds: collections.abc.Sequence[PySide6.QtGui.QPolygonF] | None = ..., bounding_rectangle: PySide6.QtCore.QRectF | None = ..., text: str | None = ..., start_index: int | None = ..., end_index: int | None = ...) -> None: ...

    def bounding_rectangle(self, /) -> PySide6.QtCore.QRectF: ...
