...
class XLMAParams:
    ...
    def __init__(self,
        ...
        Parameters:
            ...
            cartopy_path (str): The path to cartopy (boundaries)
        ...
        self.cartopy_path = cartopy_path
...
def create_strike_image(xlma_params: XLMAParams,
    ...
    if xlma_params.cartopy_path:
        states = gpd.read_file(xlma_params.cartopy_path)
        us_states = states[states['iso_a2'] == 'US']
        us_states.boundary.plot(ax=ax3, edgecolor=marker_color, linewidth=1, zorder=2, alpha=0.2)
