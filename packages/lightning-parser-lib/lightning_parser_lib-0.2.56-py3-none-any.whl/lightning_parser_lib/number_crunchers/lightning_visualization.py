...
def create_strike_image(xlma_params: XLMAParams,
    ...
    if xlma_params.cartopy_paths:
        for path in xlma_params.cartopy_paths:
            ...
            counties_in_box.boundary.plot(ax=ax3, edgecolor=marker_color, linewidth=xlma_params.county_line_width, zorder=2, alpha=xlma_params.county_line_alpha, extent=extent)
