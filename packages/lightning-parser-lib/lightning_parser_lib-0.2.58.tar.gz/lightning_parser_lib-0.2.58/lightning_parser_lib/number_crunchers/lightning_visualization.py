...
def create_strike_image(xlma_params: XLMAParams,
    ...
    if xlma_params.time_as_datetime:
        ...
        range_params.time_unit_datetime_range = range_params.time_unit_datetime_range or range_bufferize(pd.to_datetime(range_params.time_unit_range, unit='s', utc=True).to_list(), xlma_params.buffer_extension)
