    ...
    if xlma_params.cartopy_paths:
        for path in xlma_params.cartopy_paths:
            ...
            for idx, row in counties_in_box.iterrows():
                ...
                ax3.text(centroid.x, centroid.y, row['NAME'], ha='center', color=xlma_params.county_text_color, fontsize=xlma_params.county_text_font_size, alpha=county_text_alpha)
