...
```python
from bestmcp.core.network import AgentNetworkServer
...
```python
from bestmcp.core.agent import Agent
...
Visit our project website at [https://bestmcp.org](https://bestmcp.org) for more information, documentation, and resources.

## Overview

BestMCP provides an engine for running a network with a set of protocols. The framework is designed to be modular, allowing developers to:
...
BestMCP includes several built-in protocols:
...
We welcome contributions to the BestMCP framework! Whether you want to fix bugs, add new features, or create new protocols, your help is appreciated.
...
pytest --cov=src/bestmcp --cov-report=xml
```
...
[![Python Tests](https://github.com/bestmcp/bestmcp/actions/workflows/pytest.yml/badge.svg)](https://github.com/bestmcp/bestmcp/actions/workflows/pytest.yml)

### Test Coverage

[![codecov](https://codecov.io/gh/bestmcp/bestmcp/branch/main/graph/badge.svg)](https://codecov.io/gh/bestmcp/bestmcp)
...
git clone https://github.com/bestmcp/bestmcp.git
cd bestmcp
...
BestMCP provides a command-line interface for basic operations:

```bash
# Launch a network with a configuration file
bestmcp network launch config.json --runtime 3600

# Get help on available commands
bestmcp --help

# Set logging level
bestmcp --log-level DEBUG network launch config.json
```
