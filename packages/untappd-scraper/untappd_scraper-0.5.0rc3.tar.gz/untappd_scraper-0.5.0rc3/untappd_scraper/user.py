...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from untappd_scraper.constants import NumReSorts
...
class User:
    ...
    def beer_history_more(
        self, *, brewery_id: int | None = None, max_resorts: NumReSorts = 0
        ...
        return load_user_beer_history_more(
            self.user_id, brewery_id=brewery_id, max_resort=max_resorts
        )
