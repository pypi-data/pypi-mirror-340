...
def load_user_beer_history_more(
    user_id: str, *, brewery_id: int | None = None
    ...
    Returns:
        Collection[WebUserHistoryBeer]: filtered uniques
    """
    params = {"brewery_id": brewery_id} if brewery_id else None

    url = url_of(user_id, page="beers", query=params)
    ...
    return [history_details_more(beer_item) for beer_item in beer_items]
