...
_ModelComponent = Union[Cone, Var, PsdVar, Constraint, NlConstraint,
...
class NlConstrArray:
    def __init__(
        self,
        constrs: Optional[Union[NlConstraint,
                                Iterable[NlConstraint], Mapping[Any, NlConstraint]]] = None
    ) -> None: ...

    def __getitem__(self, idx: int) -> NlConstraint: ...
    def __iter__(self) -> NlConstrArray: ...
    def __next__(self) -> NlConstraint: ...
    def pushBack(self, qconstrs: Union[NlConstraint,
                                       Iterable[NlConstraint], Mapping[Any, NlConstraint]]) -> None: ...
...
class NlConstrBuilderArray:
    def __init__(
        self,
        constrs: Optional[Union[NlConstrBuilder,
                                Iterable[NlConstrBuilder], Mapping[Any, NlConstrBuilder]]] = None
    ) -> None: ...

    def __getitem__(self, idx: int) -> NlConstrBuilder: ...
    def __iter__(self) -> NlConstrBuilderArray: ...
    def __next__(self) -> NlConstrBuilder: ...
    def pushBack(self, qconstrbuilder: Union[NlConstrBuilder,
                                             Iterable[NlConstrBuilder], Mapping[Any, NlConstrBuilder]]) -> None: ...
...
class Model:
    ...
    @overload
    def addNlConstr(self, lhs: Union[bool, ConstrBuilder], name: str = "") -> Constraint: ...
    ...
    def addNlConstrs(
        self,
        generator: Iterable[NlConstrBuilder],
        nameprefix: str = "NR"
    ...
    @overload
    def addNlConstrs(self, generator: Union[int, ConstrBuilder], nameprefix: str = "NR") -> Constraint: ...

    @overload
    def addNlConstrs(self, generator: QConstrBuilder, name: str = "NR") -> QConstraint: ...

    @overload
    def addNlConstrs(self, generator: NlConstrBuilder, name: str = "NR") -> NlConstraint: ...
    ...
    def setObjective(
        self,
        expr: Union[_NlExprLike, PsdExpr],
        sense: int = None
    ) -> None: ...
    ...
    def getNlConstrBuilders(
        self,
        qconstrs: Optional[Union[NlConstrArray, Sequence[NlConstraint]]] = None
    ) -> NlConstrBuilderArray: ...

    @overload
    def getNlConstrBuilders(
        self,
        qconstrs: Mapping[_T, NlConstraint]
    ...
    def getInfo(
        self,
        infoname: str,
        args: Iterable[Union[Var, Constraint, NlConstraint, PsdConstraint, QConstraint]]
    ) -> List[float]: ...
    ...
    def getInfo(
        self,
        infoname: str,
        args: Mapping[_T, Union[Var, Constraint, NlConstraint, PsdConstraint, QConstraint]]
    ) -> tupledict[_T, float]: ...
    ...
    def setNames(
        self,
        args: Union[Var, PsdVar, Constraint, GenConstr, NlConstraint, QConstraint, PsdConstraint, LmiConstraint],
        names: str
    ) -> None: ...
    ...
    def setNames(
        self,
        args: Iterable[Union[Var, PsdVar, Constraint, GenConstr, NlConstraint, QConstraint, PsdConstraint, LmiConstraint]],
    ...
    def setNames(
        self,
        args: Mapping[_T, Union[Var, PsdVar, Constraint, GenConstr, NlConstraint, QConstraint, PsdConstraint, LmiConstraint]],
    ...
    def setNames(
        self,
        args: Union[VarArray, ConstrArray, GenConstrArray, NlConstrArray, QConstrArray, PsdVarArray, PsdConstrArray, LmiConstrArray],
        names: Union[str, Iterable[str]]
    ) -> None: ...
...
class nl:
    ...
    @overload
    def sum(self, op1: _NlExprLike, op2: _NlExprLike, op3: _NlExprLike, op4: _NlExprLike) -> NlExpr: ...
