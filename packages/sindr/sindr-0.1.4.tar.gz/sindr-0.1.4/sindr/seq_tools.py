...
# %% auto 0
__all__ = ['BioSeq', 'DnaSeq', 'ProteinSeq', 'Fastq', 'Fasta', 'NucleotideFasta', 'ProteinFasta', 'SpadesAssembly', 'translate',
           'uniquify', 'filter_spades_batch']
...
class SpadesAssembly(NucleotideFasta):
