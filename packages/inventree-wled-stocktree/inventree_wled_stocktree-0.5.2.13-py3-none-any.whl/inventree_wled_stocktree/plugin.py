    ...
    def locate_stock_location(self, location_pk):
        ...
        try:
            ...
            if led_nbr >= 0:
                ...
                self._set_led(led_nbr, turn_off_others=False)  # Only turn on this LED, don't turn off others
            ...
            if parent_led_nbr is not None and parent_led_nbr != led_nbr:
                ...
                self._set_led(parent_led_nbr, turn_off_others=True)  # Turn off all LEDs before turning on the parent LED
