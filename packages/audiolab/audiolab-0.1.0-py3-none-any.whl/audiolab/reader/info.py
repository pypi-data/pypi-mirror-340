...
class Info:
    ...
    def __str__(self):
        return template.render(
            ...
            num_cdda_sectors=round(self.num_cdda_sectors, 2),
            size=naturalsize(self.container.size),
            bit_rate=naturalsize(self.bit_rate).rstrip("B"),
