...
from sthg_fastapi_logs.utils.response_utils import get_process_time, get_request_data, get_response_data, \
    logs_set_header
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            if default_config['access']['enable']:
                ...
                access_info['param_input'] = get_request_data(args, kwargs)
                try:
...
def wrapper_func_exec(func, *args, **kwargs):
    if default_config['server']['enable']:
        ...
        try:
            ...
            reData = response if response else '-'
...
def service_log():
    def decorator(func):
        @functools.wraps(func)
        def wrapper(*args, **kwargs):
            return wrapper_func_exec(func, *args, **kwargs)
        return wrapper
    return decorator
