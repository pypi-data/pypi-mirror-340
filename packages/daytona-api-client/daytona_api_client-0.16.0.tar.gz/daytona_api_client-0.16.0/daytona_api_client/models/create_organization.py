...
class CreateOrganization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "totalCpuQuota", "totalMemoryQuota", "totalDiskQuota", "maxCpuPerWorkspace", "maxMemoryPerWorkspace", "maxDiskPerWorkspace", "maxConcurrentWorkspaces", "workspaceQuota", "imageQuota", "maxImageSize", "totalImageSize"]
