...
setup(
    name='glgrpa',
    version='0.0.13',  # Incrementa la versión para publicar nuevamente
    packages=find_packages(where='src'),  # Encuentra los paquetes dentro de 'src'
    package_dir={'': 'src'},  # Define 'src' como el directorio base
    include_package_data=True,  # Asegúrate de incluir todos los archivos necesarios
    install_requires=[
        'selenium',
        'pandas',
        'colorama'
