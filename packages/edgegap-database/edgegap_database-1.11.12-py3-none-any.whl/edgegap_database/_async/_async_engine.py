...
class AsyncDatabaseEngine:
    ...
    class __Engine:
        def __init__(self, configuration: DatabaseConfiguration):
            ...
            self.__write_engine = create_async_engine(
                url=str(self.__configuration.async_uri),
        ...
        def get_engine_write_engine(self) -> AsyncEngine:
            """
    ...
    def __init__(self, configuration: DatabaseConfiguration):
        ...
        if key not in AsyncDatabaseEngine.__mapping__:
            AsyncDatabaseEngine.__mapping__[key] = self.__Engine(configuration)
    ...
    def get_write_engine(self) -> AsyncEngine:
        ...
        Get an engine that can be used for writing to the database. This will be executed in transaction mode.
        """
        instance: AsyncDatabaseEngine.__Engine = AsyncDatabaseEngine.__mapping__.get(self.__key)
