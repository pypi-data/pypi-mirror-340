...
class BaseDocumentContent(BaseModel):
    """
    BaseDocumentContent
    """ # noqa: E501
    document_id: Optional[StrictStr] = None
    content_state: Optional[ContentState] = None
    __properties: ClassVar[List[str]] = ["document_id", "content_state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BaseDocumentContent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BaseDocumentContent from a dict"""
        if obj is None:
            return None
