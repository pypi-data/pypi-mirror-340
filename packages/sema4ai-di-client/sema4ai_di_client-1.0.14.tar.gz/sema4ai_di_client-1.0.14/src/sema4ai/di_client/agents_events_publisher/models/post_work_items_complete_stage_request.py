...
class PostWorkItemsCompleteStageRequest(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SUCCESS', 'FAILURE', 'ERROR', 'VALIDATION_FAILURE']):
            raise ValueError("must be one of enum values ('SUCCESS', 'FAILURE', 'ERROR', 'VALIDATION_FAILURE')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostWorkItemsCompleteStageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostWorkItemsCompleteStageRequest from a dict"""
        if obj is None:
            return None
