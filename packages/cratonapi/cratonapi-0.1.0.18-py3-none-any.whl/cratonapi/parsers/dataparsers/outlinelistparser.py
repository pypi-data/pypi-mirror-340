...
from cratonapi.datacontainers import OutlineInfo, Color
...
def parse(message: bytes) -> np.ndarray:
    ...
    for outline_num in range(outlines_count):
        ...
        outline_name_bytes = message[26 + offset : 26 + offset + outline_name_symbols_count]
        offset += outline_name_symbols_count + 6
        outline_name = outline_name_bytes.decode("cp1251")

        (pen_width, pen_style, pen_color_b, pen_color_g, pen_color_r, pen_color_a, outline_width, outline_style,
         outline_color_b, outline_color_g, outline_color_r, outline_color_a, fill_color_b, fill_color_g, fill_color_r,
         fill_color_a, fill_style, sz) = struct.unpack(
            "<17BH", message[20 + offset : 39 + offset]
        )
        offset += 19
        new_outline = OutlineInfo(outline_id=outline_id,
                                  outline_name=outline_name,
                                  pen_width=pen_width,
                                  pen_style=pen_style,
                                  pen_color=Color(red=pen_color_r,
                                                  green=pen_color_g,
                                                  blue=pen_color_b,
                                                  alpha=pen_color_a),
                                  outline_width=outline_width,
                                  outline_style=outline_style,
                                  outline_color=Color(red=outline_color_r,
                                                      green=outline_color_g,
                                                      blue=outline_color_b,
                                                      alpha=outline_color_a),
                                  fill_style=fill_style,
                                  fill_color=Color(red=fill_color_r,
                                                   green=fill_color_g,
                                                   blue=fill_color_b,
                                                   alpha=fill_color_a))
