...
class Mockbin:
    ...
    def __init__(self):
        """Inicializa uma nova instância de Mockbin."""
        self.models: Dict[str, Dict[str, Any]] = {}
        
    def set_model(self, model_name: str, model_size: int = 100) -> 'Mockbin':
    ...
    def set_columns(self, model_name: str, columns: Dict[str, Type[BaseGenerator]]) -> 'Mockbin':
