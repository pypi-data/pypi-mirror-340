...
if nuke.NUKE_VERSION_MAJOR >= 16:
    ...
    #PySide2 for default Nuke 14-15
...
class SubmissionDialog(ButtonedScrollDialog):
    def __init__(self, submitter, submitting, messages):
        ...
        #     nuke.tprint("Error in SubmissionDialog: {}".format(e))
        # nuke.tprint("INITIALIZED SUCCESSFULLY.")
...
def submit(submitter, submitting):
    ...
    # nuke.tprint("SUBMITTING.... NUKE MAJOR VERSION...")
    # nuke.tprint(nuke.NUKE_VERSION_MAJOR)
    messages = validation.run(submitter)
    # nuke.tprint("NOW RUNNING VALIDATION WITH SUBMITTER.... {}".format(messages))
    # nuke.tprint("about to run submission dialog.....")

    dialog = SubmissionDialog(submitter, submitting, messages)
    # nuke.tprint("Dialog {}".format(dialog))
