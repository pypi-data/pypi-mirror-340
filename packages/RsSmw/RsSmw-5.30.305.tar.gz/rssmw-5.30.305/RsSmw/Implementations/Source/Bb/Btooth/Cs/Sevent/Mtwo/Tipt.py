...
class TiptCls:
	...
	def set(self, tipt: enums.BtoCsTiP2, channelNull=repcap.ChannelNull.Default) -> None:
		...
		Snippet: driver.source.bb.btooth.cs.sevent.mtwo.tipt.set(tipt = enums.BtoCsTiP2.TIP2_10, channelNull = repcap.ChannelNull.Default) \n
	...
	def get(self, channelNull=repcap.ChannelNull.Default) -> enums.BtoCsTiP2:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:CS:[SEVent<CH0>]:MTWO:TIPT \n
		Snippet: value: enums.BtoCsTiP2 = driver.source.bb.btooth.cs.sevent.mtwo.tipt.get(channelNull = repcap.ChannelNull.Default) \n
		Sets the time 'T_IP2' for Mode-2 or Mode-3 CS steps. \n
			:param channelNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Sevent')
