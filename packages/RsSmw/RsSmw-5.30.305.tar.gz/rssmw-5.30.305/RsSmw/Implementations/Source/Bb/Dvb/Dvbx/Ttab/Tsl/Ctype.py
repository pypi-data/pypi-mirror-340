...
class CtypeCls:
	...
	def get(self, channelNull=repcap.ChannelNull.Default) -> enums.DvbS2XcodeTypeTsl:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBX:TTAB:TSL<CH0>:CTYPe \n
		Snippet: value: enums.DvbS2XcodeTypeTsl = driver.source.bb.dvb.dvbx.ttab.tsl.ctype.get(channelNull = repcap.ChannelNull.Default) \n
		...
		response = self._core.io.query_str(f'SOURce<HwInstance>:BB:DVB:DVBX:TTAB:TSL{channelNull_cmd_val}:CTYPe?')
