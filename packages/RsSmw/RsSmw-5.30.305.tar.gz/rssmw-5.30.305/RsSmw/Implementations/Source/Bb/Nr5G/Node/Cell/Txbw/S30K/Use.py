...
class UseCls:
	...
	def set(self, scs_use: bool, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:TXBW:S30K:USE \n
		Snippet: driver.source.bb.nr5G.node.cell.txbw.s30K.use.set(scs_use = False, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CC(CH0)>:TXBW:S30K:USE \n
		Snippet: value: bool = driver.source.bb.nr5G.node.cell.txbw.s30K.use.get(cellNull = repcap.CellNull.Default) \n
		Enables an SCS in the particular cell. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
