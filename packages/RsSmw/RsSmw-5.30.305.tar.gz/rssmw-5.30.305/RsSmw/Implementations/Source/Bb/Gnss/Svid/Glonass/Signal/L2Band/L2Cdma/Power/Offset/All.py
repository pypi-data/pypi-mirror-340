...
class AllCls:
	...
	def set(self, power_offset: float, satelliteSvid=repcap.SatelliteSvid.Default, indexNull=repcap.IndexNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GLONass:SIGNal:L2Band:L2CDma<US0>:POWer:OFFset:ALL \n
		Snippet: driver.source.bb.gnss.svid.glonass.signal.l2Band.l2Cdma.power.offset.all.set(power_offset = 1.0, satelliteSvid = repcap.SatelliteSvid.Default, indexNull = repcap.IndexNull.Default) \n
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:SVID{satelliteSvid_cmd_val}:GLONass:SIGNal:L2Band:L2CDma{indexNull_cmd_val}:POWer:OFFset:ALL {param}')
