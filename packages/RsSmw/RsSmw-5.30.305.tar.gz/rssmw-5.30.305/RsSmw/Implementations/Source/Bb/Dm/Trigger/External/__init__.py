...
class ExternalCls:
	...
	def get_delay(self) -> float:
		...
		Sets the trigger delay in symbols. Maximum trigger delay and trigger inhibit values depend on the installed options. See
		'To set delay and inhibit values'. \n
	...
	def get_inhibit(self) -> int:
		...
		Sets the number of symbols that inhibit a restart of the signal generation. Maximum trigger delay and trigger inhibit
		values depend on the installed options. See 'To set delay and inhibit values'. \n
	...
	def get_tdelay(self) -> float:
		...
		Sets the trigger delay for external triggering. The value affects all external trigger signals. Maximum trigger delay and
		trigger inhibit values depend on the installed options. See 'To set delay and inhibit values'. \n
