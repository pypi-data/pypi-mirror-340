...
class CtypeCls:
	...
	def set(self, ctype: enums.DvbS2XcodeTypeTsl, modCodSet=repcap.ModCodSet.Default) -> None:
		...
		Snippet: driver.source.bb.dvb.dvbs.mtab.set.ctype.set(ctype = enums.DvbS2XcodeTypeTsl.MEDium, modCodSet = repcap.ModCodSet.Default) \n
	...
	def get(self, modCodSet=repcap.ModCodSet.Default) -> enums.DvbS2XcodeTypeTsl:
		"""SCPI: [SOURce<HW>]:BB:DVB:DVBS:MTAB:SET<ST>:CTYPe \n
		Snippet: value: enums.DvbS2XcodeTypeTsl = driver.source.bb.dvb.dvbs.mtab.set.ctype.get(modCodSet = repcap.ModCodSet.Default) \n
		Selects the code type. \n
			:param modCodSet: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Set')
