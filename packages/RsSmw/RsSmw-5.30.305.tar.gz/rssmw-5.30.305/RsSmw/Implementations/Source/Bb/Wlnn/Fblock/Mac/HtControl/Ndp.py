...
class NdpCls:
	...
	def set(self, ndp: str, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:HTControl:NDP \n
		Snippet: driver.source.bb.wlnn.fblock.mac.htControl.ndp.set(ndp = rawAbc, frameBlock = repcap.FrameBlock.Default) \n
		Sets the value of the Null Data Packet (NDP) announcement. 0 = no NDP will follow 1 = NDP will follow \n
			:param ndp: integer
			:param frameBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Fblock')
		"""
		param = Conversions.value_to_str(ndp)
	...
	def get(self, frameBlock=repcap.FrameBlock.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:HTControl:NDP \n
		Snippet: value: str = driver.source.bb.wlnn.fblock.mac.htControl.ndp.get(frameBlock = repcap.FrameBlock.Default) \n
		Sets the value of the Null Data Packet (NDP) announcement. 0 = no NDP will follow 1 = NDP will follow \n
			:param frameBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Fblock')
			:return: ndp: integer"""
		frameBlock_cmd_val = self._cmd_group.get_repcap_cmd_value(frameBlock, repcap.FrameBlock)
