...
class NadCls:
	...
	def set(self, nad: str, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:NAD \n
		Snippet: driver.source.bb.nfc.cblock.nad.set(nad = rawAbc, commandBlock = repcap.CommandBlock.Default) \n
		Determines the value of NAD. \n
			:param nad: integer
			:param commandBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
		"""
		param = Conversions.value_to_str(nad)
	...
	def get(self, commandBlock=repcap.CommandBlock.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:NAD \n
		Snippet: value: str = driver.source.bb.nfc.cblock.nad.get(commandBlock = repcap.CommandBlock.Default) \n
		Determines the value of NAD. \n
			:param commandBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cblock')
			:return: nad: integer"""
		commandBlock_cmd_val = self._cmd_group.get_repcap_cmd_value(commandBlock, repcap.CommandBlock)
