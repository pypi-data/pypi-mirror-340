...
class VreservedCls:
	...
	def set(self, vht_reserved: str, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:VHTControl:VREServed \n
		Snippet: driver.source.bb.wlnn.fblock.mac.vhtControl.vreserved.set(vht_reserved = rawAbc, frameBlock = repcap.FrameBlock.Default) \n
		...
		"""
		param = Conversions.value_to_str(vht_reserved)
	...
	def get(self, frameBlock=repcap.FrameBlock.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:MAC:VHTControl:VREServed \n
		Snippet: value: str = driver.source.bb.wlnn.fblock.mac.vhtControl.vreserved.get(frameBlock = repcap.FrameBlock.Default) \n
		This signal field is currently defined, but not used. It is set to zero by the transmitter and ignored by the receiver. \n
			:param frameBlock: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Fblock')
