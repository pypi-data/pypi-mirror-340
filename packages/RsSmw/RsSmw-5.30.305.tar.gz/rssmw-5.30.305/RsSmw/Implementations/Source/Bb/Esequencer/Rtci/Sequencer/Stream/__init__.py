...
class StreamCls:
	"""Stream commands group definition. 11 total commands, 11 Subgroups, 0 group commands"""
	...
	@property
	def breset(self):
		"""breset commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_breset'):
			from .Breset import BresetCls
			self._breset = BresetCls(self._core, self._cmd_group)
		return self._breset
