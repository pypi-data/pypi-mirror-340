...
class UtcCls:
	...
	def get_ioffset(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:XONA:UTC:IOFFset \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.xona.utc.get_ioffset() \n
		No command help available \n
			:return: integer_offset: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:XONA:UTC:IOFFset?')
		return Conversions.str_to_int(response)

	def get_wnot(self) -> int:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TIME:CONVersion:XONA:UTC:WNOT \n
		Snippet: value: int = driver.source.bb.gnss.time.conversion.xona.utc.get_wnot() \n
		No command help available \n
			:return: wnot: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:XONA:UTC:WNOT?')
		return Conversions.str_to_int(response)
	...
	def set_wnot(self, wnot: int) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:BB:GNSS:TIME:CONVersion:XONA:UTC:WNOT {param}')
