...
class RwindowCls:
	...
	def set(self, rep_window: int, vehicle=repcap.Vehicle.Default) -> None:
		...
		Sets the repetition window. This window defines the distance of repeated obstacles that means contiguous objects. \n
			:param rep_window: integer Range: 1 to 1E6, Unit: m
	...
	def get(self, vehicle=repcap.Vehicle.Default) -> int:
		...
		Sets the repetition window. This window defines the distance of repeated obstacles that means contiguous objects. \n
			:param vehicle: optional repeated capability selector. Default value: Nr1 (settable in the interface 'V')
			:return: rep_window: integer Range: 1 to 1E6, Unit: m"""
		vehicle_cmd_val = self._cmd_group.get_repcap_cmd_value(vehicle, repcap.Vehicle)
