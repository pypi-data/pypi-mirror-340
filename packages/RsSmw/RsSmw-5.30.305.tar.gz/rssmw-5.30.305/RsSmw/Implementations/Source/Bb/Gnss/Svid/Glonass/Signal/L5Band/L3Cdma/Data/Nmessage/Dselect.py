...
class DselectCls:
	...
	def set(self, dselect: str, satelliteSvid=repcap.SatelliteSvid.Default, index=repcap.Index.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.glonass.signal.l5Band.l3Cdma.data.nmessage.dselect.set(dselect = 'abc', satelliteSvid = repcap.SatelliteSvid.Default, index = repcap.Index.Default) \n
