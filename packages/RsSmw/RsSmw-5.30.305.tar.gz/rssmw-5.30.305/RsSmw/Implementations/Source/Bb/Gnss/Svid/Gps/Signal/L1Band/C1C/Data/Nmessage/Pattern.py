...
class PatternCls:
	...
	def set(self, pattern: str, satelliteSvid=repcap.SatelliteSvid.Default) -> None:
		...
		Snippet: driver.source.bb.gnss.svid.gps.signal.l1Band.c1C.data.nmessage.pattern.set(pattern = rawAbc, satelliteSvid = repcap.SatelliteSvid.Default) \n
	...
	def get(self, satelliteSvid=repcap.SatelliteSvid.Default) -> str:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SVID<CH>:GPS:SIGNal:L1Band:C1C:DATA:NMESsage:PATTern \n
		Snippet: value: str = driver.source.bb.gnss.svid.gps.signal.l1Band.c1C.data.nmessage.pattern.get(satelliteSvid = repcap.SatelliteSvid.Default) \n
		No command help available \n
			:param satelliteSvid: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Svid')
