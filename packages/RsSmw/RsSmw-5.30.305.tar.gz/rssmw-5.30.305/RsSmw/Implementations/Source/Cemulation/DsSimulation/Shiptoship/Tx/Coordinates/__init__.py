...
class CoordinatesCls:
	...
	def get_dms(self) -> DmsStruct:
		"""SCPI: [SOURce<HW>]:CEMulation:DSSimulation:SHIPtoship:TX:COORdinates:DMS \n
		...
		"""
		return self._core.io.query_struct('SOURce<HwInstance>:CEMulation:DSSimulation:SHIPtoship:TX:COORdinates:DMS?', self.__class__.DmsStruct())
	...
	def set_dms(self, value: DmsStruct) -> None:
		...
		"""
		self._core.io.write_struct('SOURce<HwInstance>:CEMulation:DSSimulation:SHIPtoship:TX:COORdinates:DMS', value)
