...
class TxCls:
	...
	def get_pattern(self) -> enums.AntMod3DaNtPattern:
		"""SCPI: [SOURce<HW>]:CEMulation:MIMO:ANTenna:TX:PATTern \n
		Snippet: value: enums.AntMod3DaNtPattern = driver.source.cemulation.mimo.antenna.tx.get_pattern() \n
		No command help available \n
			:return: ant_tx_patt_descr: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:MIMO:ANTenna:TX:PATTern?')
	...
	def set_pattern(self, ant_tx_patt_descr: enums.AntMod3DaNtPattern) -> None:
		"""SCPI: [SOURce<HW>]:CEMulation:MIMO:ANTenna:TX:PATTern \n
		Snippet: driver.source.cemulation.mimo.antenna.tx.set_pattern(ant_tx_patt_descr = enums.AntMod3DaNtPattern.DIPole) \n
		No command help available \n
			:param ant_tx_patt_descr: No help available
		"""
		param = Conversions.enum_scalar_to_str(ant_tx_patt_descr, enums.AntMod3DaNtPattern)
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:MIMO:ANTenna:TX:PATTern {param}')
