...
class VehicleCls:
	...
	def get_mode(self) -> enums.FadDssUsrVehMode:
		"""SCPI: [SOURce<HW>]:CEMulation:DSSimulation:USER:RX:VEHicle:MODE \n
		Snippet: value: enums.FadDssUsrVehMode = driver.source.cemulation.dsSimulation.user.rx.vehicle.get_mode() \n
		No command help available \n
			:return: veh_mode: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:DSSimulation:USER:RX:VEHicle:MODE?')
	...
	def set_mode(self, veh_mode: enums.FadDssUsrVehMode) -> None:
		"""SCPI: [SOURce<HW>]:CEMulation:DSSimulation:USER:RX:VEHicle:MODE \n
		Snippet: driver.source.cemulation.dsSimulation.user.rx.vehicle.set_mode(veh_mode = enums.FadDssUsrVehMode.NONE) \n
		No command help available \n
			:param veh_mode: No help available
		"""
		param = Conversions.enum_scalar_to_str(veh_mode, enums.FadDssUsrVehMode)
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:DSSimulation:USER:RX:VEHicle:MODE {param}')
