...
class RxCls:
	...
	def get_pattern(self) -> enums.AntMod3DaNtPattern:
		"""SCPI: [SOURce<HW>]:CEMulation:MIMO:ANTenna:RX:PATTern \n
		Snippet: value: enums.AntMod3DaNtPattern = driver.source.cemulation.mimo.antenna.rx.get_pattern() \n
		No command help available \n
			:return: ant_rx_patt_descr: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:MIMO:ANTenna:RX:PATTern?')
	...
	def set_pattern(self, ant_rx_patt_descr: enums.AntMod3DaNtPattern) -> None:
		"""SCPI: [SOURce<HW>]:CEMulation:MIMO:ANTenna:RX:PATTern \n
		Snippet: driver.source.cemulation.mimo.antenna.rx.set_pattern(ant_rx_patt_descr = enums.AntMod3DaNtPattern.DIPole) \n
		No command help available \n
			:param ant_rx_patt_descr: No help available
		"""
		param = Conversions.enum_scalar_to_str(ant_rx_patt_descr, enums.AntMod3DaNtPattern)
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:MIMO:ANTenna:RX:PATTern {param}')
