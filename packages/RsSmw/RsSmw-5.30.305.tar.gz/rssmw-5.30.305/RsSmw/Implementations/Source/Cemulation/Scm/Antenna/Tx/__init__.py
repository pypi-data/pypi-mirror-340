...
class TxCls:
	...
	def get_pattern(self) -> enums.AntMod3DaNtPattern:
		"""SCPI: [SOURce<HW>]:CEMulation:SCM:ANTenna:TX:PATTern \n
		Snippet: value: enums.AntMod3DaNtPattern = driver.source.cemulation.scm.antenna.tx.get_pattern() \n
		No command help available \n
			:return: pattern: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:SCM:ANTenna:TX:PATTern?')
	...
	def set_pattern(self, pattern: enums.AntMod3DaNtPattern) -> None:
		"""SCPI: [SOURce<HW>]:CEMulation:SCM:ANTenna:TX:PATTern \n
		Snippet: driver.source.cemulation.scm.antenna.tx.set_pattern(pattern = enums.AntMod3DaNtPattern.DIPole) \n
		No command help available \n
			:param pattern: No help available
		"""
		param = Conversions.enum_scalar_to_str(pattern, enums.AntMod3DaNtPattern)
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:SCM:ANTenna:TX:PATTern {param}')

	# noinspection PyTypeChecker
	def get_structure(self) -> enums.AntModStructure:
		"""SCPI: [SOURce<HW>]:CEMulation:SCM:ANTenna:TX:STRucture \n
		Snippet: value: enums.AntModStructure = driver.source.cemulation.scm.antenna.tx.get_structure() \n
		No command help available \n
			:return: antenna_struct: No help available
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:SCM:ANTenna:TX:STRucture?')
	...
	def set_structure(self, antenna_struct: enums.AntModStructure) -> None:
		"""SCPI: [SOURce<HW>]:CEMulation:SCM:ANTenna:TX:STRucture \n
		Snippet: driver.source.cemulation.scm.antenna.tx.set_structure(antenna_struct = enums.AntModStructure.CROSS) \n
		No command help available \n
			:param antenna_struct: No help available
		"""
		param = Conversions.enum_scalar_to_str(antenna_struct, enums.AntModStructure)
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:SCM:ANTenna:TX:STRucture {param}')
