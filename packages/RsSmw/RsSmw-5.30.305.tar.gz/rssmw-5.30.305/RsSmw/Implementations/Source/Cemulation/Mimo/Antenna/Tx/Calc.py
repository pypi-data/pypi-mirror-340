...
class CalcCls:
	...
	def get_mode(self) -> enums.AntModCalcMode:
		"""SCPI: [SOURce<HW>]:CEMulation:MIMO:ANTenna:TX:CALC:MODE \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:CEMulation:MIMO:ANTenna:TX:CALC:MODE?')
	...
	def set_mode(self, ant_mod_calc_rx_mod: enums.AntModCalcMode) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:CEMulation:MIMO:ANTenna:TX:CALC:MODE {param}')
