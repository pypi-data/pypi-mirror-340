...
class RowsCls:
	...
	def get_size(self) -> enums.NumbSystAntenna:
		"""SCPI: [SOURce<HW>]:FSIMulator:MIMO:ANTenna:RX:ROWS:SIZE \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:FSIMulator:MIMO:ANTenna:RX:ROWS:SIZE?')
	...
	def set_size(self, ant_mod_rx_row_size: enums.NumbSystAntenna) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:FSIMulator:MIMO:ANTenna:RX:ROWS:SIZE {param}')
