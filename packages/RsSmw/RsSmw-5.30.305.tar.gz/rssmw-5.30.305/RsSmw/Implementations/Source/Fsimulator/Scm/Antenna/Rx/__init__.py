...
class RxCls:
	...
	def get_pattern(self) -> enums.AntMod3DaNtPattern:
		"""SCPI: [SOURce<HW>]:FSIMulator:SCM:ANTenna:RX:PATTern \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:PATTern?')
	...
	def set_pattern(self, type_of_pattern: enums.AntMod3DaNtPattern) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:PATTern {param}')

	# noinspection PyTypeChecker
	def get_structure(self) -> enums.AntModStructure:
		"""SCPI: [SOURce<HW>]:FSIMulator:SCM:ANTenna:RX:STRucture \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:STRucture?')
	...
	def set_structure(self, antenna_rx_struct: enums.AntModStructure) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:STRucture {param}')
