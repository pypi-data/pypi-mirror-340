...
class CalcCls:
	...
	def get_mode(self) -> enums.AntModCalcGeoMode:
		"""SCPI: [SOURce<HW>]:FSIMulator:SCM:ANTenna:RX:CALC:MODE \n
		...
		"""
		response = self._core.io.query_str('SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:CALC:MODE?')
	...
	def set_mode(self, mode: enums.AntModCalcGeoMode) -> None:
		...
		self._core.io.write(f'SOURce<HwInstance>:FSIMulator:SCM:ANTenna:RX:CALC:MODE {param}')
