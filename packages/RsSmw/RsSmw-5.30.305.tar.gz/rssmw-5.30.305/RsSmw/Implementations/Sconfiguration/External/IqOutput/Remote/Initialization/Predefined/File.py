...
class FileCls:
	...
	def set(self, filename: str, iqConnector=repcap.IqConnector.Default) -> None:
		"""SCPI: SCONfiguration:EXTernal:IQOutput<CH>:REMote:INITialization:PREDefined:FILE \n
		Snippet: driver.sconfiguration.external.iqOutput.remote.initialization.predefined.file.set(filename = 'abc', iqConnector = repcap.IqConnector.Default) \n
		...
		self._core.io.write(f'SCONfiguration:EXTernal:IQOutput{iqConnector_cmd_val}:REMote:INITialization:PREDefined:FILE {param}')
