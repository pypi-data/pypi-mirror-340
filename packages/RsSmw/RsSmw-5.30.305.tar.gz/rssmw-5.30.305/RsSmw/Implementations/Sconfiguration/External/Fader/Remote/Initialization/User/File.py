...
class FileCls:
	...
	def set(self, filename: str, digitalIq=repcap.DigitalIq.Default) -> None:
		"""SCPI: SCONfiguration:EXTernal:FADer<CH>:REMote:INITialization:USER:FILE \n
		Snippet: driver.sconfiguration.external.fader.remote.initialization.user.file.set(filename = 'abc', digitalIq = repcap.DigitalIq.Default) \n
		...
		self._core.io.write(f'SCONfiguration:EXTernal:FADer{digitalIq_cmd_val}:REMote:INITialization:USER:FILE {param}')
