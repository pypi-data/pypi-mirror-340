...
class EditCls:
	...
	def get_alias(self) -> str:
		...
		"""
		response = self._core.io.query_str('SCONfiguration:EXTernal:REMote:EDIT:ALIas?')
	...
	def set_alias(self, symbolic_name: str) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:REMote:EDIT:ALIas {param}')
	...
	def get_hostname(self) -> str:
		...
		"""
		response = self._core.io.query_str('SCONfiguration:EXTernal:REMote:EDIT:HOSTname?')
		return trim_str_response(response)
	...
	def set_hostname(self, hostname_or_ip: str) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:REMote:EDIT:HOSTname {param}')
	...
	def get_iselect(self) -> str:
		...
		"""
		response = self._core.io.query_str('SCONfiguration:EXTernal:REMote:EDIT:ISELect?')
		return trim_str_response(response)
	...
	def set_iselect(self, instrument_name: str) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:REMote:EDIT:ISELect {param}')
	...
	def get_rchannel(self) -> enums.RcConnType:
		...
		"""
		response = self._core.io.query_str('SCONfiguration:EXTernal:REMote:EDIT:RCHannel?')
	...
	def set_rchannel(self, remote_channel: enums.RcConnType) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:REMote:EDIT:RCHannel {param}')
	...
	def get_serial(self) -> int:
		...
		"""
		response = self._core.io.query_str('SCONfiguration:EXTernal:REMote:EDIT:SERial?')
	...
	def set_serial(self, serial_number: int) -> None:
		...
		self._core.io.write(f'SCONfiguration:EXTernal:REMote:EDIT:SERial {param}')
