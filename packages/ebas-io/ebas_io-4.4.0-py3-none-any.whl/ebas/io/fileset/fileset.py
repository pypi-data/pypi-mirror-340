    ...
    def add_di(self, di_obj, intv):
        ...
        for result in self.results:
            ...
            if success:
                ...
                for int_ in rem_intv:
                    # recursively add remaining intervals
                    self.add_di(di_obj, int_)
                return
