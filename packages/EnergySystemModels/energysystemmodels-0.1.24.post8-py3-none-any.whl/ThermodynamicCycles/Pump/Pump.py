...
class Object:
    ...
    def plot_pump_curve(self):
        ...
        ax1.scatter(self.X_F.flatten(), self.Y_hmt.flatten(), color='black', label='Points Hmt (données)', zorder=5)  # Points noirs
        ...
        ax2.scatter(self.X_F.flatten(), (self.Y_eta.flatten() * 100), color='black', label='Points eta (données)', zorder=5)  # Points noirs
