...
class HitTestRequestBodyRetrievalModelBuilder:
    def __init__(self):
    ...
    def set_search_method(
        self,
        search_method: Literal["keyword_search", "semantic_search", "full_text_search", "hybrid_search"],
    ):
    ...
    def reranking_provider_name(self, reranking_provider_name: str):
        self._hit_test_request_body_retrieval_model.reranking_mode["reranking_provider_name"] = reranking_provider_name
        return self

    def reranking_model_name(self, reranking_model_name: str):
        self._hit_test_request_body_retrieval_model.reranking_mode["reranking_model_name"] = reranking_model_name
        return self
    ...
    def score_threshold_enabled(self, score_threshold_enabled: bool):
        self._hit_test_request_body_retrieval_model.score_threshold_enabled = score_threshold_enabled
        return self
