...
class QueueClient:
    ...
    def __init__(self, parent_run_id: str, account_name: str, account_key: str, protocol: str, endpoint: str):
        ...
        self._queue_client = None  # type: Optional[AzureQueueClient]
        self._con_str = (
    ...
    def _receive_message(self, visibility_timeout: int = 30) -> Optional[QueueMessage]:
        """
        ...
        try:
            page = next(pages)
            message = next(page)  # type: QueueMessage
