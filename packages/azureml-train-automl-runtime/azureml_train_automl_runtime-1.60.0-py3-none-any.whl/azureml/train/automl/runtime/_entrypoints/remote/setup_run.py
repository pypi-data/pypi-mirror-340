...
def execute(
    ...
    try:
        ...
        parent_run, automl_settings_obj, cache_store = \
            entrypoint_util.init_wrapper(setup_run, automl_settings, script_directory, load_cache=False)
        ...
        # feature_sweeped_state_container is None if enable_streaming or timeseries or featurization off
        ...
        # prep_type SETUP_ONLY if distributed featurization is disabled, otherwise SETUP_WITHOUT_FEATURIZATION
