...
def estimate_model_folded_normal(model_name, dwi_path, bvals_path, delta_path, small_delta, lowb_noisemap_path, out_path, 
    ...
    # NEXI with Folded Normal Mean correction
    ...
    assert model_name == 'Nexi', "Folded Normal Mean correction is only available for the Nexi model yet."
    microstruct_model = find_model(model_name + 'FoldedNormal')
...
if __name__ == '__main__':
    ...
    estimate_model_folded_normal(model_name=args.model_name, dwi_path=args.dwi_path, bvals_path=args.bvals_path, delta_path=args.delta_path, 
