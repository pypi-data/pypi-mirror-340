...
from caffeinism_utils.asyncio import run_in_threadpool, run_in_threadpool_deco
...
class AsyncContextManagerWrapper:
    ...
    async def __aenter__(self):
        return AsyncObjectWrapper(
            await run_in_threadpool(self._context_manager.__enter__)
        )
