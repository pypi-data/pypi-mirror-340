...
def list() -> None:
    ...
    typer.echo(prepare_agents_prompt(agents))
...
def new(
    ...
    selected_agent = get_template_name(available_agents, name)
    target_directory = get_directory(selected_agent, target)
    ...
    target_directory = download_and_extract_template(selected_agent, target_directory)
    typer.echo(
        typer.style(
