...
DownloadRequest = namedtuple("DownloadRequest", ["url", "dist", "expire", "deny_protocol"])
...
class Downloader:
    ...
    def down_one(self, info: Tuple[str, str, datetime.timedelta, Set[str]]):
        url, dist, expire, deny_protocol = info
        dist_path = Path(dist)
