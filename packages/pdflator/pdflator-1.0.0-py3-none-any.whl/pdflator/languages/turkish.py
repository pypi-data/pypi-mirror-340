...
class Turkish(Language):
    ...
    Turkish is a left-to-right language, so the alignment is set to left by default.
    """
    _language_name = "Turkish"
    _language_code = "tr"
    ...
    def __repr__(self):
        """
        Returns a string representation of the Turkish object.
        :return: A string representation of the Turkish object.
        """
        return self.__str__()
    def __str__(self):
        """
        ...
        :return: A string representation of the Turkish object.
        """
        return f"Turkish(language_code={self.language_code}, alignment={self._alignment})"
