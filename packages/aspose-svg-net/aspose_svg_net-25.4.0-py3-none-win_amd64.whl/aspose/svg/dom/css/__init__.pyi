...
class IPercentResolvingContext:
...
class IResolvedStyleDeclaration:
    '''Represents a resolved style declaration that provides access to various style properties.'''
    
    def fill(self, rendeing_context : aspose.svg.rendering.ISVGDeviceContext) -> aspose.svg.drawing.IBrush:
        '''Gets the brush used for filling shapes.
        
        :param rendeing_context: The rendering context.
        :returns: The brush used for filling shapes.'''
        ...
    
    def stroke(self, rendeing_context : aspose.svg.rendering.ISVGDeviceContext) -> aspose.svg.drawing.IBrush:
        '''Gets the brush used for stroking shapes.
        
        :param rendeing_context: The rendering context.
        :returns: The brush used for stroking shapes.'''
        ...
    
    @property
    def fill_rule(self) -> aspose.svg.drawing.FillRule:
        ...
    
    @property
    def clip_rule(self) -> aspose.svg.drawing.FillRule:
        ...
    
    @property
    def transform(self) -> aspose.svg.drawing.IMatrix:
        '''Gets the transformation matrix.'''
        ...
    
    @property
    def width(self) -> aspose.svg.drawing.Numeric:
        '''Gets the width value.'''
        ...
    
    @property
    def stroke_width(self) -> aspose.svg.drawing.Numeric:
        ...
    
    @property
    def stroke_linejoin(self) -> aspose.svg.drawing.StrokeLineJoin:
        ...
    ...
    @property
    def stroke_linecap(self) -> aspose.svg.drawing.StrokeLineCap:
        ...
    
    @property
    def stroke_dashoffset(self) -> aspose.svg.drawing.Numeric:
        ...
    
    @property
    def stroke_dasharray(self) -> List[float]:
        ...
    
    @property
    def height(self) -> aspose.svg.drawing.Numeric:
        '''Gets the height value.'''
        ...
    
    @property
    def font_size(self) -> aspose.svg.drawing.Numeric:
        ...
    
    @property
    def x(self) -> aspose.svg.drawing.Numeric:
        '''Gets the x-coordinate value.'''
        ...
    
    @property
    def y(self) -> aspose.svg.drawing.Numeric:
        '''Gets the y-coordinate value.'''
        ...
    
    @property
    def cx(self) -> aspose.svg.drawing.Numeric:
        '''Gets the x-coordinate of the center of an ellipse or circle.'''
        ...
    
    @property
    def cy(self) -> aspose.svg.drawing.Numeric:
        '''Gets the y-coordinate of the center of an ellipse or circle.'''
        ...
    
    @property
    def r(self) -> aspose.svg.drawing.Numeric:
        '''Gets the radius of an ellipse or circle.'''
        ...
    
    @property
    def rx(self) -> aspose.svg.drawing.Numeric:
        '''Gets the x-radius of an ellipse or horizontal radius of an ellipse or circle.'''
        ...
    
    @property
    def ry(self) -> aspose.svg.drawing.Numeric:
        '''Gets the y-radius of an ellipse or vertical radius of an ellipse or circle.'''
        ...
    
    @property
    def letter_spacing(self) -> aspose.svg.drawing.Numeric:
        ...
    
    @property
    def word_spacing(self) -> aspose.svg.drawing.Numeric:
        ...
    
    @property
    def visibility(self) -> aspose.svg.dom.css.CSSValue:
        '''Gets the visibility of an element.'''
        ...
    
    @property
    def baseline_shift(self) -> aspose.svg.drawing.Numeric:
        ...
    ...
    @property
    def display(self) -> aspose.svg.dom.css.CSSValue:
        '''Gets the display behavior of an element.'''
        ...
    
    @property
    def marker_start(self) -> aspose.svg.SVGMarkerElement:
        ...
    
    @property
    def marker_mid(self) -> aspose.svg.SVGMarkerElement:
        ...
    
    @property
    def marker_end(self) -> aspose.svg.SVGMarkerElement:
        ...
    
    @property
    def overflow(self) -> aspose.svg.dom.css.CSSValue:
        '''Gets the overflow behavior of an element.'''
        ...
    
    @property
    def paint_order(self) -> aspose.svg.dom.css.CSSValueList:
        ...
    
    @property
    def font_kerning(self) -> aspose.svg.dom.css.CSSValue:
        ...
    
    @property
    def white_space(self) -> aspose.svg.dom.css.CSSValue:
        ...
    
    @property
    def alignment_baseline(self) -> aspose.svg.dom.css.CSSValue:
        ...
