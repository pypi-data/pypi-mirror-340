...
class IBitmap:
    ...
    def rotate_flip(self, rotate_flip_type : aspose.svg.drawing.WebRotateFlipType):
        '''Rotates and flips the bitmap image according to the specified rotation and flip type.
        
        :param rotate_flip_type: The rotation and flip type :py:class:`aspose.svg.drawing.WebRotateFlipType` to apply.'''
        ...
...
class WebRotateFlipType:
    '''Specifies the rotation and flip operation to apply to an image.'''
    
    @classmethod
    @property
    def ROTATE_NONE_FLIP_NONE(cls) -> WebRotateFlipType:
        '''No rotation and no flipping.'''
        ...
    
    @classmethod
    @property
    def ROTATE_90_FLIP_NONE(cls) -> WebRotateFlipType:
        '''Rotate 90 degrees clockwise with no flipping.'''
        ...
    
    @classmethod
    @property
    def ROTATE_180_FLIP_NONE(cls) -> WebRotateFlipType:
        '''Rotate 180 degrees with no flipping.'''
        ...
    
    @classmethod
    @property
    def ROTATE_270_FLIP_NONE(cls) -> WebRotateFlipType:
        '''Rotate 270 degrees clockwise with no flipping.'''
        ...
    
    @classmethod
    @property
    def ROTATE_NONE_FLIP_X(cls) -> WebRotateFlipType:
        '''No rotation with a horizontal flip (flip along the X-axis).'''
        ...
    
    @classmethod
    @property
    def ROTATE_90_FLIP_X(cls) -> WebRotateFlipType:
        '''Rotate 90 degrees clockwise followed by a horizontal flip (flip along the X-axis).'''
        ...
    
    @classmethod
    @property
    def ROTATE_180_FLIP_X(cls) -> WebRotateFlipType:
        '''Rotate 180 degrees followed by a horizontal flip (flip along the X-axis).'''
        ...
    
    @classmethod
    @property
    def ROTATE_270_FLIP_X(cls) -> WebRotateFlipType:
        '''Rotate 270 degrees clockwise followed by a horizontal flip (flip along the X-axis).'''
        ...
    
    @classmethod
    @property
    def ROTATE_NONE_FLIP_Y(cls) -> WebRotateFlipType:
        '''No rotation with a vertical flip (flip along the Y-axis).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_180_FLIP_X`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_90_FLIP_Y(cls) -> WebRotateFlipType:
        '''Rotate 90 degrees clockwise followed by a vertical flip (flip along the Y-axis).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_270_FLIP_X`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_180_FLIP_Y(cls) -> WebRotateFlipType:
        '''Rotate 180 degrees followed by a vertical flip (flip along the Y-axis).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_NONE_FLIP_X`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_270_FLIP_Y(cls) -> WebRotateFlipType:
        '''Rotate 270 degrees clockwise followed by a vertical flip (flip along the Y-axis).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_90_FLIP_X`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_NONE_FLIP_XY(cls) -> WebRotateFlipType:
        '''No rotation with both a horizontal and vertical flip (flip along both axes).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_180_FLIP_NONE`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_90_FLIP_XY(cls) -> WebRotateFlipType:
        '''Rotate 90 degrees clockwise followed by both a horizontal and vertical flip (flip along both axes).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_270_FLIP_NONE`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_180_FLIP_XY(cls) -> WebRotateFlipType:
        '''Rotate 180 degrees followed by both a horizontal and vertical flip (flip along both axes).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_NONE_FLIP_NONE`.'''
        ...
    
    @classmethod
    @property
    def ROTATE_270_FLIP_XY(cls) -> WebRotateFlipType:
        '''Rotate 270 degrees clockwise followed by both a horizontal and vertical flip (flip along both axes).
        This is equivalent to :py:attr:`aspose.svg.drawing.WebRotateFlipType.ROTATE_90_FLIP_NONE`.'''
        ...
