...
with open("/mnt/data/data_structures_documentation.md", "w") as f:
    f.write(documentation)

"/mnt/data/data_structures_documentation.md"

# Create concise documentation for each data structure as markdown
