...
class Bee:
    ...
    def get_all_conversations(self, user_id="me") -> List[Conversation]:
        ...
        # Filter to only include valid conversations with required fields
        filtered_conversations = []
        for conversation in all_conversations:
            # Check if conversation has required fields: start_time, end_time, and at least one summary
            if (conversation.start_time and 
                conversation.end_time and 
                (conversation.summary or conversation.short_summary)):
