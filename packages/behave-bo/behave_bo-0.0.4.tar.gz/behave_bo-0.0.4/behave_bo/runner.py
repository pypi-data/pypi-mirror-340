...
class BehaveRunner(Runner):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.testing_projects = kwargs.get('testing_projects')
    ...
    def get_filtered_feature_locations(self):
        ...
        if self.testing_projects:
            filenames = [
                filename
                for filename in list(filenames)
                if any(test_project in str(filename) for test_project in self.testing_projects)
            ]
