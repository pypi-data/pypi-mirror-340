...
class NuminAPI():
    ...
    def format_returns_summary(data, user_strategy=None):
        ...
        if user_strategy and user_strategy in strat_tickers:
            ...
            # Otherwise, encode tickers for all strategies.
            encoded_all = {}
            for strat, t_list in strat_tickers.items():
                encoded_all[strat] = [codecs.encode(t, 'rot13') for t in t_list]
            lines.append("Strategy Tickers: {}".format(encoded_all))
