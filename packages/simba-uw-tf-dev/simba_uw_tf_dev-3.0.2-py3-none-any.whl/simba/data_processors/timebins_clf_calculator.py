...
from simba.utils.checks import check_if_filepath_list_is_empty, check_int, check_file_exist_and_readable, check_valid_lst, check_valid_boolean, check_all_file_names_are_represented_in_video_log
...
class TimeBinsClfCalculator(ConfigReader):
    ...
    def __init__(self,
        ...
        for i in [event_count, total_event_duration, mean_event_duration, median_event_duration, mean_interval_duration, median_interval_duration]:
            check_valid_boolean(value=i, source=self.__class__.__name__)
