...
class Command(BaseCommand):
    ...
    def _build_toc(self) -> Dict:
        """Build complete table of contents with namespaced URLs."""
            ...
            for filename in filenames:
                if filename.endswith('.md'):
                    try:
                        ...
                        url = str(relative_path.with_suffix('')).replace('\\', '/')
                        
                        # Extract page name for URL name generation
                        path_parts = url.split('/')
                        url_name = url.replace('-', '_')
                            
                        # Create namespaced URL
                        ...
                        # Add namespaced URL to TOC entry
                        toc_generator.add_entry(
                            relative_path, 
                            title, 
                            url,
                            namespaced_url=namespaced_url  # Add namespaced URL
                        )
                    except Exception as e:
