...
class CAF_Analysis:
    def __init__(self, pmt_folder,dpi, avg=5,peak_height=0.01, peak_distance=100, peak_prominence=0.01, show_plot=True, return_peaks=False, polyorder=3, buffer=1000, window_length=501, ymin=0, ymax=0.1):
    ...
    def ExtractDataSetpoint(self, FindResiduals):
    ...
    def ExtractDataSetpointTWOPEAK(self, FindResiduals):
    ...
    def PlotAverageTOF(self, fitGaussian, initialguess=0):
    ...
    def PlotAverageDataIntegral(self,initialguess, checkfitparams, plotMaximum, plotQuadintegral, plotTrapzintegral, SaveData, upperlimit):
    ...
    def DealWithAllData(self, avg, SaveData, FindResiduals):
    ...
    def FitDataToLorentzians(self, datatype, initialguess, cutoff, forceHF, OffsettoF0, SaveFig):
    ...
    def GenerateFrequencySpectra(self, windowsize, starttime, endtime, PlotFreqSpec, HFfixed):
