...
public class ConfigureSeasonalCalendarTest {
    ...
    public void configureSeasonalCalendarTest() {
        ...
        // select category
        onView(allOf(withId(android.R.id.title), withText("Preferred category")))
                .perform(click());
        onView(allOf(withId(android.R.id.text1), withText("Seasonal recipes")))
                .perform(click());
