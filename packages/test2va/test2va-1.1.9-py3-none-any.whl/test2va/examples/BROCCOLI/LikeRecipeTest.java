...
public class LikeRecipeTest {
    ...
    public void likeRecipeTest() {
        onView(allOf(withId(R.id.card_text_view_title), withText("Fry Rice"))).perform(click());
        onView(allOf(withId(R.id.action_details_like), withContentDescription("Mark as favorite"),
                isDisplayed())).perform(click());

        onView(allOf(withId(R.id.action_details_unlike))).check(matches(isDisplayed()));
    }
