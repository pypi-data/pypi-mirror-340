...
public class SearchCardTest {
    ...
    @Test
    public void searchCardTest() throws InterruptedException {
        ...
        Thread.sleep(2000);
        onView(withId(R.id.edit_text_search)).perform(replaceText("Blueberry"));
        Thread.sleep(2000);

        onView(allOf(withId(R.id.text_question),
                withText(containsStringIgnoringCase("Blueberry")))).check(matches(isDisplayed()));
