...
public class AddWeightEntryTest {
    ...
    @Test
    public void addWeightEntryTest() throws InterruptedException {
        ...
        onView(withId(R.id.edit_text)).perform(typeText("65"));
        onView(withId(R.id.fab_primary)).perform(click());

        onView(allOf(withId(R.id.value), withText("65 kg")))
