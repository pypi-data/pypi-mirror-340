...
public class DeleteCardTest {
    ...
    public void deleteCardTest() throws InterruptedException {
        ...
        onView(allOf(withId(R.id.button_delete),
                withParent(withParent(hasDescendant(withText(containsStringIgnoringCase("Bananas"))))))).perform(click());

        onView(withId(R.id.button_ok)).perform(click());

        onView(withText(containsStringIgnoringCase("Q: Bananas"))).check(doesNotExist());
