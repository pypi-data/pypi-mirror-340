...
(function (MESSAGE) {
    ...
    MESSAGE[MESSAGE["CSP_UNSAFE_INLINE_SCRIPT"] = 5] = "CSP_UNSAFE_INLINE_SCRIPT";
    MESSAGE[MESSAGE["DEPRECATED_API_ACCESS"] = 6] = "DEPRECATED_API_ACCESS";
    MESSAGE[MESSAGE["DEPRECATED_BOOTSTRAP_PARAM"] = 7] = "DEPRECATED_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["DEPRECATED_CLASS"] = 8] = "DEPRECATED_CLASS";
    MESSAGE[MESSAGE["DEPRECATED_INTERFACE"] = 9] = "DEPRECATED_INTERFACE";
    MESSAGE[MESSAGE["DEPRECATED_TYPE"] = 10] = "DEPRECATED_TYPE";
    MESSAGE[MESSAGE["DEPRECATED_COMPONENT"] = 11] = "DEPRECATED_COMPONENT";
    MESSAGE[MESSAGE["DEPRECATED_DECLARATIVE_SUPPORT"] = 12] = "DEPRECATED_DECLARATIVE_SUPPORT";
    MESSAGE[MESSAGE["DEPRECATED_FUNCTION_CALL"] = 13] = "DEPRECATED_FUNCTION_CALL";
    MESSAGE[MESSAGE["DEPRECATED_LESS_SUPPORT"] = 14] = "DEPRECATED_LESS_SUPPORT";
    MESSAGE[MESSAGE["DEPRECATED_LIBRARY"] = 15] = "DEPRECATED_LIBRARY";
    MESSAGE[MESSAGE["DEPRECATED_MANIFEST_JS_RESOURCES"] = 16] = "DEPRECATED_MANIFEST_JS_RESOURCES";
    MESSAGE[MESSAGE["DEPRECATED_MODULE_IMPORT"] = 17] = "DEPRECATED_MODULE_IMPORT";
    MESSAGE[MESSAGE["DEPRECATED_ODATA_MODEL_V4_SYNCHRONIZATION_MODE"] = 18] = "DEPRECATED_ODATA_MODEL_V4_SYNCHRONIZATION_MODE";
    MESSAGE[MESSAGE["DEPRECATED_PROPERTY"] = 19] = "DEPRECATED_PROPERTY";
    MESSAGE[MESSAGE["DEPRECATED_PROPERTY_OF_CLASS"] = 20] = "DEPRECATED_PROPERTY_OF_CLASS";
    MESSAGE[MESSAGE["DEPRECATED_THEME"] = 21] = "DEPRECATED_THEME";
    MESSAGE[MESSAGE["DEPRECATED_VIEW_TYPE"] = 22] = "DEPRECATED_VIEW_TYPE";
    MESSAGE[MESSAGE["DUPLICATE_BOOTSTRAP_PARAM"] = 23] = "DUPLICATE_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["HTML_IN_XML"] = 24] = "HTML_IN_XML";
    MESSAGE[MESSAGE["LIB_INIT_API_VERSION"] = 25] = "LIB_INIT_API_VERSION";
    MESSAGE[MESSAGE["MISSING_BOOTSTRAP_PARAM"] = 26] = "MISSING_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["NO_CONTROL_RERENDER_OVERRIDE"] = 27] = "NO_CONTROL_RERENDER_OVERRIDE";
    MESSAGE[MESSAGE["NO_DEPRECATED_RENDERER"] = 28] = "NO_DEPRECATED_RENDERER";
    MESSAGE[MESSAGE["NO_DIRECT_DATATYPE_ACCESS"] = 29] = "NO_DIRECT_DATATYPE_ACCESS";
    MESSAGE[MESSAGE["NO_DIRECT_ENUM_ACCESS"] = 30] = "NO_DIRECT_ENUM_ACCESS";
    MESSAGE[MESSAGE["NO_EXPORTED_VALUES_BY_LIB"] = 31] = "NO_EXPORTED_VALUES_BY_LIB";
    MESSAGE[MESSAGE["NO_GLOBALS"] = 32] = "NO_GLOBALS";
    MESSAGE[MESSAGE["NO_ICON_POOL_RENDERER"] = 33] = "NO_ICON_POOL_RENDERER";
    MESSAGE[MESSAGE["NO_ODATA_GLOBALS"] = 34] = "NO_ODATA_GLOBALS";
    MESSAGE[MESSAGE["NOT_STATIC_CONTROL_RENDERER"] = 35] = "NOT_STATIC_CONTROL_RENDERER";
    MESSAGE[MESSAGE["PARSING_ERROR"] = 36] = "PARSING_ERROR";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CORE_ROUTER"] = 37] = "PARTIALLY_DEPRECATED_CORE_ROUTER";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CREATE_COMPONENT"] = 38] = "PARTIALLY_DEPRECATED_CREATE_COMPONENT";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_JSON_MODEL_LOAD_DATA"] = 39] = "PARTIALLY_DEPRECATED_JSON_MODEL_LOAD_DATA";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_MOBILE_INIT"] = 40] = "PARTIALLY_DEPRECATED_MOBILE_INIT";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY"] = 41] = "PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY_PROPERTIES_ARRAY"] = 42] = "PARTIALLY_DEPRECATED_ODATA_MODEL_V2_CREATE_ENTRY_PROPERTIES_ARRAY";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_PARAMETERS_GET"] = 43] = "PARTIALLY_DEPRECATED_PARAMETERS_GET";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_VIEW_CREATE"] = 44] = "PARTIALLY_DEPRECATED_VIEW_CREATE";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_FRAGMENT_LOAD"] = 45] = "PARTIALLY_DEPRECATED_FRAGMENT_LOAD";
    MESSAGE[MESSAGE["PARTIALLY_DEPRECATED_CONTROLLER_LOAD_FRAGMENT"] = 46] = "PARTIALLY_DEPRECATED_CONTROLLER_LOAD_FRAGMENT";
    MESSAGE[MESSAGE["PREFER_TEST_STARTER"] = 47] = "PREFER_TEST_STARTER";
    MESSAGE[MESSAGE["REDUNDANT_BOOTSTRAP_PARAM"] = 48] = "REDUNDANT_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["REDUNDANT_BOOTSTRAP_PARAM_ERROR"] = 49] = "REDUNDANT_BOOTSTRAP_PARAM_ERROR";
    MESSAGE[MESSAGE["REDUNDANT_VIEW_CONFIG_PROPERTY"] = 50] = "REDUNDANT_VIEW_CONFIG_PROPERTY";
    MESSAGE[MESSAGE["REPLACED_BOOTSTRAP_PARAM"] = 51] = "REPLACED_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["SPELLING_BOOTSTRAP_PARAM"] = 52] = "SPELLING_BOOTSTRAP_PARAM";
    MESSAGE[MESSAGE["STRING_FOR_FORMATTER_VALUE_IN_JS"] = 53] = "STRING_FOR_FORMATTER_VALUE_IN_JS";
    MESSAGE[MESSAGE["SVG_IN_XML"] = 54] = "SVG_IN_XML";
    MESSAGE[MESSAGE["MISSING_CONTROL_RENDERER_DECLARATION"] = 55] = "MISSING_CONTROL_RENDERER_DECLARATION";
    MESSAGE[MESSAGE["CONTROL_RENDERER_DECLARATION_STRING"] = 56] = "CONTROL_RENDERER_DECLARATION_STRING";
})(MESSAGE || (MESSAGE = {}));
