            ...
            if res_dict["ocr_dict"] and res_dict["set_dict"]:#说明技能栏的技能和配置文件不匹配
                ...
                if res_shortcut_dict: #如果存在技能错乱的情况
                    for coord in list(res_shortcut_dict.values()):
                        ...
                        try:
                            self.mouse_drag(coord[0]+random_num,coord[1]+random_num,672+random_num,737+random_num,110)
                            time.sleep(1)
...
skill_config_灵宿_scope={
    ...
    "4":["resource/images_info/role_skill/无相涅槃.png",786, 249, 834, 296],#怒气技能
