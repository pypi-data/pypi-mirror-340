...
class Mian_Task(TaskModule): #todo,修改任务名称
    ...
    def task_竹海的强盗(self):
        ...
        if "对话界面" in self.game_interface[0]:
            ...
            elif (self.target_info and self.target_info["目标体"] == "强盗")  or self.get_value_from_key("目标体强盗", "dic_mutil_colors"):
...
public_res:公共资源
"""
reward_merged_dict_主线=merge_dicts(dic_reward_tasks,public_res)
...
task_主线_text_alternative_parameters=task_background_scope
...
# 倒序排列
task_主线_word_standard_dict_order = dict(sorted(task_name_word_standard_dict.items(), reverse=True))
