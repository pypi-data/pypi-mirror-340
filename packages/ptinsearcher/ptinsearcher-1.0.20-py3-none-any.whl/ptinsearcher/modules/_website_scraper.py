...
class WebsiteScraper:
    ...
    def _scrape_response(self, response) -> dict:
            ...
            self.result.data: dict = {"url": response.url, "metadata": None, "emails": None, "phone_numbers": None, "ip_addresses": None, "abs_urls": None, "internal_urls": None, "internal_urls_with_parameters": None, "external_urls": None, "insecure_sources": None, "subdomains": None, "forms": None, "comments": None}
            content_type = response.headers.get("content-type")
            if "text" not in content_type:
                return self.result # TODO: FIXME
