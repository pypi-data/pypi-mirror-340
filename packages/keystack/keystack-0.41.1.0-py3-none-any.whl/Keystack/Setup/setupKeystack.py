...
class Setup:
    ...
    def installAndStartDockerContainers(self, mongoIp='keystackMongoDBHostname', dockerBuildImagePath=None):
        ...
        for replacement in [('{keystackVersion}',     SetupVar.keystackVersion),
                            ...
                            #('{debugPort}',           SetupVar.userEnvSettings["debugPort"]),
                        ]:
    ...
    def setup(self, platform='docker', dockerBuildImagePath=None):     
        try:                
            ...
            keystackFolderList = [f'{keystackTestsPath}/Playbooks/DOMAIN=Communal',
                                  ...
                                  f'{keystackSystemPath}/SystemBackup',
    ...
    def update(self, platform='docker', dockerBuildImagePath=None):
        """
