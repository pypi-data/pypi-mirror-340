...
class TransformerModel(nn.Module):
    ...
    def fwd(
        ...
        with open("store_cross_attentions.txt", "r") as file:
            store_cross_attentions = str(file.read()).strip()
            store_cross_attentions = True if store_cross_attentions == "True" else False
        ...
        if store_attentions and (store_cross_attentions or self.is_encoder):
