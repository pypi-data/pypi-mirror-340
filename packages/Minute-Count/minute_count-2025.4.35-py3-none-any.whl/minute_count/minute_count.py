...
from minute_count.terminal_formatting import add_color, print_temp, hide_temp
...
def minute_overview(path: Path, recursive: bool = True, show_output: bool = False, show_for_files: bool = False,
    ...
    print(f"Current sum: {add_color(2, format_time(seconds_offset, seconds_precision)):20} ({seconds_offset:20})")
