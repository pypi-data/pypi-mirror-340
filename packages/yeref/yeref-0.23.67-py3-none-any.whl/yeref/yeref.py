...
async def post_save(bot, data_user, data_web, MEDIA_D, BASE_P, KEYS_JSON, PROJECT_USERNAME, PROJECT_TYPE):
    ...
    try:
        ...
        HASH_VAL = hashlib.blake2b(HASH_STR.encode('utf-8'), digest_size=8).hexdigest()
        POST_NFT = f'https://t.me/{PROJECT_USERNAME}/web?startapp=nft-{HASH_VAL}-{str(ENT_TID).replace('-', '')}'
        print(f"{POST_NFT=}")
        # endregion
        ...
        result['post'] = {
            ...
            'POST_BLOG': POST_BLOG, 'POST_LZ': POST_LZ, 'POST_TZ': POST_TZ,
        ...
        sql = f""" 
            INSERT INTO {schema_prefix}_{str(ENT_TID).replace('-', '')}.POST (
                ...
                POST_WEB, POST_PAY, POST_INVOICE, POST_BLOG, POST_NFT, POST_ISPRIVATE, 
        ...
        await db_change_pg(sql, (
            ...
            POST_TYPE, POST_TEXT, POST_MEDIA, POST_BUTTONS, POST_CHKBOX,
            POST_WEB, POST_PAY or None, POST_INVOICE or None, POST_NFT or None, POST_BLOG, POST_ISPRIVATE or None,
