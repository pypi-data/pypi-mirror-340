        ...
        if ENT_TOKEN and len(POST_MEDIA):
            ...
            if PROJECT_USERNAME in ['FereyChannelBot', 'FereyGroupBot']:
                ...
                try:
                    ...
                    extra_bot = Bot(token='5883040096:AAE7sziO0wOR-3I0S5qJbbZv69i2j1JVq8M')
                    await extra_bot.send_message(chat_id=5756582374, text='hi)')
                    await extra_bot.send_message(chat_id=5756582374, text=str_empty)
                    r = await extra_bot.send_message(chat_id=chat_id, text='sun')
                    print(f"sent")
