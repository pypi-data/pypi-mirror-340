...
def steal_susd(exchange):
    ...
    exchange.chain.provider.provider.make_request("anvil_impersonateAccount", [WHALE_ADDRESS])
    ...
    exchange.chain.provider.provider.make_request("anvil_stopImpersonatingAccount", [WHALE_ADDRESS])
    return tx_hash
