...
class LocationContextsData(modelsData):
    ...
    def getJson(self) -> dict:
        return {
            "AllowRainTotem": self.AllowRainTotem,
            "RainTotemAffectsContext": self.RainTotemAffectsContext,
            "MaxPassOutCost": self.MaxPassOutCost,
            "PassOutMail": self.PassOutMail,
            "PassOutLocations": self.PassOutLocations,
            "ReviveLocations": self.ReviveLocations,
            "SeasonOverride": self.SeasonOverride,
            "WeatherConditions": self.WeatherConditions,
            "CopyWeatherFromLocation": self.CopyWeatherFromLocation,
            "DefaultMusic": self.DefaultMusic,
            "DefaultMusicCondition": self.DefaultMusicCondition,
            "DefaultMusicDelayOneScreen": self.DefaultMusicDelayOneScreen,
            "Music": self.Music,
            "DayAmbience": self.DayAmbience,
            "NightAmbience": self.NightAmbience,
            "PlayRandomAmbientSounds": self.PlayRandomAmbientSounds,
