...
class FencesData(modelsData):
    ...
    def getJson(self) -> dict:
        return {
            ...
            "PlacementSound": self.PlacementSound,
            "RemovalToolIds": self.RemovalToolIds,
            "RemovalToolTypes": self.RemovalToolTypes,
            "RemovalSound": self.RemovalSound,
            "RemovalDebrisType": self.RemovalDebrisType,
            "RepairHealthAdjustmentMinimum": self.RepairHealthAdjustmentMinimum,
            "RepairHealthAdjustmentMaximum": self.RepairHealthAdjustmentMaximum,
            "HeldObjectDrawOffset": self.HeldObjectDrawOffset,
            "LeftEndHeldObjectDrawX": self.LeftEndHeldObjectDrawX,
            "RightEndHeldObjectDrawX": self.RightEndHeldObjectDrawX
        }
