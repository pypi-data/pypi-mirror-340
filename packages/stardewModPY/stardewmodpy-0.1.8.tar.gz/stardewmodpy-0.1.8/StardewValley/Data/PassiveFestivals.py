...
class PassiveFestivalsData(modelsData):
    ...
    def getJson(self) -> dict:
        return {
            ...
            "StartMessage": self.StartMessage,
            "MapReplacements": self.MapReplacements,
            "Condition": self.Condition,
            "ShowOnCalendar": self.ShowOnCalendar,
            "DailySetupMethod": self.DailySetupMethod,
            "CleanupMethod": self.CleanupMethod,
